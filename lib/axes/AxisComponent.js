var AxisBuilder, AxisComponent, BinsComponent, ColorMapComponent, ExprCompiler, ExprComponent, ExprUtils, H, LinkComponent, NumberComponent, R, React, ui, update,
...
module.exports = AxisComponent = (function(superClass) {
  ...
  AxisComponent.prototype.renderColorMap = function() {
    if (!this.props.showColorMap || !this.props.value || !this.props.value.expr) {
      return null;
    }
    return R(ColorMapComponent, {
      schema: this.props.schema,
      dataSource: this.props.dataSource,
      axis: this.props.value,
  ...
  AxisComponent.prototype.render = function() {
    ...
    })), this.renderXform(), this.renderColorMap());
  };
