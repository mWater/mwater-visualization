var DashboardViewComponent, H, LegoLayoutEngine, React, ReactElementPrinter, WidgetContainerComponent, WidgetScoper, WidgetScopesViewComponent, uuid,
    ...
    elems = _.mapValues(widgets, (function(_this) {
      return function(widget, id) {
        ...
        return widget.createViewElement({
          ...
          onDuplicate: _this.handleDuplicate.bind(null, id),
