...
module.exports = ChartViewComponent = (function(superClass) {
  ...
  ChartViewComponent.prototype.loadData = function(props, callback) {
    return props.chart.getData(props.design, props.filters, callback);
  };
  ...
  ChartViewComponent.prototype.render = function() {
    ...
    if (!_.isEqual(this.props.chart.cleanDesign(this.props.design), this.state.validDesign)) {
      style.opacity = 0.5;
    }
