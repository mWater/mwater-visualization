    ...
    getData(design, schema, dataSource, filters, callback) {
        ...
        const evalExprItem = (exprItem, cb) => {
            ...
            if (table) {
                ...
                whereClauses = lodash_1.default.map(relevantFilters, (f) => (0, mwater_expressions_4.injectTableAlias)(f.jsonql, "main"));
            }
            else {
                whereClauses = [];
            }
            // In case of "sum where"/"count where", extract where clause to make faster
            if ((expr === null || expr === void 0 ? void 0 : expr.op) === "sum where") {
            ...
            else if ((expr === null || expr === void 0 ? void 0 : expr.op) === "count where") {
