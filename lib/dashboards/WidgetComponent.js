...
function WidgetComponent(props) {
    ...
    var widgetDataSource = react_1.useMemo(function () { return props.dashboardDataSource.getWidgetDataSource(props.type, props.id); }, [props.dashboardDataSource, props.type, props.id]);
