...
class SettingsModalComponent extends react_1.default.Component {
    ...
    static initClass() {
        this.contextTypes = { globalFiltersElementFactory: prop_types_1.default.func };
    ...
    render() {
        ...
        return R(ActionCancelModalComponent_1.default, {
            ...
            ? R(QuickfiltersDesignComponent_1.default, {
                ...
                onDesignChange: (design) => this.handleDesignChange(update_object_1.default(this.state.design, { quickfilters: { $set: design } })),
            ...
            onChange: (locale) => this.handleDesignChange(update_object_1.default(this.state.design, { locale: { $set: locale.value } }))
        }), R("h4", { style: { paddingTop: 10 } }, "Advanced"), R(bootstrap_1.default.Checkbox, {
            value: this.state.design.implicitFiltersEnabled != null ? this.state.design.implicitFiltersEnabled : true,
            onChange: (value) => this.handleDesignChange(update_object_1.default(this.state.design, { implicitFiltersEnabled: { $set: value } }))
