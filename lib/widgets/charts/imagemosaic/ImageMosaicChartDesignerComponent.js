...
var AxisBuilder,
    ...
    ExprUtils,
    FilterExprComponent,
    ImageMosaicChartDesignerComponent,
    PropTypes,
    R,
    React,
...
module.exports = ImageMosaicChartDesignerComponent = function () {
  var ImageMosaicChartDesignerComponent =
  /*#__PURE__*/
  function (_React$Component) {
    (0, _inherits2.default)(ImageMosaicChartDesignerComponent, _React$Component);

    function ImageMosaicChartDesignerComponent() {
      var _this;

      (0, _classCallCheck2.default)(this, ImageMosaicChartDesignerComponent);
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(ImageMosaicChartDesignerComponent).apply(this, arguments));
      ...
      _this.handleImageAxisChange = _this.handleImageAxisChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      return _this;
    } // Updates design with the specified changes


    (0, _createClass2.default)(ImageMosaicChartDesignerComponent, [{
      key: "updateDesign",
      ...
      value: function handleTitleTextChange(ev) {
        boundMethodCheck(this, ImageMosaicChartDesignerComponent);
      ...
      key: "handleImageAxisChange",
      value: function handleImageAxisChange(imageAxis) {
        boundMethodCheck(this, ImageMosaicChartDesignerComponent);
        return this.updateDesign({
          imageAxis: imageAxis
        });
      ...
      key: "renderImageAxis",
      value: function renderImageAxis() {
        if (!this.props.design.table) {
          return;
        }
