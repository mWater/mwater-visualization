...
module.exports = ConsoleComponent = (function(superClass) {
  ...
  ConsoleComponent.prototype.handleTabRemove = function(tab, ev) {
    ...
    return this.props.onActiveTabIdChange(selectedTab.id);
  };
  ...
  ConsoleComponent.prototype.render = function() {
    var activeTab;
    activeTab = _.findWhere(this.props.design.tabs, {
    ...
    }, this.renderTabs(), activeTab ? H.div({
      style: {
        height: "100%"
      },
      key: activeTab.id
    }, this.renderContents(activeTab)) : void 0);
  };
