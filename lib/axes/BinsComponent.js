...
class BinsComponent extends react_1.default.Component {
    ...
    render() {
        return R("div", null, R("div", { key: "vals" }, R(LabeledInlineComponent, { key: "min", label: "Min:" }, R(NumberInputComponent_1.default, {
            ...
            ? R("div", { key: "excludes" }, R("label", { className: "checkbox-inline", key: "lower" }, R("input", {
                type: "checkbox",
                checked: !this.props.xform.excludeLower,
                onChange: (ev) => this.props.onChange(update_object_1.default(this.props.xform, { excludeLower: { $set: !ev.target.checked } }))
            }), `Include < ${this.props.xform.min}`), R("label", { className: "checkbox-inline", key: "upper" }, R("input", {
                type: "checkbox",
                checked: !this.props.xform.excludeUpper,
                onChange: (ev) => this.props.onChange(update_object_1.default(this.props.xform, { excludeUpper: { $set: !ev.target.checked } }))
