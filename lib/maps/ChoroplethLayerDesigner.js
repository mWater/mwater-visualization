    ...
    ChoroplethLayerDesigner.prototype.renderRegionsTable = function () {
        ...
        return (react_1.default.createElement("div", { className: "form-group" },
            ...
            react_1.default.createElement("div", { style: { marginLeft: 8 } },
                react_1.default.createElement(bootstrap_1.default.Select, { value: this.props.design.regionsTable, onChange: this.handleRegionsTableChange, options: options, nullLabel: "Administrative Regions" }))));
    };
    ChoroplethLayerDesigner.prototype.renderAdminRegionExpr = function () {
        ...
        return (react_1.default.createElement("div", { className: "form-group" },
            react_1.default.createElement("label", { className: "text-muted" },
                ...
                " Location"),
            react_1.default.createElement("div", { style: { marginLeft: 8 } },
                react_1.default.createElement(mwater_expressions_ui_1.ExprComponent, { schema: this.props.schema, dataSource: this.props.dataSource, onChange: this.handleAdminRegionExprChange, table: this.props.design.table, types: ["id"], idTable: regionsTable, value: this.props.design.adminRegionExpr }))));
    };
