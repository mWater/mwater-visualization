...
class MapFiltersDesignerComponent extends react_1.default.Component {
    ...
    render() {
        ...
        return R("div", null, R("div", { className: "mb-3" }, R("label", { className: "text-muted" }, "Filters ", R(PopoverHelpComponent_1.default, { placement: "left" }, "Filters all layers in the map. Individual layers can be filtered by clicking on Customize...")), R("div", { style: { margin: 5 } }, R(FiltersDesignerComponent_1.default, {
