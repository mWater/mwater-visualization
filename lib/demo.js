...
var $,
    AutoSizeComponent,
    DataSource,
    DirectDashboardDataSource,
    DirectDatagridDataSource,
    DirectMapDataSource,
    ...
    RichTextPane,
    Schema,
    ServerDashboardDataSource,
    ServerMapDataSource,
    WaterOrgDashboardPane,
    adminRegionMap,
    autoBoundsMap,
    badColorsMap,
    badColorsMap2,
...
visualization = require('./index'); // CalendarChartViewComponent = require './widgets/charts/CalendarChartViewComponent'
...
$(function () {
  var sample;
  sample = R(DragDropContextProvider, {
  ...
  }, R('style', null, 'html, body, #main { height: 100% }'), R(MWaterDashboardPane, {
    apiUrl: "http://localhost:1234/v3/",
    client: "674fd648e9693e1e0d2eb2ef29107d0e",
    dashboardId: "c58048c3c3384a5aab3d984ac1f3750e"
...
function (_React$Component) {
  (0, _inherits2["default"])(RichTextPane, _React$Component);

  function RichTextPane(props) {
    var _this;

    (0, _classCallCheck2["default"])(this, RichTextPane);
    _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(RichTextPane).call(this, props));
  ...
  (0, _createClass2["default"])(RichTextPane, [{
    key: "handleInsert",
    value: function handleInsert(ev) {
      boundMethodCheck(this, RichTextPane);
      ev.preventDefault();
    ...
    value: function render() {
      ...
      return R('div', {
        ...
        onItemsChange: function onItemsChange(items) {
...
function (_React$Component2) {
  (0, _inherits2["default"])(MWaterDashboardPane, _React$Component2);

  function MWaterDashboardPane(props) {
    var _this3;

    (0, _classCallCheck2["default"])(this, MWaterDashboardPane);
    _this3 = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(MWaterDashboardPane).call(this, props));
    _this3.handleDesignChange = _this3.handleDesignChange.bind((0, _assertThisInitialized2["default"])(_this3));
    _this3.state = {
      design: null,
      extraTables: []
    };
  ...
  (0, _createClass2["default"])(MWaterDashboardPane, [{
    key: "componentWillMount",
    value: function componentWillMount() {
      var _this4 = this;

      var url; // Load dashboard

      url = this.props.apiUrl + "dashboards/".concat(this.props.dashboardId, "?") + querystring.stringify({
        client: this.props.client,
        share: this.props.share
      });
      return $.getJSON(url, function (dashboard) {
        return _this4.setState({
          design: dashboard.design,
          extraTables: dashboard.extraTables
        });
      });
    }
  }, {
    ...
    value: function handleDesignChange(design) {
      boundMethodCheck(this, MWaterDashboardPane);
    ...
    value: function render() {
      ...
      return React.createElement(MWaterLoaderComponent, {
        ...
        errorFormatter: function errorFormatter(err, defaultError) {
          if (!err.form) {
            return defaultError;
          }

          return "This dashboard depends on the survey ".concat(err.form.name, " which cannot be loaded. Perhaps the administrator of the survey has not shared it with you? The survey was created by ").concat(err.form.created_by);
        }
        ...
        dashboardDataSource = new ServerDashboardDataSource({
          apiUrl: _this5.props.apiUrl,
          client: _this5.props.client,
          share: _this5.props.share,
          dashboardId: _this5.props.dashboardId,
        ...
        return R('div', {
          ...
          design: _this5.state.design,
          onDesignChange: _this5.handleDesignChange,
          titleElem: "Sample"
        }));
      });
    }
...
function (_React$Component3) {
  (0, _inherits2["default"])(MWaterDirectDashboardPane, _React$Component3);

  function MWaterDirectDashboardPane(props) {
    var _this6;

    (0, _classCallCheck2["default"])(this, MWaterDirectDashboardPane);
    _this6 = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(MWaterDirectDashboardPane).call(this, props));
    _this6.handleDesignChange = _this6.handleDesignChange.bind((0, _assertThisInitialized2["default"])(_this6));
    _this6.handleExtraTablesChange = _this6.handleExtraTablesChange.bind((0, _assertThisInitialized2["default"])(_this6));
    _this6.state = {
      // design: { items: {}, layout: "grid" } # dashboardDesign
      // design: { items: { id: "root", type: "root", blocks: [] }, layout: "blocks" } # dashboardDesign
      design: window.localStorage.getItem("MWaterDirectDashboardPane.design") ? JSON.parse(window.localStorage.getItem("MWaterDirectDashboardPane.design")) : mapAndChartDashboard,
      // design: imageWidgetDashboardDesign
      // design: dashboardDesign
      extraTables: window.localStorage.getItem("MWaterDirectDashboardPane.extraTables") ? JSON.parse(window.localStorage.getItem("MWaterDirectDashboardPane.extraTables")) : []
    };
    return _this6;
  }

  (0, _createClass2["default"])(MWaterDirectDashboardPane, [{
    key: "handleDesignChange",
    value: function handleDesignChange(design) {
      boundMethodCheck(this, MWaterDirectDashboardPane);
      this.setState({
        design: design
      }); // console.log JSON.stringify(design, null, 2)
    ...
    key: "handleExtraTablesChange",
    value: function handleExtraTablesChange(extraTables) {
      boundMethodCheck(this, MWaterDirectDashboardPane);
      this.setState({
        extraTables: extraTables
      });
    ...
    value: function render() {
      ...
      return React.createElement(MWaterLoaderComponent, {
        ...
        dashboardDataSource = new DirectDashboardDataSource({
          apiUrl: _this7.props.apiUrl,
          client: _this7.props.client,
          design: _this7.state.design,
          schema: config.schema,
          dataSource: config.dataSource
        });
        return R('div', {
          ...
          dashboardDataSource: dashboardDataSource,
          design: _this7.state.design,
          onDesignChange: _this7.handleDesignChange,
          titleElem: "Sample",
          // quickfilterLocks: [{ expr: { type: "field", table: "entities.water_point", column: "type" }, value: "Protected dug well" }]
          namedStrings: {
            branding: "mWater"
          },
          onRowClick: function onRowClick(table, rowId) {
            return alert("Row clicked: ".concat(table, " ").concat(rowId));
          }
        }));
      });
    }
...
}(React.Component); // mapId = "fb92ca9ca9a04bfd8dc156b5ac71380d"
...
function (_React$Component4) {
  (0, _inherits2["default"])(MWaterMapPane, _React$Component4);

  function MWaterMapPane(props) {
    var _this8;

    (0, _classCallCheck2["default"])(this, MWaterMapPane);
    _this8 = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(MWaterMapPane).call(this, props));
    _this8.handleDesignChange = _this8.handleDesignChange.bind((0, _assertThisInitialized2["default"])(_this8));
    _this8.state = {
      design: null,
      extraTables: []
    };
  ...
  (0, _createClass2["default"])(MWaterMapPane, [{
    key: "componentWillMount",
    value: function componentWillMount() {
      var _this9 = this;
      ...
      url = this.props.apiUrl + "maps/".concat(mapId, "?") + querystring.stringify({
        client: this.props.client
      });
      return $.getJSON(url, function (map) {
    ...
    key: "handleDesignChange",
    value: function handleDesignChange(design) {
      boundMethodCheck(this, MWaterMapPane);
      this.setState({
        design: design
      });
    ...
    value: function render() {
      ...
      return React.createElement(MWaterLoaderComponent, {
        ...
        var mapDataSource; // Create map url source
        ...
        mapDataSource = new ServerMapDataSource({
          apiUrl: _this10.props.apiUrl,
          client: _this10.props.client,
          mapId: mapId,
          design: _this10.state.design
        });
        return R('div', {
          style: {
            height: "100%"
          ...
          onDesignChange: _this10.handleDesignChange,
          onRowClick: function onRowClick(tableId, rowId) {
            return alert("".concat(tableId, ":").concat(rowId));
          },
          titleElem: "Sample"
        }));
      });
...
function (_React$Component5) {
  (0, _inherits2["default"])(MWaterDirectMapPane, _React$Component5);

  function MWaterDirectMapPane(props) {
    var _this11;

    (0, _classCallCheck2["default"])(this, MWaterDirectMapPane);
    _this11 = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(MWaterDirectMapPane).call(this, props));
    _this11.handleDesignChange = _this11.handleDesignChange.bind((0, _assertThisInitialized2["default"])(_this11));
    _this11.handleExtraTablesChange = _this11.handleExtraTablesChange.bind((0, _assertThisInitialized2["default"])(_this11));
    _this11.state = {
      design: window.localStorage.getItem("MWaterDirectMapPane.design") ? JSON.parse(window.localStorage.getItem("MWaterDirectMapPane.design")) : doubleClickMap,
      extraTables: window.localStorage.getItem("MWaterDirectMapPane.extraTables") ? JSON.parse(window.localStorage.getItem("MWaterDirectMapPane.extraTables")) : []
    };
    return _this11;
  }

  (0, _createClass2["default"])(MWaterDirectMapPane, [{
    key: "handleDesignChange",
    value: function handleDesignChange(design) {
      boundMethodCheck(this, MWaterDirectMapPane);
      this.setState({
        design: design
      }); // console.log JSON.stringify(design, null, 2)
    ...
    value: function render() {
      ...
      return React.createElement(MWaterLoaderComponent, {
        ...
        mapDataSource = new DirectMapDataSource({
          apiUrl: _this12.props.apiUrl,
          client: _this12.props.client,
          schema: config.schema,
          dataSource: config.dataSource,
          design: _this12.state.design
        });
        return R('div', {
          style: {
            height: "100%"
          ...
          design: _this12.state.design,
          mapDataSource: mapDataSource,
          onDesignChange: _this12.handleDesignChange,
          onRowClick: function onRowClick(tableId, rowId) {
            return console.log("Click ".concat(tableId, ":").concat(rowId));
          },
          titleElem: "Sample"
        }));
      });
...
function (_React$Component6) {
  (0, _inherits2["default"])(MWaterDatagridPane, _React$Component6);

  function MWaterDatagridPane(props) {
    var _this13;

    (0, _classCallCheck2["default"])(this, MWaterDatagridPane);
    _this13 = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(MWaterDatagridPane).call(this, props));
    _this13.handleDesignChange = _this13.handleDesignChange.bind((0, _assertThisInitialized2["default"])(_this13));
    _this13.state = {
  ...
  (0, _createClass2["default"])(MWaterDatagridPane, [{
    key: "handleDesignChange",
    value: function handleDesignChange(design) {
      boundMethodCheck(this, MWaterDatagridPane);
      this.setState({
        design: design
      });
      return console.log(JSON.stringify(design, null, 2));
    ...
    value: function render() {
      ...
      return R(MWaterLoaderComponent, {
        ...
        return R('div', {
          ...
          design: _this14.state.design,
          onDesignChange: _this14.handleDesignChange,
          titleElem: "Sample",
          ...
          canEditValue: function canEditValue(tableId, rowId, expr, callback) {
            return callback(null, true);
          },
          updateValue: function updateValue(tableId, rowId, expr, value, callback) {
            console.log(value);
...
function (_React$Component7) {
  (0, _inherits2["default"])(WaterOrgDashboardPane, _React$Component7);

  function WaterOrgDashboardPane(props) {
    var _this15;

    (0, _classCallCheck2["default"])(this, WaterOrgDashboardPane);
    _this15 = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(WaterOrgDashboardPane).call(this, props));
    _this15.handleDesignChange = _this15.handleDesignChange.bind((0, _assertThisInitialized2["default"])(_this15));
    _this15.state = {
      design: {
        items: {
          id: "root",
  ...
  (0, _createClass2["default"])(WaterOrgDashboardPane, [{
    key: "componentWillMount",
    value: function componentWillMount() {
      var _this16 = this;
      ...
      return $.getJSON(url, function (schemaJson) {
        ...
        dataSource = new MWaterDataSource(_this16.props.apiUrl, null, {
          serverCaching: false,
          localCaching: true
        });
    ...
    key: "handleDesignChange",
    value: function handleDesignChange(design) {
      boundMethodCheck(this, WaterOrgDashboardPane);
      this.setState({
        design: design
      });
      return console.log(JSON.stringify(design, null, 2));
  ...
  return WaterOrgDashboardPane;
}(React.Component); // class MapPane extends React.Component
//   constructor: (props) ->
//     super
//     @state = {
//       schema: null
...
function (_DataSource) {
  ...
  function MWaterDataSource(apiUrl, client) {
    ...
    _this17 = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(MWaterDataSource).call(this));
    _this17.apiUrl = apiUrl;
    _this17.client = client;
    _this17.caching = caching;
    return _this17;
  }
