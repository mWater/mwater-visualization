var AxisBuilder, ExprCleaner, ExprCompiler, ExprUtils, H, React, _, d3Format, moment, xforms,
...
module.exports = AxisBuilder = (function() {
  ...
  AxisBuilder.prototype.cleanAxis = function(options) {
    ...
    if (!axis.xform && options.types && indexOf.call(options.types, type) < 0) {
      ...
      if (xform) {
        ...
        if (indexOf.call(options.types, "number") < 0) {
          return null;
        }
      }
    }
    ...
    if (axis.xform) {
      ...
      if (options.types && indexOf.call(options.types, "number") >= 0 && indexOf.call(options.types, type) < 0) {
        axis.aggr = "count";
      }
    }
    return axis;
  ...
  AxisBuilder.prototype.formatValue = function(axis, value, locale) {
    ...
    categories = this.getCategories(axis, [], locale);
