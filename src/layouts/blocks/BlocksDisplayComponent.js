...
class BlocksDisplayComponent extends React.Component {
    ...
    switch (block.type) {
      ...
      case "spacer":
        elem = R(AutoSizeComponent, { injectWidth: true, key: block.id }, 
          size => {
            return R('div', { id: block.id, style: {
              width: size.width,
          ...
          elem = R(DraggableBlockComponent, { 
            ...
            onBlockDrop: this.handleBlockDrop
              ...
              R(DecoratedBlockComponent, { 
                ...
                onAspectRatioChange: (block.aspectRatio != null) ? aspectRatio => this.props.onItemsChange(blockUtils.updateBlock(this.props.items, _.extend({}, block, {aspectRatio}))) : undefined,
        ...
        elem = R(AutoSizeComponent, { injectWidth: true, key: block.id }, 
          size => {
            return this.props.renderWidget({
              ...
              design: block.design,
              onDesignChange: this.props.onItemsChange ? design => this.props.onItemsChange(blockUtils.updateBlock(this.props.items, _.extend({}, block, {design}))) : undefined,
              width: size.width,
              height: (block.aspectRatio != null) ? size.width / block.aspectRatio : undefined
            });
        });
  ...
  renderPalette() {
    return R('div', {key: "palette", style: { width: 141, height: "100%", position: "absolute", top: 0, left: 0 }}, 
      R('div', {className: "mwater-visualization-palette", style: { height: "100%" }},
        ...
        R(PaletteItemComponent, {
          createItem: this.createBlockItem({ type: "widget", aspectRatio: 1.4, widgetType: "LayeredChart", design: {} }),
        ...
        !this.props.disableMaps ?
          R(PaletteItemComponent, {
            createItem: this.createBlockItem({ type: "widget", aspectRatio: 1.4, widgetType: "Map", design: { baseLayer: "bing_road", layerViews: [], filters: {}, bounds: { w: -40, n: 25, e: 40, s: -25 } } }),
        ...
        R(PaletteItemComponent, {
          createItem: this.createBlockItem({ type: "widget", aspectRatio: 1.4, widgetType: "CalendarChart", design: {} }),
          title: R('i', {className: "fa fa-calendar"}),
          subtitle: "Calendar"
        }
        ),
        R(PaletteItemComponent, {
          createItem: this.createBlockItem({ type: "widget", aspectRatio: 1.4, widgetType: "ImageMosaicChart", design: {} }),
        ...
        R(PaletteItemComponent, {
          createItem: this.createBlockItem({ type: "widget", aspectRatio: 16.0/9.0, widgetType: "IFrame", design: {} }),
          title: R('i', {className: "fa fa-youtube-play"}),
          subtitle: "Video"
        }
        ),
        R(PaletteItemComponent, {
          createItem: this.createBlockItem({ type: "widget", widgetType: "TOC", design: { numbering: false, borderWeight: 2, header: "Contents" } }),
  ...
  render() {
    ...
    if (this.props.onItemsChange) {
      ...
      return R('div', {style: { width: "100%", height: "100%", overflow: "hidden", position: "relative" }}, 
        this.renderPalette(),
        R('div', {style: { position: "absolute", left: 141, top: 0, bottom: 0, right: 0, overflow: "auto" }, className: `mwater-visualization-block-parent-outer mwater-visualization-block-parent-outer-${this.props.style || "default"} mwater-visualization-block-editing`}, 
          R('div', {key: "inner", className: `mwater-visualization-block-parent-inner mwater-visualization-block-parent-inner-${this.props.style || "default"}`, style: innerParentStyle},
      ...
      return R(AutoSizeComponent, { injectWidth: true, injectHeight: true }, 
        size => { 
          ...
          return R('div', {style: outerParentStyle, className: `mwater-visualization-block-parent-outer mwater-visualization-block-parent-outer-${this.props.style || "default"} mwater-visualization-block-viewing`},
            R('div', {key: "inner", className: `mwater-visualization-block-parent-inner mwater-visualization-block-parent-inner-${this.props.style || "default"}`, style: innerParentStyle},
