var EditableLinkComponent, H, React, Schema;
...
module.exports = Schema = (function() {
  ...
  Schema.prototype.createTableSelectElement = function(table, onChange) {
    return React.createElement(EditableLinkComponent, {
      dropdownItems: this.getTables(),
      onDropdownItemClicked: onChange,
      onRemove: (table ? this.onChange.bind(this, null) : void 0)
    }, table ? this.getTable(table).name : H.i(null, "Select..."));
  };
