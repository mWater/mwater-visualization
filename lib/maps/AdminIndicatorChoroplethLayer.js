var AdminIndicatorChoroplethLayer, AdminIndicatorChoroplethLayerDesigner, AxisBuilder, ExprCleaner, ExprCompiler, ExprUtils, H, Layer, React, injectTableAlias,
...
module.exports = AdminIndicatorChoroplethLayer = (function(superClass) {
  ...
  AdminIndicatorChoroplethLayer.prototype.createUrl = function(extension, design, filters) {
    var jsonql, mapDesign, query, url;
    query = "type=jsonql";
    if (this.client) {
