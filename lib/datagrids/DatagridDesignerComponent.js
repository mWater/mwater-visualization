var ColumnDesignerComponent, ColumnsDesignerComponent, DatagridDesignerComponent, DefaultColumnsBuilder, ExprComponent, ExprUtils, FilterExprComponent, H, OrderBysDesignerComponent, QuickfiltersDesignComponent, R, React, ReactReorderable, TabbedComponent, TableSelectComponent, _, update, uuid,
...
ColumnDesignerComponent = (function(superClass) {
  ...
  ColumnDesignerComponent.prototype.render = function() {
    var allowedTypes, exprUtils, type;
    exprUtils = new ExprUtils(this.props.schema);
