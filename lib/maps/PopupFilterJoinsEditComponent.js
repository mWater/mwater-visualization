...
class PopupFilterJoinsEditComponent extends react_1.default.Component {
    ...
    render() {
        ...
        return R("div", null, R("div", { className: "text-muted" }, "Optional connections for other tables to filtering the popup"), R("table", { className: "table table-condensed table-bordered" }, R("thead", null, R("tr", null, R("th", null, "Data Source"), R("th", null, "Connection"))), R("tbody", null, lodash_1.default.map(filterableTables, (filterableTable) => {
            var _a;
