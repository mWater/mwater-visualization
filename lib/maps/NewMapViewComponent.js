...
const dark_matter_json_1 = __importDefault(require("./map-styles/dark-matter.json"));
const positron_json_1 = __importDefault(require("./map-styles/positron.json"));
...
function NewMapViewComponent(props) {
    ...
    react_1.useEffect(() => {
        ...
        if (props.design.baseLayer == "cartodb_positron") {
            setBaseStyle(positron_json_1.default);
            return;
        }
        else if (props.design.baseLayer == "cartodb_dark_matter") {
            setBaseStyle(dark_matter_json_1.default);
            return;
        }
    ...
    react_1.useEffect(() => {
        ...
        const style = Object.assign(Object.assign({}, baseStyle), { sources: Object.assign(Object.assign({}, baseStyle.sources), userStyle.sources), glyphs: baseStyle.glyphs || "mapbox://fonts/mapbox/{fontstack}/{range}.pbf", layers });
        map.setStyle(style);
    ...
    react_1.useEffect(() => {
        ...
        function onMoveEnd() {
            ...
            const design = Object.assign(Object.assign({}, props.design), { bounds: { n: bounds.getNorth(), e: bounds.getEast(), s: bounds.getSouth(), w: bounds.getWest() } });
    ...
    function renderPopup() {
        ...
        return (react_1.default.createElement(ModalPopupComponent_1.default, { onClose: () => setPopupContents(null), showCloseX: true, size: "large" },
            ...
            react_1.default.createElement("div", { style: { textAlign: "right", marginTop: 10 } },
                react_1.default.createElement("button", { className: "btn btn-default", onClick: () => setPopupContents(null) }, "Close"))));
    }
...
function AttributionControl(props) {
    return (react_1.default.createElement("div", { className: "newmap-attribution-control" },
        react_1.default.createElement("a", { href: "https://www.mapbox.com/about/maps/", target: "_blank" }, "\u00A9 Mapbox"),
        " ",
