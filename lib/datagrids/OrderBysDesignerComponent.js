...
class OrderBysDesignerComponent extends react_1.default.Component {
    ...
    render() {
        ...
        }, R("span", { className: "glyphicon glyphicon-plus" }), " Add Ordering"));
    }
}
...
class OrderByDesignerComponent extends react_1.default.Component {
    constructor() {
        ...
        this.handleDirectionChange = (ev) => {
            return this.props.onChange(lodash_1.default.extend({}, this.props.orderBy, { direction: ev.target.checked ? "desc" : "asc" }));
        };
    }
    render() {
        return R("div", { className: "row" }, R("div", { className: "col-xs-7" }, R(mwater_expressions_ui_1.ExprComponent, {
            schema: this.props.schema,
            dataSource: this.props.dataSource,
            table: this.props.table,
        ...
        })), R("div", { className: "col-xs-3" }, R("div", { className: "checkbox-inline" }, R("label", null, R("input", {
            type: "checkbox",
            checked: this.props.orderBy.direction === "desc",
            onChange: this.handleDirectionChange
        }), "Reverse"))), R("div", { className: "col-xs-1" }, R("button", { className: "btn btn-xs btn-link", type: "button", onClick: this.props.onRemove }, R("span", { className: "glyphicon glyphicon-remove" }))));
    }
}
