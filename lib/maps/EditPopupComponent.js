var BlocksLayoutManager, DirectWidgetDataSource, EditPopupComponent, ModalWindowComponent, PopupFilterJoinsEditComponent, PropTypes, R, React, WidgetFactory, _,
...
module.exports = EditPopupComponent = (function(superClass) {
  ...
  function EditPopupComponent(props) {
    ...
    EditPopupComponent.__super__.constructor.call(this, props);
    this.state = {
      editing: false
    };
  }
