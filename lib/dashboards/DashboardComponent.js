    ...
    (0, _createClass2["default"])(DashboardComponent, [{
      ...
      value: function renderQuickfilter() {
        ...
        return R('div', {
          style: {
            position: "absolute",
            top: this.props.hideTitleBar ? 0 : 40,
            left: 0,
            right: 0
          },
          ref: function ref(c) {
      ...
      value: function render() {
        ...
        return R('div', {
          ...
          style: {
            height: "100%",
            paddingTop: (this.props.hideTitleBar ? 0 : 40) + (this.state.quickfiltersHeight || 0),
            position: "relative"
          }
        }, !this.props.hideTitleBar ? this.renderTitleBar() : void 0, this.renderQuickfilter(), this.props.onDesignChange != null ? R(SettingsModalComponent, {
