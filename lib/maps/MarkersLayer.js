...
class MarkersLayer extends Layer_1.default {
    ...
    getVectorTile(design, sourceId, schema, filters, opacity) {
        ...
        mapLayers.push({
            ...
            paint: {
                "fill-color": color,
                "fill-opacity": ((_c = design.polygonFillOpacity) !== null && _c !== void 0 ? _c : 0.25) * opacity
            },
            filter: addFilter([
                "any",
        ...
        if (!design.symbol) {
            mapLayers.push({
                ...
                paint: {
                    ...
                    "circle-stroke-color": (0, mapboxUtils_1.compileColorToMapbox)("white", (_d = design.axes.color) === null || _d === void 0 ? void 0 : _d.excludedValues),
...
#layer0[geometry_type='ST_Polygon'],#layer0[geometry_type='ST_MultiPolygon'] {
  polygon-fill: ` +
                (design.color || "#666666") +
                `;
  polygon-opacity: ${(_a = design.polygonFillOpacity) !== null && _a !== void 0 ? _a : 0.25};
}
\
`;
        // If color axes, add color conditions
