...
const BingLayer_1 = __importDefault(require("./BingLayer"));
const UtfGridLayer_1 = __importDefault(require("./UtfGridLayer"));
...
class LeafletMapComponent extends react_2.Component {
    constructor(props) {
        super(props);
    }
    /** Reloads all layers */
    ...
    updateMap(prevProps) {
        ...
        if (!prevProps ||
            ...
            switch (this.props.baseLayerId) {
                case "bing_road":
                    this.baseLayer = new BingLayer_1.default("Ao26dWY2IC8PjorsJKFaoR85EPXCnCohrJdisCWXIULAXFo0JAXquGauppTMQbyU", {
                        type: "Road"
                    });
                    break;
            ...
            if (this.props.layers) {
                        ...
                        geoJsonLayer = leaflet_1.default.geoJSON(layer.geometry, {
                            ...
                            pointToLayer: (geojson, latlng) => {
                                if (layer.pointStyle) {
                                    ...
                                    return leaflet_1.default.marker(latlng, { interactive: layer.nonInteractive ? false : true });
                                }
                            }
                        });
                        if (layer.onClick) {
                ...
                return (() => {
                    ...
                    for (layer of this.props.layers.slice().reverse()) {
                        ...
                        if (layer.utfGridUrl) {
                            utfGridLayer = new UtfGridLayer_1.default(layer.utfGridUrl, {
                                useJsonP: false,
