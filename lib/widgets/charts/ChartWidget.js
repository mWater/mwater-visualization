...
ChartWidgetComponent = (function(superClass) {
  ...
  ChartWidgetComponent.prototype.render = function() {
    ...
    }, this.renderChart(this.props.design, this.props.onDesignChange, this.props.width, this.props.height, this.props.standardWidth)), (emptyDesign || !validDesign) && (this.props.onDesignChange != null) ? this.renderEditLink() : void 0);
  };
