...
module.exports = LayeredChartDesignerComponent = function () {
  var LayeredChartDesignerComponent =
  /*#__PURE__*/
  function (_React$Component) {
    ...
    function LayeredChartDesignerComponent() {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(LayeredChartDesignerComponent).apply(this, arguments));
      _this.handleTypeChange = _this.handleTypeChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleTransposeChange = _this.handleTransposeChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      ...
      _this.handleProportionalChange = _this.handleProportionalChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleLabelsChange = _this.handleLabelsChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleYThresholdsChange = _this.handleYThresholdsChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleLayerChange = _this.handleLayerChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleRemoveLayer = _this.handleRemoveLayer.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleAddLayer = _this.handleAddLayer.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleXAxisLabelTextChange = _this.handleXAxisLabelTextChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleYAxisLabelTextChange = _this.handleYAxisLabelTextChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleToggleXAxisLabelClick = _this.handleToggleXAxisLabelClick.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleToggleYAxisLabelClick = _this.handleToggleYAxisLabelClick.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.renderLayer = _this.renderLayer.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      return _this;
    ...
    (0, _createClass2.default)(LayeredChartDesignerComponent, [{
      ...
      value: function render() {
        ...
        tabs.push({
          ...
          }, R('br'), this.renderType(), this.renderLayers(), this.renderThresholds())
        });
...
ThresholdsComponent = function () {
  ...
  function (_React$Component2) {
    ...
    function ThresholdsComponent() {
      ...
      _this4 = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(ThresholdsComponent).apply(this, arguments));
...
ThresholdComponent = function () {
  ...
  function (_React$Component3) {
    ...
    function ThresholdComponent() {
      ...
      return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(ThresholdComponent).apply(this, arguments));
    }
