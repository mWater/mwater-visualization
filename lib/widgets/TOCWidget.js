var BorderComponent, DropdownWidgetComponent, ModalPopupComponent, PropTypes, R, React, TOCWidget, TOCWidgetComponent, TOCWidgetDesignerComponent, TOCWidgetViewComponent, Widget, _, ui, update,
...
TOCWidgetComponent = (function(superClass) {
  ...
  function TOCWidgetComponent(props) {
    ...
    TOCWidgetComponent.__super__.constructor.call(this, props);
    this.state = {
      editing: false
    };
  }
...
TOCWidgetViewComponent = (function(superClass) {
  ...
  TOCWidgetViewComponent.prototype.render = function() {
    ...
    })(this)), this.props.onDesignChange && this.props.tocEntries.length === 0 ? R('div', {
