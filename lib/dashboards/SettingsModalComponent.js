var ActionCancelModalComponent, DashboardUtils, FiltersDesignerComponent, PropTypes, QuickfiltersDesignComponent, R, React, ReactSelect, SettingsModalComponent, _, languages, ui, update,
...
module.exports = SettingsModalComponent = (function(superClass) {
  ...
  function SettingsModalComponent(props) {
    ...
    SettingsModalComponent.__super__.constructor.call(this, props);
    this.state = {
      design: null
    };
  }
