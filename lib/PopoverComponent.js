...
class PopoverComponent extends react_1.default.Component {
    ...
    updatePopover(props, oldProps) {
        ...
        if (oldProps && oldProps.visible) {
            jquery_1.default(react_dom_1.default.findDOMNode(this)).popover("destroy");
        }
        if (props && props.visible) {
            const div = document.createElement("div");
            return react_dom_1.default.render(this.props.content, div, () => {
                jquery_1.default(react_dom_1.default.findDOMNode(this)).popover({
                    content() {
                ...
                return jquery_1.default(react_dom_1.default.findDOMNode(this)).popover("show");
            });
        }
    }
    render() {
