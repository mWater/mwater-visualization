...
class CalendarChartDesignerComponent extends react_1.default.Component {
    ...
    renderCellColor() {
        return R("div", { className: "form-group" }, R("label", { className: "text-muted" }, R("span", { className: "glyphicon glyphicon glyphicon-tint" }), "Cell Color"), R("div", null, R(ColorComponent_1.default, {
