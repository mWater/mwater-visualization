...
module.exports = MWaterTableSelectComponent = (function(superClass) {
  ...
  function MWaterTableSelectComponent(props) {
    ...
    MWaterTableSelectComponent.__super__.constructor.call(this, props);
    this.state = {
...
CompleteTableSelectComponent = (function(superClass) {
  ...
  CompleteTableSelectComponent.prototype.renderSweetSense = function() {
    ...
    return R(uiComponents.OptionListComponent, {
      items: _.map(sweetSenseTables, (function(_this) {
  ...
  CompleteTableSelectComponent.prototype.getSweetSenseTables = function() {
    return _.filter(this.props.schema.getTables(), (function(_this) {
      return function(table) {
        if (table.deprecated) {
          return false;
        }
...
FormsListComponent = (function(superClass) {
  ...
  function FormsListComponent(props) {
    ...
    FormsListComponent.__super__.constructor.call(this, props);
    this.state = {
      forms: null,
      search: ""
    };
...
IndicatorsListComponent = (function(superClass) {
  ...
  function IndicatorsListComponent(props) {
    ...
    this.handleTableRemove = bind(this.handleTableRemove, this);
    this.handleTableAdd = bind(this.handleTableAdd, this);
    IndicatorsListComponent.__super__.constructor.call(this, props);
    this.state = {
      indicators: null,
      search: ""
    };
...
AddIndicatorConfirmPopupComponent = (function(superClass) {
  ...
  function AddIndicatorConfirmPopupComponent(props) {
    AddIndicatorConfirmPopupComponent.__super__.constructor.call(this, props);
    this.state = {
      visible: false,
      indicatorTable: null
    };
...
IssuesListComponent = (function(superClass) {
  ...
  function IssuesListComponent(props) {
    ...
    this.handleTableRemove = bind(this.handleTableRemove, this);
    this.handleTableAdd = bind(this.handleTableAdd, this);
    IssuesListComponent.__super__.constructor.call(this, props);
    this.state = {
      issueTypes: null,
      search: ""
    };
