...
module.exports = QuickfiltersComponent = function () {
  var QuickfiltersComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(QuickfiltersComponent, _React$Component);

    var _super = _createSuper(QuickfiltersComponent);
    ...
    (0, _createClass2["default"])(QuickfiltersComponent, [{
      ...
      value: function render() {
        ...
        return R('div', {
          style: {
            borderTop: !this.props.hideTopBorder ? "solid 1px #E8E8E8" : void 0,
            borderBottom: "solid 1px #E8E8E8",
            padding: 5
          }
        }, _.map(this.props.design, function (item, i) {
          return _this2.renderQuickfilter(item, i);
        }), this.props.onHide ? R('button', {
...
EnumQuickfilterComponent = function () {
  ...
  var EnumQuickfilterComponent = /*#__PURE__*/function (_React$Component2) {
    (0, _inherits2["default"])(EnumQuickfilterComponent, _React$Component2);

    var _super2 = _createSuper(EnumQuickfilterComponent);
    ...
    (0, _createClass2["default"])(EnumQuickfilterComponent, [{
      ...
      value: function render() {
        ...
        var minWidth, options, ref, ref1, width;
        ...
        })) != null ? (ref1 = ref.label) != null ? ref1.length : void 0 : void 0;
...
TextQuickfilterComponent = function () {
  ...
  var TextQuickfilterComponent = /*#__PURE__*/function (_React$Component3) {
    (0, _inherits2["default"])(TextQuickfilterComponent, _React$Component3);

    var _super3 = _createSuper(TextQuickfilterComponent);
...
DateQuickfilterComponent = function () {
  ...
  var DateQuickfilterComponent = /*#__PURE__*/function (_React$Component4) {
    (0, _inherits2["default"])(DateQuickfilterComponent, _React$Component4);

    var _super4 = _createSuper(DateQuickfilterComponent);
...
TextArrayQuickfilterComponent = function () {
  // Quickfilter for a text value
  var TextArrayQuickfilterComponent = /*#__PURE__*/function (_React$Component5) {
    (0, _inherits2["default"])(TextArrayQuickfilterComponent, _React$Component5);

    var _super5 = _createSuper(TextArrayQuickfilterComponent);
