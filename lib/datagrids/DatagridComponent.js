...
exports.default = DatagridComponent = (function () {
    var _a;
    DatagridComponent = (_a = class DatagridComponent extends react_1.default.Component {
            constructor(props) {
                super(props);
            ...
            renderEditButton() {
                ...
                }, R("span", { className: "glyphicon glyphicon-cog" }), " ", "Settings");
            }
            renderFindReplace() {
                if (!this.state.cellEditingEnabled) {
                    return null;
            ...
            render() {
                ...
                }, this.renderTitleBar(filters), this.renderQuickfilter(), this.renderEditor(), this.renderFindReplaceModal(filters), R(AutoSizeComponent_1.default, { injectWidth: true, injectHeight: true }, (size) => {
