...
var ChoroplethLayer = /** @class */ (function (_super) {
    ...
    ChoroplethLayer.prototype.cleanDesign = function (design, schema) {
        ...
        design = immer_1.produce(design, function (draft) {
            ...
            // Clean the axes
            if (draft.regionMode === "indirect" && design.table) {
                draft.axes.color = axisBuilder.cleanAxis({ axis: immer_1.original(draft.axes.color) || null, table: design.table, types: ['enum', 'text', 'boolean', 'date'], aggrNeed: "required" });
                draft.axes.label = axisBuilder.cleanAxis({ axis: immer_1.original(draft.axes.label) || null, table: design.table, types: ['text', 'number'], aggrNeed: "required" });
            }
                ...
                draft.axes.color = axisBuilder.cleanAxis({ axis: immer_1.original(draft.axes.color) || null, table: regionsTable, types: ['enum', 'text', 'boolean', 'date'], aggrNeed: "none" });
                draft.axes.label = axisBuilder.cleanAxis({ axis: immer_1.original(draft.axes.label) || null, table: regionsTable, types: ['text', 'number'], aggrNeed: "none" });
            }
