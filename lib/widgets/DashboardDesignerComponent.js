...
module.exports = DashboardDesignerComponent = (function(superClass) {
  ...
  DashboardDesignerComponent.prototype.renderWidgetDesigner = function(item) {
  ...
  DashboardDesignerComponent.prototype.render = function() {
    ...
    return H.div(null, this.renderUndoRedo(), H.br(), item ? this.renderWidgetDesigner(item) : this.renderGeneralDesigner());
  };
