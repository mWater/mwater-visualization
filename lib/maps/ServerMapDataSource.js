...
var $, LayerFactory, ServerLayerDataSource, ServerMapDataSource, ServerMapLayerPopupWidgetDataSource, _, compressJson, injectTableAlias, querystring;
...
module.exports = ServerMapDataSource = /*#__PURE__*/function () {
...
ServerLayerDataSource = /*#__PURE__*/function () {
  // Create map url source that uses map design stored on server
  // options:
  //   apiUrl: API url to use for talking to mWater server
  //   client: client id to use for talking to mWater server
...
ServerMapLayerPopupWidgetDataSource = /*#__PURE__*/function () {
  // options:
  //   apiUrl: API url to use for talking to mWater server
  //   client: client id to use for talking to mWater server
  //   share: share id to use for talking to mWater server
