...
module.exports = BufferLayer = (function(superClass) {
  ...
  BufferLayer.prototype.createJsonQL = function(design, schema, filters) {
    var axisBuilder, boundingBox, bufferedGeometry, cases, colorExpr, exprCompiler, filter, geometryExpr, j, len, order, query, radiusDeg, relevantFilters, selects, whereClauses;
    ...
    if (design.axes.color && design.axes.color.colorMap) {
      ...
      cases = _.map(order, (function(_this) {
        return function(value, i) {
          return {
            when: value != null ? {
              type: "op",
              op: "=",
              exprs: [colorExpr, value]
            } : {
              type: "op",
              op: "is null",
              exprs: [colorExpr]
  ...
  BufferLayer.prototype.onGridClick = function(ev, clickOptions) {
    ...
    if (ev.data && ev.data.id) {
      results = {
        row: {
          tableId: clickOptions.design.table,
