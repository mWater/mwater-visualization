...
exports.MWaterAssetSystemsListComponent = (props) => {
    ...
    react_1.useEffect(() => {
        fetch(`${props.apiUrl}asset_systems?client=${props.client || ""}`)
            ...
            setSystems(lodash_1.default.sortByAll(body, [
                ...
                (m) => mwater_expressions_1.ExprUtils.localizeString(m.name, props.locale)
            ]));
        });
    }, []);
    react_1.useEffect(() => {
    ...
    const renderAssetSystems = () => {
        const items = systems
            ...
            return {
                name: mwater_expressions_1.ExprUtils.localizeString(m.name, props.locale) || "",
    ...
    return (react_2.default.createElement("div", null,
        ...
        react_2.default.createElement("div", { className: "alert alert-info" },
            react_2.default.createElement("i", { className: "fa fa-info-circle" }),
