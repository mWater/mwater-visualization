...
describe("MWaterGlobalFiltersComponent", function () {
  it("extracts _managed_by filter", function () {
    const wrapper = enzyme.shallow(
      R(MWaterGlobalFiltersComponent, {
        schema: {},
        dataSource: {},
        filterableTables: [],
        globalFilters: [
          {
            ...
            columnType: "id",
            op: "within",
            exprs: [{ type: "literal", valueType: "id", idTable: "subjects", value: "group:xyz" }]
          }
        ],
        onChange() {}
      })
      ...
      onChange.calledWith([
        {
          ...
          columnType: "id",
          op: "within",
          exprs: [{ type: "literal", valueType: "id", idTable: "subjects", value: "group:abc" }]
        }
      ])
    )
  })
        ...
        globalFilters: [
          {
            ...
            columnType: "id",
            op: "within any",
            exprs: [{ type: "literal", valueType: "id[]", idTable: "admin_regions", value: [123, 456] }]
          }
        ],
        onChange() {}
      })
      ...
      onChange.calledWith([
        {
          ...
          columnType: "id",
          op: "within any",
          exprs: [{ type: "literal", valueType: "id[]", idTable: "admin_regions", value: [789] }]
        }
      ])
    )
  })
