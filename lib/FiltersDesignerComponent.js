...
PopoverHelpComponent = require('react-library/lib/PopoverHelpComponent'); // Designer for filters of multiple tables. Used for maps and dashboards
...
module.exports = FiltersDesignerComponent = function () {
  ...
  function (_React$Component) {
    ...
    function FiltersDesignerComponent() {
      ...
      _this.renderFilterableTable = _this.renderFilterableTable.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      return _this;
    }
