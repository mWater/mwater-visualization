...
class MWaterGlobalFiltersComponent extends react_1.default.Component {
    ...
    render() {
        ...
        return R("div", null, R(ui.FormGroup, { label: "Only sites managed by", labelMuted: true }, R(mwater_expressions_ui_1.IdLiteralComponent, {
            value: managedBy,
        ...
        })), R(ui.FormGroup, { label: "Only sites located in", labelMuted: true }, R(mwater_expressions_ui_1.IdLiteralComponent, {
            value: adminRegions,
