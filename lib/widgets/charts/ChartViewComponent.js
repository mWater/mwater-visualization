var ChartViewComponent, H, PropTypes, React, asyncLatest,
...
module.exports = ChartViewComponent = (function(superClass) {
  ...
  ChartViewComponent.prototype.componentWillReceiveProps = function(nextProps) {
    var base, base1;
    if (!_.isEqual(nextProps.design, this.props.design) || !_.isEqual(nextProps.filters, this.props.filters) || (typeof (base = nextProps.widgetDataSource).getCacheExpiry === "function" ? base.getCacheExpiry() : void 0) !== this.state.cacheExpiry) {
      this.setState({
        cacheExpiry: typeof (base1 = nextProps.widgetDataSource).getCacheExpiry === "function" ? base1.getCacheExpiry() : void 0
      });
