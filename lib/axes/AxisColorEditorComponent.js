var AsyncLoadComponent, AxisBuilder, AxisColorEditorComponent, ColorMapComponent, ColorPaletteCollectionComponent, H, R, React, _, update,
...
module.exports = AxisColorEditorComponent = (function(superClass) {
  ...
  AxisColorEditorComponent.prototype.load = function(props, prevProps, callback) {
    ...
    if (categories.length > 1) {
      ...
      if (!props.axis.colorMap || !_.isEqual(_.pluck(props.axis.colorMap, "value"), _.pluck(categories, "value"))) {
  ...
  AxisColorEditorComponent.prototype.render = function() {
    ...
    return H.div(null, this.state.mode === "palette" ? this.state.loading ? H.span(null, "Loading...") : R(ColorPaletteCollectionComponent, {
    ...
    }, H.div(null, R(ColorMapComponent, {
      ...
      categories: this.state.categories,
      key: "colorMap",
      reorderable: drawOrder && this.props.colorMapReorderable,
      order: drawOrder,
      onOrderChange: this.handleDrawOrderChange
    }))) : void 0) : void 0);
  };
