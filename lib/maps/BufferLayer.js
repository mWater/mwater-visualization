...
module.exports = BufferLayer = (function(superClass) {
  ...
  BufferLayer.prototype.createKMLExportJsonQL = function(design, schema, filters) {
    var axisBuilder, bufferedGeometry, cases, categories, colorExpr, column, exprCompiler, extraFields, field, filter, geometryExpr, j, k, len, len1, order, query, radiusDeg, relevantFilters, selects, whereClauses;
    axisBuilder = new AxisBuilder({
      schema: schema
    });
    exprCompiler = new ExprCompiler(schema);
