...
export default EditExprCellComponent = (function() {
  EditExprCellComponent = class EditExprCellComponent extends React.Component {
    ...
    render() {
      ...
      switch (exprType) {
        case "text":
          return R(TextEditComponent, {value: this.state.value, onChange: this.handleChange, onSave: this.props.onSave, onCancel: this.props.onCancel});
          break;
        case "number":
          return R(NumberEditComponent, {value: this.state.value, onChange: this.handleChange, onSave: this.props.onSave, onCancel: this.props.onCancel});
          break;
        case "enum":
          return R(EnumEditComponent, {value: this.state.value, onChange: this.handleChange, enumValues: exprUtils.getExprEnumValues(this.props.expr), onSave: this.props.onSave, onCancel: this.props.onCancel, locale: this.props.locale});
          break;
      }
