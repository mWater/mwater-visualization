    ...
    return React.createElement(MWaterLoaderComponent, {
      ...
      return function(error, config) {
        ...
        return H.div({
          ...
          getSystemActions: function(table) {
            return [
              {
                id: "open",
                name: "Open " + table,
          ...
          onSystemAction: function(actionId, tableId, rowIds) {
            return alert(actionId + " " + tableId + ":" + (rowIds.join(",")));
          }
        }));
      };
    })(this));
    ...
    return React.createElement(MWaterLoaderComponent, {
      ...
      return function(error, config) {
        ...
        return H.div({
          ...
          mapDataSource: mapDataSource,
          onDesignChange: _this.handleDesignChange,
          onSystemAction: function(actionId, tableId, rowId) {
            return alert(actionId + " " + tableId + ":" + rowId);
          },
          titleElem: "Sample"
        }));
      };
