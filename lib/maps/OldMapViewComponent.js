...
LegendComponent = require('./LegendComponent')["default"]; // Component that displays just the map

module.exports = OldMapViewComponent = function () {
  var OldMapViewComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(OldMapViewComponent, _React$Component);

    var _super = _createSuper(OldMapViewComponent);

    function OldMapViewComponent(props) {
      var _this;

      (0, _classCallCheck2["default"])(this, OldMapViewComponent);
      var initialLegendDisplay;
      ...
      initialLegendDisplay = props.design.initialLegendDisplay || "open";
      _this.state = {
        popupContents: null,
    ...
    (0, _createClass2["default"])(OldMapViewComponent, [{
      ...
      value: function handleBoundsChange(bounds) {
        var design;
        boundMethodCheck(this, OldMapViewComponent); // Ignore if readonly
      ...
      value: function handleGridClick(layerViewId, ev) {
        ...
        boundMethodCheck(this, OldMapViewComponent);
      ...
      value: function render() {
        ...
        }, this.renderPopup(), this.props.onDesignChange && this.props.design.showLayerSwitcher ? R(LayerSwitcherComponent, {
          design: this.props.design,
          onDesignChange: this.props.onDesignChange
        }) : void 0, R(LeafletMapComponent, {
          ref: function ref(c) {
            return _this5.leafletMap = c;
          },
  ...
  OldMapViewComponent.contextTypes = {
    locale: PropTypes.string
  };
  return OldMapViewComponent;
}.call(void 0); // Legend display tab at bottom right


HiddenLegend = /*#__PURE__*/function (_React$Component2) {
  (0, _inherits2["default"])(HiddenLegend, _React$Component2);

  var _super2 = _createSuper(HiddenLegend);

  function HiddenLegend() {
    (0, _classCallCheck2["default"])(this, HiddenLegend);
    return _super2.apply(this, arguments);
  }

  (0, _createClass2["default"])(HiddenLegend, [{
    key: "render",
    value: function render() {
      var style;
      style = {
