...
interface LayoutCellComponentProps {
  ...
  onHover?: () => void  
  onEditSection?: () => void
  onSummarizeSegment?: () => void
}

/** Single layout cell */
class LayoutCellComponent extends React.Component<LayoutCellComponentProps> {
  tdComponent: Element | null
  ...
  render() {
    ...
    if (isHover) {
      backgroundColor = Color(backgroundColor || "#ffffff").darken(0.03).toString()
    }
