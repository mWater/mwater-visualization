...
module.exports = LayeredChartCompiler = (function() {
  ...
  LayeredChartCompiler.prototype.createChartOptions = function(options) {
    ...
    if (options.design.labels) {
      _.each(options.design.layers, (function(_this) {
        return function(layer, layerIndex) {
          var ref, ref1;
          if ((ref = layer.axes) != null ? (ref1 = ref.y) != null ? ref1.format : void 0 : void 0) {
            if (!chartDesign.data.labels.format) {
              chartDesign.data.labels = {
                format: {}
              };
            }
            return chartDesign.data.labels.format["" + layerIndex] = d3.format(layer.axes.y.format);
          }
        };
      })(this));
    }
  ...
  LayeredChartCompiler.prototype.compileDataCategorical = function(design, data, locale) {
    var categories, categoryMap, categoryOrder, categoryXs, colors, column, columns, dataMap, defaultStacked, groups, i, j, k, layer, layerIndex, len, len1, len2, m, n, names, o, ref, ref1, ref2, stacked, types, xAxis, xType, xValues, xs, xtotals;
    columns = [];
    types = {};
    names = {};
    dataMap = {};
