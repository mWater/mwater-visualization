        ...
        for (let index = 0; index < this.props.design.layerViews.length; index++) {
            ...
            let leafletLayer = {
                ...
                utfGridUrl: this.props.disableInteraction
                    ? undefined
                    : (_a = layerDataSource.getUtfGridUrl(design, isScoping ? compiledFilters : scopedCompiledFilters)) !== null && _a !== void 0 ? _a : undefined,
            ...
            if (isScoping) {
                leafletLayer = {
                    ...
                    utfGridUrl: this.props.disableInteraction
                        ? undefined
                        : (_d = layerDataSource.getUtfGridUrl(design, scopedCompiledFilters)) !== null && _d !== void 0 ? _d : undefined,
                    visible: layerView.visible,
