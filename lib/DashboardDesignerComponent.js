...
module.exports = DashboardDesignerComponent = (function(superClass) {
  ...
  function DashboardDesignerComponent() {
    this.handleAddBarChart = bind(this.handleAddBarChart, this);
  ...
  DashboardDesignerComponent.prototype.handleAddBarChart = function() {
  ...
  DashboardDesignerComponent.prototype.renderGeneralDesigner = function() {
    return H.div(null, H.div(null, "Click on widgets to edit them"), H.a({
