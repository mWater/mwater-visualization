...
require('leaflet-loading'); // Leaflet map component that displays a base layer, a tile layer and an optional interactivity layer
  ...
  function (_React$Component) {
    ...
    (0, _createClass2.default)(LeafletMapComponent, [{
      ...
      value: function updateMap(prevProps) {
        var i, j, k, l, layer, len, len1, len2, len3, options, ref, ref1, ref2, ref3, results, tileLayer, utfGridLayer; // Update size
        ...
        if (!prevProps || JSON.stringify(_.omit(this.props.layers, "onGridClick", "onGridHover")) !== JSON.stringify(_.omit(prevProps.layers, "onGridClick", "onGridHover"))) {
          ...
          if (this.props.layers) {
            ...
            for (k = 0, len2 = ref2.length; k < len2; k++) {
              layer = ref2[k]; // Do not display if not visible or no tile url
            ...
            this.utfGridLayers = [];
            ref3 = this.props.layers.slice().reverse(); // Add grid layers in reverse order
