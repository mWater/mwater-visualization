...
produce = require('immer')["default"]; // Category map for an axis. Controls the colorMap values and excludedValues
// Can be collapsed

module.exports = CategoryMapComponent = function () {
  var CategoryMapComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(CategoryMapComponent, _React$Component);

    var _super = _createSuper(CategoryMapComponent);
    ...
    function CategoryMapComponent(props) {
      ...
      _this.handleCategoryLabelChange = _this.handleCategoryLabelChange.bind((0, _assertThisInitialized2["default"])(_this));
    ...
    (0, _createClass2["default"])(CategoryMapComponent, [{
      ...
      value: function handleNullLabelChange(e) {
        var name;
        boundMethodCheck(this, CategoryMapComponent);
        name = prompt("Enter label for none value", this.props.axis.nullLabel || "None");
      ...
      key: "handleCategoryLabelChange",
      value: function handleCategoryLabelChange(category, e) {
        var label, name;
        boundMethodCheck(this, CategoryMapComponent);
        ...
        if (name != null) {
          if (name) {
            return this.props.onChange(produce(this.props.axis, function (draft) {
