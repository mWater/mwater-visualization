...
LayerDesignerComponent = (function(superClass) {
  ...
  LayerDesignerComponent.prototype.render = function() {
    var layer;
    layer = this.props.design.layers[this.props.index];
    return H.div(null, this.renderRemove(), this.renderTable(), this.isLayerPolar(layer) ? this.renderColorAxis() : void 0, this.renderXAxis(), layer.axes.x || layer.axes.color ? this.renderYAxis() : void 0, layer.axes.x && layer.axes.y && !this.isLayerPolar(layer) ? this.renderColorAxis() : void 0, this.renderColor(), this.renderFilter(), this.renderName());
  };
