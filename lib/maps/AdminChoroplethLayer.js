var AdminChoroplethLayer, AxisBuilder, ExprCleaner, ExprCompiler, ExprUtils, Layer, LayerLegendComponent, LegendGroup, PopupFilterJoinsUtils, R, React, _, injectTableAlias,
...
module.exports = AdminChoroplethLayer = (function(superClass) {
  ...
  AdminChoroplethLayer.prototype.createJsonQL = function(design, schema, filters) {
    var axisBuilder, colorExpr, compiledAdminRegionExpr, exprCompiler, filter, i, innerQuery, labelExpr, len, query, ref, ref1, regionsTable, relevantFilters, whereClauses;
    ...
    regionsTable = design.regionsTable || "admin_regions";
  ...
  AdminChoroplethLayer.prototype.onGridClick = function(ev, clickOptions) {
    var BlocksLayoutManager, WidgetFactory, compiledFilterExpr, defaultPopupFilterJoins, exprCompiler, filter, filterExpr, popupFilterJoins, popupFilters, regionsTable, results, table;
    regionsTable = clickOptions.design.regionsTable || "admin_regions";
  ...
  AdminChoroplethLayer.prototype.getBounds = function(design, schema, dataSource, filters, callback) {
    ...
    return this.getBoundsFromExpr(schema, dataSource, regionsTable, {
      type: "field",
      table: regionsTable,
      column: "shape"
  ...
  AdminChoroplethLayer.prototype.cleanDesign = function(design, schema) {
    var axisBuilder, exprCleaner, regionsTable;
    regionsTable = design.regionsTable || "admin_regions";
  ...
  AdminChoroplethLayer.prototype.createKMLExportJsonQL = function(design, schema, filters) {
    var adminGeometry, axisBuilder, colorExpr, compiledAdminRegionExpr, exprCompiler, filter, i, innerQuery, labelExpr, len, query, ref, ref1, regionsTable, relevantFilters, valueExpr, whereClauses;
    regionsTable = design.regionsTable || "admin_regions";
    axisBuilder = new AxisBuilder({
      schema: schema
    });
