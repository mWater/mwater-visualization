var AxisComponent, ColorComponent, EditPopupComponent, ExprCompiler, ExprUtils, FilterExprComponent, H, MarkerSymbolSelectComponent, MarkersLayerDesignerComponent, PopupFilterJoinsUtils, PropTypes, R, React, TableSelectComponent, ZoomLevelsComponent, _, ui,
...
module.exports = MarkersLayerDesignerComponent = (function(superClass) {
  ...
  MarkersLayerDesignerComponent.prototype.render = function() {
    return H.div(null, this.renderTable(), this.renderGeometryAxis(), this.renderColor(), this.renderSymbol(), this.renderMarkerSize(), this.renderFilter(), this.renderPopup(), this.props.design.table ? R(ZoomLevelsComponent, {
      design: this.props.design,
      onDesignChange: this.props.onDesignChange
    }) : void 0);
  };
