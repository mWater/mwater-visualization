...
class ColorPaletteComponent extends react_1.default.Component {
    ...
    render() {
        ...
        R("tr", null, lodash_1.default.map(lodash_1.default.range(0, 8), (i) => {
            return this.renderColor(color_1.default({ r: (i * 255) / 7, g: (i * 255) / 7, b: (i * 255) / 7 }).hex());
        })), R("tr", { style: { height: 5 } }), 
        // Base colors
        R("tr", null, lodash_1.default.map(baseColors, (c) => this.renderColor(c))), R("tr", { style: { height: 5 } }), R("tr", null, lodash_1.default.map(baseColors, (c) => this.renderColor(color_1.default(c).lighten(0.7).hex()))), R("tr", null, lodash_1.default.map(baseColors, (c) => this.renderColor(color_1.default(c).lighten(0.5).hex()))), R("tr", null, lodash_1.default.map(baseColors, (c) => this.renderColor(color_1.default(c).lighten(0.3).hex()))), R("tr", null, lodash_1.default.map(baseColors, (c) => this.renderColor(color_1.default(c).darken(0.3).hex()))), R("tr", null, lodash_1.default.map(baseColors, (c) => this.renderColor(color_1.default(c).darken(0.5).hex()))), R("tr", null, lodash_1.default.map(baseColors, (c) => this.renderColor(color_1.default(c).darken(0.7).hex()))))));
    }
}
