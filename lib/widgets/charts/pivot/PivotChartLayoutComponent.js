...
LayoutCellComponent = (function(superClass) {
  ...
  LayoutCellComponent.prototype.render = function() {
    var backgroundColor, cell, innerStyle, isHover, ref, style;
    cell = this.props.layout.rows[this.props.rowIndex].cells[this.props.columnIndex];
    if (cell.type === "skip") {
      return null;
    }
    ...
    style = {
      ...
      borderTop: cell.sectionTop ? "solid 1px #ccc" : cell.section ? "solid 1px #eee" : void 0,
      borderBottom: cell.sectionBottom ? "solid 1px #ccc" : cell.section ? "solid 1px #eee" : void 0,
      borderLeft: cell.sectionLeft ? "solid 1px #ccc" : cell.section ? "solid 1px #eee" : void 0,
      borderRight: cell.sectionRight ? "solid 1px #ccc" : cell.section ? "solid 1px #eee" : void 0
    };
    innerStyle = {
