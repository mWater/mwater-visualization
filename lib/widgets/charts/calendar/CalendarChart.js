...
var AxisBuilder, CalendarChart, Chart, ExprCleaner, ExprCompiler, R, React, _, injectTableAlias, moment;
...
function (_Chart) {
  ...
  function CalendarChart() {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(CalendarChart).apply(this, arguments));
  }
  ...
  (0, _createClass2.default)(CalendarChart, [{
    ...
    value: function cleanDesign(design, schema) {
      ...
      design.version = design.version || 1; // Clean axes
