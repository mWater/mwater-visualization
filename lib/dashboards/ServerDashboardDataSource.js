...
var $, ServerDashboardDataSource, ServerQuickfilterDataSource, ServerWidgetDataSource, ServerWidgetLayerDataSource, ServerWidgetLayerPopupWidgetDataSource, ServerWidgetMapDataSource, _, compressJson, injectTableAlias, querystring;

_ = require('lodash');
$ = require('jquery');
querystring = require('querystring');
injectTableAlias = require('mwater-expressions').injectTableAlias;
compressJson = require('../compressJson'); // Uses mWater server to get widget data to allow sharing with unprivileged users
