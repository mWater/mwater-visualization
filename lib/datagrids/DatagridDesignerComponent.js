var ColumnDesignerComponent, ColumnsDesignerComponent, DatagridDesignerComponent, DatagridOptionsComponent, ExprComponent, ExprUtils, FilterExprComponent, H, LabeledExprGenerator, OrderBysDesignerComponent, PropTypes, QuickfiltersDesignComponent, R, React, ReorderableListComponent, TabbedComponent, TableSelectComponent, _, ui, update, uuid,
...
module.exports = DatagridDesignerComponent = (function(superClass) {
  ...
  DatagridDesignerComponent.prototype.handleGlobalFiltersChange = function(globalFilters) {
    return this.props.onDesignChange(update(this.props.design, {
      globalFilters: {
        $set: globalFilters
      }
      ...
      tabs: [
        {
          ...
          }), this.context.globalFiltersElementFactory ? H.div({
            style: {
              marginTop: 20
            }
...
DatagridOptionsComponent = (function(superClass) {
  extend(DatagridOptionsComponent, superClass);

  function DatagridOptionsComponent() {
    return DatagridOptionsComponent.__super__.constructor.apply(this, arguments);
  }
  ...
  DatagridOptionsComponent.prototype.render = function() {
    return R(ui.FormGroup, {
      label: "Display Options"
    }, R(ui.Checkbox, {
      value: this.props.design.showRowNumbers,
      onChange: ((function(_this) {
        return function(showRowNumbers) {
          return _this.props.onDesignChange(update(_this.props.design, {
            showRowNumbers: {
              $set: showRowNumbers
            }
