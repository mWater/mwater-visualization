...
class MarkersLayerDesignerComponent extends react_1.default.Component {
    ...
    renderColor() {
        ...
        return R("div", null, !this.props.design.axes.color
            ? R("div", { className: "form-group" }, R("label", { className: "text-muted" }, R("span", { className: "glyphicon glyphicon glyphicon-tint" }), "Color"), R("div", null, R(ColorComponent_1.default, {
    ...
    renderMarkerSize() {
        ...
        return R("div", { className: "form-group" }, R("label", { className: "text-muted" }, "Marker Size"), R(bootstrap_1.default.Select, {
    ...
    renderLineWidth() {
        ...
        return R("div", { className: "form-group" }, R("label", { className: "text-muted" }, "Line Width (for shapes)"), R(bootstrap_1.default.Select, {
