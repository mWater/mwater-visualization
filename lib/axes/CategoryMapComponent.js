...
module.exports = CategoryMapComponent = (function(superClass) {
  ...
  function CategoryMapComponent() {
    ...
    return CategoryMapComponent.__super__.constructor.apply(this, arguments);
  }
  ...
  CategoryMapComponent.prototype.renderNonReorderable = function() {
    return H.div(null, _.map(this.props.categories, (function(_this) {
      return function(category) {
