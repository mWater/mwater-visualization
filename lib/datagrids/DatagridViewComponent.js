...
class DatagridViewComponent extends react_1.default.Component {
    constructor(props) {
        ...
        this.handleCellClick = (rowIndex, columnIndex) => {
            ...
            this.props.canEditValue(this.props.design.table, this.state.rows[rowIndex].id, column.expr, (error, canEdit) => {
                // TODO handle error
                if (error) {
                    throw error;
                }
        ...
        this.handleSaveEdit = () => {
            ...
            this.setState({ savingCell: true }, () => {
                this.props.updateValue(this.props.design.table, rowId, expr, value, (error) => {
                    // TODO handle error
                    // Reload row
