...
/** Chart types */
const chartTypes = {
    bar: billboard_js_1.bar,
    line: billboard_js_1.line,
    spline: billboard_js_1.spline,
...
class LayeredChartCompiler {
    ...
    createChartOptions(options) {
        ...
        if (options.design.labels) {
            ...
            if (!options.design.transpose) {
                chartDesign.data.labels = Object.assign(Object.assign({}, chartDesign.data.labels), { position: {
                        y: 15
                    } });
            }
        }
        if (lodash_1.default.isEmpty(chartDesign.data.types)) {
        ...
        if (options.design.labels && !lodash_1.default.isEmpty(c3Data.format)) {
            ...
            chartDesign.data.labels = Object.assign(Object.assign({}, chartDesign.data.labels), { format: c3Data.format });
        }
        ...
        lodash_1.default.each(design.layers, (layer, layerIndex) => {
            ...
            if (layer.axes.color) {
                ...
                lodash_1.default.each(colorValues, (colorValue) => {
                    ...
                    lodash_1.default.each(rows, (row, rowIndex) => {
                ...
                if (layer.trendline === "linear") {
                    ...
                    format[trendlineSeries] = (value) => value != null ? this.axisBuilder.formatValue(layer.axes.y, d3Round(value), locale, true) : "";
    ...
    getLayerTypeString(design, layerIndex) {
