...
var BingLayer, L, LeafletLoading, LeafletMapComponent, PropTypes, R, React, ReactDOM, UtfGridLayer, _;
...
LeafletLoading = require('./LeafletLoading'); // See https://github.com/PaulLeCam/react-leaflet/issues/255#issuecomment-261904061 for issue with CSS + webpack
...
module.exports = LeafletMapComponent = function () {
  var LeafletMapComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(LeafletMapComponent, _React$Component);

    var _super = _createSuper(LeafletMapComponent);
