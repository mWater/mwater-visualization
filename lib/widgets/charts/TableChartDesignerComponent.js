var AxisBuilder, EditableLinkComponent, ExpressionBuilder, H, LogicalExprComponent, PopoverComponent, React, ScalarExprComponent, TableChartColumnDesignerComponent, TableChartDesignerComponent, _,
...
module.exports = TableChartDesignerComponent = (function(superClass) {
  ...
  TableChartDesignerComponent.prototype.render = function() {
    return H.div(null, this.renderTable(), this.renderColumns(), this.props.design.table ? H.hr() : void 0, this.renderFilter(), H.hr(), this.renderTitle());
  };
