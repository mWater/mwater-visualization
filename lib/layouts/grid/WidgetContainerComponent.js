...
const MoveLayoutComponent = react_dnd_1.DragSource("block-move", moveSpec, moveCollect)(LayoutComponent);
const resizeSpec = {
    beginDrag(props, monitor, component) {
        return props.dragInfo;
    },
...
const MoveResizeLayoutComponent = react_dnd_1.DragSource("block-resize", resizeSpec, resizeCollect)(MoveLayoutComponent);
...
class Container extends react_1.default.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        ...
        if (!lodash_1.default.isEqual(this.props.elems, nextProps.elems)) {
            return true;
        }
        return false;
    }
...
exports.default = react_dnd_2.DropTarget(["block-move", "block-resize"], targetSpec, targetCollect)(Container);
