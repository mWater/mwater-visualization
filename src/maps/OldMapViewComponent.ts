...
export default OldMapViewComponent = (function() {
  OldMapViewComponent = class OldMapViewComponent extends React.Component {
    ...
    renderLegend() {
      if (this.state.legendHidden) {
        return R(HiddenLegend,
          {onShow: () => this.setState({legendHidden: false})});
      } else {
      ...
      return R(ModalPopupComponent, { 
        ...
        size: "large"
          ...
          R('div', {style: { height: "80vh" }},
            this.state.popupContents),
          R('div', {style: { textAlign: "right", marginTop: 10 }},
            R('button', {className: "btn btn-default", onClick: (() => this.setState({popupContents: null}))},
              "Close")
          )
      );
    }
    ...
    render() {
      ...
      return R('div', {style: { width: this.props.width, height: this.props.height, position: 'relative' }},
        this.renderPopup(),
        ...
        R(LeafletMapComponent, {
          ref: c => { return this.leafletMap = c; },
...
class HiddenLegend extends React.Component {
  render() {
    ...
    return R('div', {style, onClick: this.props.onShow},
