...
module.exports = DatagridComponent = function () {
  ...
  function (_React$Component) {
    ...
    function DatagridComponent(props) {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(DatagridComponent).call(this, props)); // Get the values of the quick filters

      _this.getQuickfilterValues = _this.getQuickfilterValues.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))); // Get filters that are applied by the quickfilters

      _this.getQuickfilterFilters = _this.getQuickfilterFilters.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleCellEditingToggle = _this.handleCellEditingToggle.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    ...
    (0, _createClass2.default)(DatagridComponent, [{
      ...
      value: function render() {
        ...
        var filters, hasQuickfilters, ref; // Compile quickfilters

        filters = this.getQuickfilterFilters();
...
DatagridEditorComponent = function () {
  ...
  function (_React$Component2) {
    ...
    function DatagridEditorComponent(props) {
      ...
      _this7 = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(DatagridEditorComponent).call(this, props));
      _this7.state = {
        design: props.design
      };
      return _this7;
