...
module.exports = LeafletMapComponent = (function(superClass) {
  ...
  LeafletMapComponent.prototype.setBounds = function(bounds) {
    var curBounds, e, n, s, w;
    if (bounds) {
      if (this.hasBounds) {
  ...
  LeafletMapComponent.prototype.render = function() {
    return H.div(null, this.props.legend ? this.props.legend : void 0, H.div({
      ref: "map",
      style: {
