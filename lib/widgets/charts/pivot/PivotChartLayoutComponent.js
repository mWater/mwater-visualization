...
class PivotChartLayoutComponent extends react_1.default.Component {
    constructor(props) {
        super(props);
        ...
        this.renderHoverControls = () => {
            ...
            for (const key in this.cellComps) {
            ...
            if (sectionType === "row" && this.props.onInsertAfterSegment) {
                controls.push(this.renderHoverPlusIcon("bottom", (minX + maxX) / 2, maxY - 2, this.props.onInsertAfterSegment.bind(null, this.state.hoverSection)));
            }
...
class LayoutCellComponent extends react_1.default.Component {
    ...
    render() {
        ...
        if (isHover) {
            backgroundColor = (0, color_1.default)(backgroundColor || "#ffffff").darken(0.03).toString();
        }
        // Add striping
