...
exports.default = OldMapViewComponent = (function () {
    var _a;
    OldMapViewComponent = (_a = class OldMapViewComponent extends react_1.default.Component {
            constructor(props) {
                super(props);
            ...
            renderPopup() {
                ...
                R("div", { style: { height: "80vh" } }, this.state.popupContents), R("div", { style: { textAlign: "right", marginTop: 10 } }, R("button", { className: "btn btn-default", onClick: () => this.setState({ popupContents: null }) }, "Close")));
            }
            render() {
        ...
        _a.propTypes = {
            ...
            mapDataSource: prop_types_1.default.shape({
                ...
                getBounds: prop_types_1.default.func.isRequired
            }).isRequired,
            ...
            scope: prop_types_1.default.shape({
                name: prop_types_1.default.string.isRequired,
                filter: prop_types_1.default.shape({ table: prop_types_1.default.string.isRequired, jsonql: prop_types_1.default.object.isRequired }),
                data: prop_types_1.default.shape({ layerViewId: prop_types_1.default.string.isRequired, data: prop_types_1.default.any }).isRequired
            }),
            onScopeChange: prop_types_1.default.func,
            dragging: prop_types_1.default.bool,
            touchZoom: prop_types_1.default.bool,
            scrollWheelZoom: prop_types_1.default.bool,
            zoomLocked: prop_types_1.default.bool // Whether changes to zoom level should be persisted. Default false
        },
        _a.contextTypes = { locale: prop_types_1.default.string },
        _a);
