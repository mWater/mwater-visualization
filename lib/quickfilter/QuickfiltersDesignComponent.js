...
class QuickfilterDesignComponent extends react_1.default.Component {
    constructor(props) {
        ...
        this.state = {
            table: (((_a = props.design.expr) === null || _a === void 0 ? void 0 : _a.type) !== 'literal' && ((_b = props.design.expr) === null || _b === void 0 ? void 0 : _b.table)) ? (_c = props.design.expr) === null || _c === void 0 ? void 0 : _c.table : props.tables[0]
        };
    }
    componentDidUpdate(prevProps, prevState, snapshot) {
        var _a, _b, _c;
        if (((_a = this.props.design.expr) === null || _a === void 0 ? void 0 : _a.type) !== 'literal' && prevState.table !== ((_b = this.props.design.expr) === null || _b === void 0 ? void 0 : _b.table)) {
            this.setState({ table: (_c = this.props.design.expr) === null || _c === void 0 ? void 0 : _c.table });
        }
    }
    render() {
