var ExprCompiler, ExprUtils, H, LayerFactory, LeafletMapComponent, MapViewComponent, ModalPopupComponent, R, React, _,
...
module.exports = MapViewComponent = (function(superClass) {
  ...
  MapViewComponent.prototype.componentWillReceiveProps = function(nextProps) {
    var ref;
    if (!_.isEqual(nextProps.design.bounds, this.props.design.bounds)) {
      return (ref = this.refs.leafletMap) != null ? ref.setBounds(nextProps.design.bounds) : void 0;
    }
  };
  ...
  MapViewComponent.prototype.render = function() {
    var compiledFilters, design, exprCompiler, exprUtils, filters, index, isScoping, j, layer, layerDataSource, layerView, leafletLayer, leafletLayers, len, ref, scopedCompiledFilters;
    ...
    for (index = j = 0, len = ref.length; j < len; index = ++j) {
      ...
      leafletLayer = {
        tileUrl: layerDataSource.getTileUrl(isScoping ? compiledFilters : scopedCompiledFilters),
        utfGridUrl: layerDataSource.getUtfGridUrl(isScoping ? compiledFilters : scopedCompiledFilters),
        visible: layerView.visible,
        opacity: isScoping ? layerView.opacity * 0.5 : layerView.opacity,
