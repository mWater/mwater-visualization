  ...
  schema = schema.addTable({
    ...
    contents: [
      ...
      { id: "number", name: { en: "Number" }, type: "number" },
      {
        ...
        name: { en: "T2->T1" },
        type: "join",
        join: { fromColumn: "t1", toTable: "custom.ts15.t0", toColumn: "_id", type: "n-1" }
      }
    ]
  })
  return (schema = schema.addTable({
    id: "custom.ts15.t0",
    name: { _base: "en", en: "Cascading List Ref test 1" },
    primaryKey: "_id",
    contents: [
      {
        id: "c0",
        name: { en: "Region", _base: "en" },
        type: "enum",
        enumValues: [
          {
            id: "ev0",
