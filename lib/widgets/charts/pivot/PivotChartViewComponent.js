...
class PivotChartViewComponent extends react_1.default.Component {
    constructor(props) {
        ...
        this.handleSaveEditSegment = () => {
            ...
            const design = Object.assign(Object.assign({}, this.props.design), { rows: PivotChartUtils.replaceSegment(this.props.design.rows, segment), columns: PivotChartUtils.replaceSegment(this.props.design.columns, segment) });
        ...
        this.handleSaveEditIntersection = () => {
            ...
            const design = Object.assign(Object.assign({}, this.props.design), { intersections });
            this.props.onDesignChange(design);
        ...
        this.handleRemoveSegment = (segmentId) => {
            const design = Object.assign(Object.assign({}, this.props.design), { rows: PivotChartUtils.removeSegment(this.props.design.rows, segmentId), columns: PivotChartUtils.removeSegment(this.props.design.columns, segmentId) });
            return this.props.onDesignChange(design);
        };
        this.handleInsertBeforeSegment = (segmentId) => {
            const design = Object.assign(Object.assign({}, this.props.design), { rows: PivotChartUtils.insertBeforeSegment(this.props.design.rows, segmentId), columns: PivotChartUtils.insertBeforeSegment(this.props.design.columns, segmentId) });
            return this.props.onDesignChange(design);
        };
        ...
        this.handleAddChildSegment = (segmentId) => {
            const design = Object.assign(Object.assign({}, this.props.design), { rows: PivotChartUtils.addChildSegment(this.props.design.rows, segmentId), columns: PivotChartUtils.addChildSegment(this.props.design.columns, segmentId) });
            return this.props.onDesignChange(design);
        };
