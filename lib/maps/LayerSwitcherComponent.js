...
function LayerSwitcherComponent(props) {
    ...
    return react_1.default.createElement("div", { style: { position: "absolute", top: 20, right: 20, zIndex: 1000, userSelect: "none" }, ref: useClickOutside(() => { setDropdownOpen(false); }) },
