  ...
  DatagridComponent = class DatagridComponent extends React.Component {
    ...
    getCompiledFilters() {
      ...
      for (let filter of (this.props.design.globalFilters || [])) {
        ...
        // Create expr
        let expr = { type: "op", op: filter.op, table: this.props.design.table, exprs: [columnExpr].concat(filter.exprs) };
    ...
    renderTitleBar() {
      return R('div', {style: { position: "absolute", top: 0, left: 0, right: 0, height: 40, padding: 4 }},
    ...
    renderQuickfilter() {
      return R('div', {style: { position: "absolute", top: 40, left: 0, right: 0 }, ref: (c => { return this.quickfilters = c; })},
    ...
    renderFindReplaceModal(filters) {
      return R(FindReplaceModalComponent, { 
        ref: c => { return this.findReplaceModal = c; },
        schema: this.props.schema,
        dataSource: this.props.dataSource,
    ...
    render() {
      ...
      return R('div', {style: { width: "100%", height: "100%", position: "relative", paddingTop: 40 + (this.state.quickfiltersHeight || 0) }},
          ...
          size => {
            ...
            if (!new DatagridUtils(this.props.schema).validateDesign(design)) {
              return R(DatagridViewComponent, {
                ref: view => { return this.datagridView = view; },
              ...
              return R('div', {style: { textAlign: "center", marginTop: size.height / 2 }}, 
                R('a', {className: "btn btn-link", onClick: this.handleEdit}, 
