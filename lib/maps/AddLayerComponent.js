...
module.exports = AddLayerComponent = function () {
  var AddLayerComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(AddLayerComponent, _React$Component);

    var _super = _createSuper(AddLayerComponent);
    ...
    function AddLayerComponent() {
      ...
      _this.handleAddLayerView = _this.handleAddLayerView.bind((0, _assertThisInitialized2["default"])(_this));
      return _this;
    }
