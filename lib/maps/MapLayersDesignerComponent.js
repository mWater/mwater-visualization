...
ExprCompiler = require('mwater-expressions').ExprCompiler; // Designer for layer selection in the map

module.exports = MapLayersDesignerComponent = function () {
  var MapLayersDesignerComponent =
  /*#__PURE__*/
  function (_React$Component) {
    ...
    function MapLayersDesignerComponent() {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(MapLayersDesignerComponent).apply(this, arguments));
      _this.handleLayerViewChange = _this.handleLayerViewChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleRemoveLayerView = _this.handleRemoveLayerView.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleReorder = _this.handleReorder.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.renderLayerView = _this.renderLayerView.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      return _this;
    ...
    (0, _createClass2.default)(MapLayersDesignerComponent, [{
      ...
      value: function render() {
        return R('div', {
          ...
          key: "layers",
          style: {
            marginBottom: 10 // _.map(@props.design.layerViews, @renderLayerView)
