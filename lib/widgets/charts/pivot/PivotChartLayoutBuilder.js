...
module.exports = PivotChartLayoutBuilder = /*#__PURE__*/function () {
  // Pass in schema
  ...
  (0, _createClass2["default"])(PivotChartLayoutBuilder, [{
    ...
    value: function getRowsOrColumns(isRow, segment, data, locale) {
      ...
      if (!segment.valueAxis) {
        ...
        categories = _.map(this.axisBuilder.getCategories(segment.valueAxis, allValues, locale), function (category) {
          return {
            value: category.value,
            label: _this.axisBuilder.formatCategory(segment.valueAxis, category)
          };
