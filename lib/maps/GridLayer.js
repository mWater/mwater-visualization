...
var GridLayer = /** @class */ (function (_super) {
    ...
    GridLayer.prototype.createJsonQL = function (design, schema, filters) {
        ...
        */
        var compiledGeometryExpr = { type: "op", op: "ST_Transform", exprs: [exprCompiler.compileExpr({ expr: design.geometryExpr, tableAlias: "innerquery" }), 3857] };
    ...
    GridLayer.prototype.getMaxZoom = function (design) { return design.maxZoom; };
    /** Get the legend to be optionally displayed on the map. Returns
     * a React element */
    GridLayer.prototype.getLegend = function (design, schema, name, dataSource, filters) {
        var axisBuilder = new AxisBuilder_1.default({ schema: schema });
