...
module.exports = MWaterResponsesFilterComponent = function () {
  var MWaterResponsesFilterComponent =
  /*#__PURE__*/
  function (_React$Component) {
    ...
    function MWaterResponsesFilterComponent() {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(MWaterResponsesFilterComponent).apply(this, arguments));
      _this.handleSiteChange = _this.handleSiteChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleFinalChange = _this.handleFinalChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))); // Recreate all filters
    ...
    (0, _createClass2.default)(MWaterResponsesFilterComponent, [{
      ...
      value: function handleFinalChange(final) {
        boundMethodCheck(this, MWaterResponsesFilterComponent);
        return this.handleChange(final, this.getSiteValue());
      }
    }, {
      key: "handleChange",
      value: function handleChange(final, site) {
        var _this4 = this;
