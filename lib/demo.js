...
// Set demo key
vectorMaps_1.setMapTilerApiKey("cNNyJl2nwIIKEUYSeXYc");
jquery_1.default(function () {
    const sample = R(react_dnd_1.DragDropContextProvider, { backend: react_dnd_html5_backend_1.default }, R("div", { className: "container-fluid", style: { height: "100%", paddingLeft: 0, paddingRight: 0 } }, R("style", null, "html, body, #main { height: 100% }"), 
    // R(MWaterDirectMapPane, { apiUrl: "https://api.mwater.co/v3/", client: window.location.hash.substr(1) })
    // R(RichTextPane)
    R(MWaterMapPane, { apiUrl: "https://api.mwater.co/v3/", client: "dd45f0c73796e500efe0503ec8f0d224" })
    ...
    // R(MWaterDashboardPane, {apiUrl: "https://api.mwater.co/v3/", client: "97a079669ee37c34c6101e9c5bc05718", dashboardId: "38d803820a7a4bf5a1d5ef19cf8c64f3"})
...
class MWaterDirectDashboardPane extends react_1.default.Component {
    constructor(props) {
        ...
        this.handleExtraTablesChange = (extraTables) => {
...
class MWaterMapPane extends react_1.default.Component {
    ...
    componentWillMount() {
        ...
        return jquery_1.default.getJSON(url, (map) => {
