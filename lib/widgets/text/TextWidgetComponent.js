var AsyncLoadComponent, ClickOutHandler, ContentEditableComponent, ExprInsertModalComponent, ExprUpdateModalComponent, H, ItemsHtmlConverter, R, React, TextWidgetComponent, _,
...
module.exports = TextWidgetComponent = (function(superClass) {
  ...
  TextWidgetComponent.prototype.createItemsHtmlConverter = function() {
    ...
    return new ItemsHtmlConverter(this.props.schema, this.props.onDesignChange != null, exprValues, (this.props.onDesignChange != null) && (this.props.singleRowTable != null));
  };

  TextWidgetComponent.prototype.createHtml = function() {
    var exprValues;
    exprValues = !this.state.loading ? this.state.exprValues : {};
    return this.createItemsHtmlConverter().itemsToHtml(this.props.design.items);
  };

  TextWidgetComponent.prototype.handleChange = function(elem) {
    var design;
    design = _.extend({}, this.props.design, {
      items: this.createItemsHtmlConverter().elemToItems(elem)
    });
  ...
  TextWidgetComponent.prototype.handleCreateLink = function(ev) {
    var url;
    ev.preventDefault();
  ...
  TextWidgetComponent.prototype.handleClick = function(ev) {
    var item, ref, ref1, ref2, ref3, ref4, ref5;
