var AttributionComponent, BaseLayerDesignerComponent, H, MapDesignerComponent, MapFiltersDesignerComponent, MapLayersDesignerComponent, R, React,
...
module.exports = MapDesignerComponent = (function(superClass) {
  ...
  MapDesignerComponent.prototype.render = function() {
    ...
    }), H.br(), R(MapFiltersDesignerComponent, {
      schema: this.props.schema,
      dataSource: this.props.dataSource,
      design: this.props.design,
      onDesignChange: this.props.onDesignChange
