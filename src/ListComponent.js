...
var ListItem = React.createClass({
  ...
  mouseOver() { return this.setState({ hover: true }); },
  mouseOut() { return this.setState({ hover: false }); },
  ...
  render() {
    ...
    return R('div', {style, onMouseOver: this.mouseOver, onMouseOut: this.mouseOut, onClick: this.props.onSelect},
      this.props.children);
  }
});
