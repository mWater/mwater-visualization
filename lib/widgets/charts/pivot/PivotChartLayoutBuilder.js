...
class PivotChartLayoutBuilder {
    ...
    buildLayout(design, data, locale) {
        ...
        const dataIndexed = lodash_1.default.mapValues(data, (list) => lodash_1.default.zipObject(lodash_1.default.map(list, (row) => [canonical_json_1.default(lodash_1.default.pick(row, (v, k) => k.match(/^[rc]\d$/))), row])));
    ...
    buildIntersectionCell(design, dataIndexed, locale, row, column) {
        ...
        const entry = intersectionData === null || intersectionData === void 0 ? void 0 : intersectionData[canonical_json_1.default(key)];
        ...
        if (backgroundColor) {
            backgroundColor = color_1.default(backgroundColor).alpha(intersection.backgroundColorOpacity || 1).string();
