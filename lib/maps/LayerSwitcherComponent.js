...
function LayerSwitcherComponent(props) {
    ...
    function renderLayerView(lv, index) {
        function handleClick() {
            props.onDesignChange((0, immer_1.default)(props.design, draft => {
    ...
    return (react_1.default.createElement("div", { style: { position: "absolute", top: 10, right: 10, zIndex: 999, userSelect: "none" }, ref: useClickOutside(() => {
