...
exports.default = PivotChart = class PivotChart extends Chart_1.default {
            ...
            if (design.table) {
                ...
                const cleanSegment = (segment) => {
                    ...
                    if (segment.orderExpr) {
                        return (segment.orderExpr = exprCleaner.cleanExpr(segment.orderExpr ? immer_2.original(segment.orderExpr) : null, {
                            table: design.table,
