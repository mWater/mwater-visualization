...
exports.VectorMapLogo = exports.AttributionControl = exports.useThrottledMapResize = exports.mergeBaseAndUserStyle = exports.useBaseStyle = exports.useStyleMap = exports.useHoverCursor = exports.useVectorMap = exports.areVectorMapsEnabled = exports.setMapTilerApiKey = void 0;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return {
            sources: {
                "bing_raster": {
                    type: "raster",
                    tiles: resource.imageUrlSubdomains.map((subdomain) => resource.imageUrl.replace("{subdomain}", subdomain).replace("{culture}", "")),
