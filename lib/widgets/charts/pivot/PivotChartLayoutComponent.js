...
LayoutCellComponent = (function(superClass) {
  ...
  LayoutCellComponent.prototype.render = function() {
    var backgroundColor, borderWeights, cell, innerStyle, isHover, ref, ref1, style;
    cell = this.props.layout.rows[this.props.rowIndex].cells[this.props.columnIndex];
    if (cell.skip) {
      return null;
    }
    isHover = this.props.hoverSection && cell.section === this.props.hoverSection;
    backgroundColor = cell.unconfigured && this.props.onEditSection ? "#eff5fb" : cell.subtype === "filler" ? "#DDD" : cell.backgroundColor || "#FFFFFF";
    if (isHover) {
    ...
    style = {
      ...
      borderBottom: borderWeights[cell.borderBottom || 0],
      borderLeft: borderWeights[cell.borderLeft || 0],
      borderRight: borderWeights[cell.borderRight || 0]
    };
    innerStyle = {
