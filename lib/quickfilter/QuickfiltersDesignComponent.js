...
class QuickfiltersDesignComponent extends react_1.default.Component {
    ...
    render() {
        return R("div", null, react_1.default.createElement(ListEditorComponent_1.ListEditorComponent, { items: this.props.design, onItemsChange: this.handleDesignChange, renderItem: this.renderQuickfilter, getReorderableKey: (item) => JSON.stringify(item) }), this.props.tables.length > 0
