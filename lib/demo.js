var AutoSizeComponent, CalendarChartViewComponent, DataSource, DirectDashboardDataSource, DirectMapUrlSource, H, LayeredChart, LayeredChartDesignerComponent, MWaterDashboardDataSource, MWaterDashboardPane, MWaterDataSource, MWaterDatagridDesignerPane, MWaterDatagridPane, MWaterDirectDashboardPane, MWaterDirectMapPane, MWaterLoaderComponent, MWaterMapPane, MWaterMapUrlSource, React, ReactDOM, Schema, dashboardDesign, dashboardId, datagridDesign, mapDesign, mapId, querystring, rosterDatagridDesign, share, visualization,
...
MWaterMapUrlSource = require('./maps/MWaterMapUrlSource');

MWaterDashboardDataSource = require('./widgets/MWaterDashboardDataSource');
  ...
  MWaterDashboardPane.prototype.render = function() {
    ...
    return React.createElement(MWaterLoaderComponent, {
      ...
      return function(error, config) {
        ...
        dashboardDataSource = new MWaterDashboardDataSource(_this.props.apiUrl, _this.props.client, _this.props.share, dashboardId);
        return H.div({
          style: {
            height: "100%"
          }
...
MWaterDirectDashboardPane = (function(superClass) {
  ...
  MWaterDirectDashboardPane.prototype.render = function() {
    return React.createElement(MWaterLoaderComponent, {
      ...
      return function(error, config) {
        var dashboardDataSource;
        dashboardDataSource = new DirectDashboardDataSource(_this.props.apiUrl, _this.props.client, _this.state.design, config.schema, config.dataSource);
        return H.div({
          style: {
            height: "100%"
          }
...
mapId = "bd3aa8299afd4a9c86c7cf38e4aa1a93";
...
MWaterMapPane = (function(superClass) {
  ...
  MWaterMapPane.prototype.render = function() {
    ...
    return React.createElement(MWaterLoaderComponent, {
      ...
      return function(error, config) {
        var mapUrlSource;
        mapUrlSource = new MWaterMapUrlSource({
...
MWaterDirectMapPane = (function(superClass) {
  ...
  MWaterDirectMapPane.prototype.render = function() {
    return React.createElement(MWaterLoaderComponent, {
      ...
      return function(error, config) {
        var mapUrlSource;
        mapUrlSource = new DirectMapUrlSource({
          apiUrl: _this.props.apiUrl,
          client: _this.props.client,
          schema: config.schema,
