...
module.exports = DateRangeComponent = (function(superClass) {
  ...
  DateRangeComponent.prototype.handleStartChange = function(value) {
    ...
    if (((ref = this.props.value) != null ? ref[1] : void 0) && this.fromMoment(value) > this.props.value[1]) {
      return this.props.onValueChange([this.fromMoment(value), null]);
    } else {
      return this.props.onValueChange([this.fromMoment(value), (ref1 = this.props.value) != null ? ref1[1] : void 0]);
    }
  };
  ...
  DateRangeComponent.prototype.handleEndChange = function(value) {
    ...
    if (((ref = this.props.value) != null ? ref[0] : void 0) && this.fromMoment(value) < this.props.value[0]) {
      this.props.onValueChange([null, this.fromMoment(value)]);
    } else {
      this.props.onValueChange([(ref1 = this.props.value) != null ? ref1[0] : void 0, this.fromMoment(value)]);
    }
    return this.setState({
      dropdownOpen: false
    });
  ...
  DateRangeComponent.prototype.handlePreset = function(preset) {
    this.props.onValueChange([this.fromMoment(preset.value[0]), this.fromMoment(preset.value[1])]);
    return this.setState({
      dropdownOpen: false
    });
  };
  ...
  DateRangeComponent.prototype.renderClear = function() {
    return H.div({
      ...
      onClick: ((function(_this) {
        return function() {
          return _this.props.onValueChange(null);
        };
      })(this))
    }, H.i({
  ...
  DateRangeComponent.prototype.render = function() {
    ...
    }, this.renderSummary()), this.props.value && (this.props.onValueChange != null) ? this.renderClear() : void 0, this.state.dropdownOpen ? this.renderDropdown() : void 0));
  };
