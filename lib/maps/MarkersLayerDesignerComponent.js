...
MarkersLayerSublayerDesignerComponent = (function(superClass) {
  ...
  MarkersLayerSublayerDesignerComponent.prototype.render = function() {
    return H.div(null, this.renderRemove(), this.renderTable(), this.renderGeometryAxis(), this.renderColor(), this.renderColorAxis(), this.renderSymbol(), this.renderFilter());
  };
