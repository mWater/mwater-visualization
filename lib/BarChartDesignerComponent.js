...
module.exports = BarChartDesignerComponent = (function(superClass) {
  ...
  BarChartDesignerComponent.prototype.renderTable = function() {
    ...
    }, H.label(null, "Table"), H.div(null, React.createElement(PopoverComponent, {
      html: popover
  ...
  BarChartDesignerComponent.prototype.render = function() {
    return H.div(null, this.renderTable(), this.props.design.table ? [this.renderXAesthetic(), this.renderYAesthetic(), this.renderFilter()] : void 0, this.renderTitle());
  };
