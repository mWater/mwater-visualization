var AxisBuilder, ExpressionBuilder, ExpressionCompiler, LayeredChartCompiler, injectTableAlias;
...
module.exports = LayeredChartCompiler = (function() {
  ...
  LayeredChartCompiler.prototype.compileDataCategorical = function(design, data) {
    var categories, categoryMap, colors, columns, dataMap, names, types, xAxis, xValues, xs;
    columns = [];
    types = {};
    names = {};
    dataMap = {};
