...
module.exports = CategoryMapComponent = function () {
  ...
  function (_React$Component) {
    ...
    function CategoryMapComponent(props) {
      ...
      _this.handleExcludeChange = _this.handleExcludeChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleNullLabelChange = _this.handleNullLabelChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleToggle = _this.handleToggle.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))); // Category is { value: category value, label: category label }

      _this.renderCategory = _this.renderCategory.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.state = {
