...
module.exports = PivotChartLayoutComponent = function () {
  ...
  function (_React$Component) {
    ...
    function PivotChartLayoutComponent(props) {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(PivotChartLayoutComponent).call(this, props)); // Records the cell components. This is to be able to calculate the bounds of sections
      // to allow floating hover controls

      _this.recordCellComp = _this.recordCellComp.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.renderHoverPlusIcon = _this.renderHoverPlusIcon.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.renderHoverRemoveIcon = _this.renderHoverRemoveIcon.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))); // Render floating hover controls

      _this.renderHoverControls = _this.renderHoverControls.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.state = {
...
LayoutCellComponent = function () {
  ...
  function (_React$Component2) {
    ...
    function LayoutCellComponent() {
      ...
      _this4 = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(LayoutCellComponent).apply(this, arguments));
      _this4.handleClick = _this4.handleClick.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this4)));
      return _this4;
    }
