...
module.exports = ExprItemEditorComponent = function () {
  ...
  function (_React$Component) {
    ...
    function ExprItemEditorComponent(props) {
      ...
      _this.handleIncludeLabelChange = _this.handleIncludeLabelChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleLabelTextChange = _this.handleLabelTextChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleFormatChange = _this.handleFormatChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))); // Keep table in state as it can be set before the expression
