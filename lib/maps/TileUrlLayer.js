...
*/
exports.default = TileUrlLayer = class TileUrlLayer extends Layer_1.default {
...
class TileUrlLayerDesignerComponent extends react_1.default.Component {
    ...
    render() {
        ...
        return R("div", { className: "form-group" }, R("label", { className: "text-muted" }, "Url (containing {z}, {x} and {y})"), R("input", {
            type: "text",
