...
class MarkersLayerDesignerComponent extends react_1.default.Component {
    ...
    render() {
        return R("div", null, this.renderTable(), this.renderGeometryAxis(), this.renderColor(), this.renderSymbol(), this.renderMarkerSize(), this.renderLineWidth(), this.renderFilter(), this.renderPopup(), this.renderHoverOver(), this.props.design.table
