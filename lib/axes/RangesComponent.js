...
class RangesComponent extends react_1.default.Component {
    constructor() {
        ...
        this.handleRangeChange = (index, range) => {
            ...
            ranges[index] = range;
            return this.props.onChange(update_object_1.default(this.props.xform, { ranges: { $set: ranges } }));
        };
        this.handleAddRange = () => {
            const ranges = this.props.xform.ranges.slice();
            ranges.push({ id: uuid_1.default(), minOpen: false, maxOpen: true });
            return this.props.onChange(update_object_1.default(this.props.xform, { ranges: { $set: ranges } }));
        };
    ...
    render() {
        ...
        R("button", { className: "btn btn-link btn-sm", type: "button", onClick: this.handleAddRange }, R("span", { className: "glyphicon glyphicon-plus" }), " Add Range"));
    }
}
...
class RangeComponent extends react_1.default.Component {
    constructor() {
        ...
        this.handleMinOpenChange = (minOpen) => {
            return this.props.onChange(update_object_1.default(this.props.range, { minOpen: { $set: minOpen } }));
        };
        this.handleMaxOpenChange = (maxOpen) => {
            return this.props.onChange(update_object_1.default(this.props.range, { maxOpen: { $set: maxOpen } }));
        };
    }
    render() {
        let placeholder = "";
        ...
        return this.props.connectDragPreview(this.props.connectDropTarget(R("tr", null, R("td", null, this.props.connectDragSource(R("span", { className: "fa fa-bars" }))), R("td", { key: "minOpen" }, R(mwater_expressions_ui_1.LinkComponent, {
            ...
            placeholder: "None",
            small: true,
            onChange: (v) => this.props.onChange(update_object_1.default(this.props.range, { minValue: { $set: v } }))
            ...
            placeholder: "None",
            small: true,
            onChange: (v) => this.props.onChange(update_object_1.default(this.props.range, { maxValue: { $set: v } }))
        })), R("td", { key: "label" }, R("input", {
            type: "text",
            className: "form-control input-sm",
            value: this.props.range.label || "",
            placeholder,
            onChange: (ev) => this.props.onChange(update_object_1.default(this.props.range, { label: { $set: ev.target.value || null } }))
        })), R("td", { key: "remove" }, R("button", { className: "btn btn-xs btn-link", type: "button", onClick: this.props.onRemove }, R("span", { className: "glyphicon glyphicon-remove" }))))));
    }
}
