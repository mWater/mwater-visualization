...
export default LeafletMapComponent = (function() {
  LeafletMapComponent = class LeafletMapComponent extends React.Component {
    ...
    reload() {
      ...
      return this.tileLayers.map((tileLayer) =>
        tileLayer.redraw());
    }
    ...
    setBounds(bounds, pad) {
      if (bounds) {
        ...
        let lBounds = new L.LatLngBounds([[s, w], [n, e]]);
        if (pad) {
    ...
    updateMap(prevProps) {
      ...
      if (!prevProps || (this.props.baseLayerId !== prevProps.baseLayerId) || (this.props.baseLayerOpacity !== prevProps.baseLayerOpacity)) {
        ...
        switch (this.props.baseLayerId) {
          case "bing_road":
            this.baseLayer = new BingLayer("Ao26dWY2IC8PjorsJKFaoR85EPXCnCohrJdisCWXIULAXFo0JAXquGauppTMQbyU", {type: "Road"});
            break;
            ...
            // })
          case "bing_aerial":
            this.baseLayer = new BingLayer("Ao26dWY2IC8PjorsJKFaoR85EPXCnCohrJdisCWXIULAXFo0JAXquGauppTMQbyU", {type: "AerialWithLabels"});
            break;
      ...
      // Update layers
      if (!prevProps || (JSON.stringify(_.omit(this.props.layers, "onGridClick", "onGridHover", "onClick")) !== JSON.stringify(_.omit(prevProps.layers, "onGridClick", "onGridHover", "onClick")))) { // TODO naive
            ...
            if (layer.tileUrl) {
              ...
              geoJsonLayer = L.geoJSON(layer.geometry, {
                ...
                pointToLayer: (geojson, latlng) => {
                  if (layer.pointStyle) { 
                    return L.circleMarker(latlng, _.extend({}, layer.pointStyle, { interactive: (layer.nonInteractive ? false : true) }));
                  } else { 
    ...
    render() {
      return R('div', null,
        this.props.legend && this.loaded ?
          // Inject zoom
          React.cloneElement(this.props.legend, {zoom: this.map.getZoom()}) : undefined,
        R('div', { 
          ref: c => { return this.mapElem = c; }, 
