...
let _SectionComponent = (SectionComponent = (function () {
    SectionComponent = class SectionComponent extends react_1.default.Component {
        render() {
...
let _OptionListComponent = (OptionListComponent = (function () {
    OptionListComponent = class OptionListComponent extends react_1.default.Component {
        render() {
...
class OptionComponent extends react_1.default.Component {
    ...
    render() {
        return R("div", { className: "mwater-visualization-big-option", onClick: this.props.onClick }, this.props.onRemove
            ? R("button", { type: "button", className: "btn btn-link btn-xs pull-right", onClick: this.handleClick }, R("span", { className: "glyphicon glyphicon-remove" }))
...
let _SwitchViewComponent = (SwitchViewComponent = (function () {
    SwitchViewComponent = class SwitchViewComponent extends react_1.default.Component {
        constructor(props) {
            super(props);
            // Save components
        ...
        render() {
            ...
            for (id in this.props.views) {
                ...
                style[id] = react_motion_1.default.spring(id === this.props.viewId ? 1 : 0, [332, 34]);
            } // Stiff, quick spring
...
let _ToggleEditComponent = (ToggleEditComponent = (function () {
    ToggleEditComponent = class ToggleEditComponent extends react_1.default.Component {
        constructor(props) {
            super(props);
            this.close = () => {
...
let _ButtonToggleComponent = (ButtonToggleComponent = (function () {
    ButtonToggleComponent = class ButtonToggleComponent extends react_1.default.Component {
        render() {
