...
module.exports = TableChartDesignerComponent = function () {
  var TableChartDesignerComponent =
  /*#__PURE__*/
  function (_React$Component) {
    ...
    function TableChartDesignerComponent() {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(TableChartDesignerComponent).apply(this, arguments));
      _this.handleTitleTextChange = _this.handleTitleTextChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      ...
      _this.handleOrderingsChange = _this.handleOrderingsChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleColumnChange = _this.handleColumnChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleRemoveColumn = _this.handleRemoveColumn.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleAddColumn = _this.handleAddColumn.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.renderColumn = _this.renderColumn.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleReorder = _this.handleReorder.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      return _this;
    ...
    (0, _createClass2.default)(TableChartDesignerComponent, [{
      ...
      value: function render() {
        return R('div', null, this.renderTable(), this.renderColumns(), this.props.design.table ? R('hr') : void 0, this.renderOrderings(), this.renderFilter(), R('hr'), this.renderTitle());
      }
    }]);
...
TableChartColumnDesignerComponent = function () {
  var TableChartColumnDesignerComponent =
  /*#__PURE__*/
  function (_React$Component2) {
    ...
    function TableChartColumnDesignerComponent() {
      ...
      _this2 = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(TableChartColumnDesignerComponent).apply(this, arguments));
      _this2.handleExprChange = _this2.handleExprChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)));
      _this2.handleHeaderTextChange = _this2.handleHeaderTextChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)));
      _this2.handleAggrChange = _this2.handleAggrChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)));
      _this2.handleFormatChange = _this2.handleFormatChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)));
      return _this2;
    ...
    (0, _createClass2.default)(TableChartColumnDesignerComponent, [{
      ...
      value: function renderFormat() {
        ...
        column = this.props.design.columns[this.props.index]; // Only for number typ
