...
function (_Widget) {
  ...
  function TextWidget() {
    ...
    return (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(TextWidget).apply(this, arguments));
  }
  ...
  (0, _createClass2["default"])(TextWidget, [{
    ...
    value: function getData(design, schema, dataSource, filters, callback) {
      ...
      evalExprItem = function evalExprItem(exprItem, cb) {
        ...
        exprCompiler = new ExprCompiler(schema); // Clean expression
