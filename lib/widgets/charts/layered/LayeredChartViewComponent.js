...
module.exports = LayeredChartViewComponent = function () {
  ...
  function (_React$Component) {
    ...
    function LayeredChartViewComponent(props) {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(LayeredChartViewComponent).call(this, props));
...
C3ChartComponent = function () {
  ...
  function (_React$Component2) {
    ...
    function C3ChartComponent(props) {
      ...
      _this4 = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(C3ChartComponent).call(this, props));
      _this4.createChart = _this4.createChart.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this4))); // if not _.isEqual(@props.data, nextProps.data)
      ...
      _this4.updateScope = _this4.updateScope.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this4)));
      _this4.handleDataClick = _this4.handleDataClick.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this4))); // Create throttled createChart
    ...
    (0, _createClass2.default)(C3ChartComponent, [{
      ...
      value: function componentDidUpdate(prevProps, prevState) {
        var newChartOptions, newCompiler, oldChartOptions, oldCompiler; // Check if options changed
