...
class SegmentDesignerComponent extends react_1.default.Component {
    constructor(props) {
        ...
        this.handleValueAxisOnlyValuesPresentChange = (valueAxisOnlyValuesPresent) => {
        ...
        return react_1.default.createElement(ui.FormGroup, { labelMuted: true, label: "Field", help: "Field to disaggregate data by" },
            react_1.default.createElement("div", { style: { marginLeft: 8 } },
                ...
                allowValueAxisOnlyValuesPresent ?
                    react_1.default.createElement(ui.Checkbox, { value: this.props.segment.valueAxisOnlyValuesPresent, onChange: this.handleValueAxisOnlyValuesPresentChange }, "Only show values actually present")
                    : null));
    }
    renderFilter() {
        return R(ui.FormGroup, {
