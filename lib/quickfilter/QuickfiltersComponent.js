...
QuickfilterCompiler = require('./QuickfilterCompiler'); // Displays quick filters and allows their value to be modified
...
EnumQuickfilterComponent = function () {
  ...
  function (_React$Component2) {
    ...
    function EnumQuickfilterComponent() {
      ...
      _this3.handleSingleChange = _this3.handleSingleChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this3)));
      _this3.handleMultiChange = _this3.handleMultiChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this3)));
      return _this3;
    }
    ...
    (0, _createClass2.default)(EnumQuickfilterComponent, [{
      ...
      value: function renderSingleSelect() {
        var _this4 = this;
        ...
        options = _.map(this.props.options, function (opt) {
          return {
            value: opt.id,
            label: ExprUtils.localizeString(opt.name, _this4.context.locale)
          };
        });
