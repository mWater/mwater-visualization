...
module.exports = PivotChartQueryBuilder = (function() {
  ...
  PivotChartQueryBuilder.prototype.createQueries = function(design, extraFilters) {
    var backgroundColorCondition, columnPath, columnSegment, exprCompiler, filter, filters, i, intersection, intersectionFilters, intersectionId, j, k, l, len, len1, len2, len3, len4, len5, len6, len7, m, n, o, p, q, queries, query, ref, ref1, ref2, ref3, relevantFilters, rowPath, rowSegment, segment, segments, where, whereClauses;
