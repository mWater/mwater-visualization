var AxisBuilder, AxisColorEditorComponent, AxisComponent, BinsComponent, CategoryMapComponent, ExprCompiler, ExprComponent, ExprUtils, H, LinkComponent, R, RangesComponent, React, ui, update, uuid,
...
module.exports = AxisComponent = (function(superClass) {
  ...
  AxisComponent.prototype.render = function() {
    ...
    })), this.renderXform(axis), this.renderColorMap(axis), this.renderExcludedValues(axis));
  };
