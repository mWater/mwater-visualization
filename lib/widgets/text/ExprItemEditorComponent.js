var ExprComponent, ExprItemEditorComponent, ExprUtils, PropTypes, R, React, TableSelectComponent, _,
...
module.exports = ExprItemEditorComponent = (function(superClass) {
  ...
  function ExprItemEditorComponent(props) {
    ...
    var ref;
    ExprItemEditorComponent.__super__.constructor.call(this, props);
    this.state = {
