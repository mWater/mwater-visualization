...
injectTableAlias = require('mwater-expressions').injectTableAlias; // Axis component that allows designing of an axis
...
module.exports = AxisComponent = function () {
  ...
  function (_AsyncLoadComponent) {
    ...
    function AxisComponent(props) {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(AxisComponent).call(this, props));
      ...
      _this.handleFormatChange = _this.handleFormatChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleXformTypeChange = _this.handleXformTypeChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleXformChange = _this.handleXformChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.state = {
    ...
    (0, _createClass2.default)(AxisComponent, [{
      ...
      value: function load(props, prevProps, callback) {
        ...
        categories = axisBuilder.getCategories(axis); // Just "None" and so doesn't count
      ...
      value: function render() {
        ...
        return R('div', null, R('div', null, R(ExprComponent, {
          ...
          aggrStatuses: aggrStatuses // Only show format is number type
