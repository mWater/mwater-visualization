...
class AdminScopeAndDetailLevelComponent extends react_1.default.Component {
    ...
    render() {
        ...
        return R("div", null, R("div", { className: "form-group" }, R("label", { className: "text-muted" }, "Region to Map"), R(RegionSelectComponent_1.default, {
            ...
            if (this.props.scope != null && this.props.detailLevel != null) {
                return R("div", { className: "form-group" }, R("label", { className: "text-muted" }, "Detail Level"), R(DetailLevelSelectComponent_1.default, {
                ...
                return R("div", { className: "form-group" }, R("label", { className: "text-muted" }, "Detail Level"), R(react_select_1.default, {
