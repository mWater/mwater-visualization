...
class MarkersLayerDesignerComponent extends react_1.default.Component {
    ...
    renderMarkerSize() {
        ...
        return R("div", { className: "form-group" }, R("label", { className: "text-muted" }, "Marker Size"), R(ui.Select, {
    ...
    renderLineWidth() {
        ...
        return R("div", { className: "form-group" }, R("label", { className: "text-muted" }, "Line Width (for shapes)"), R(ui.Select, {
