...
exports.default = DatagridQueryBuilder = class DatagridQueryBuilder {
    constructor(schema) {
        this.schema = schema;
    }
    ...
    createSimpleQuery(design, options) {
        ...
        for (let extraFilter of options.extraFilters || []) {
            if (extraFilter.table === design.table) {
                wheres.push(mwater_expressions_4.injectTableAlias(extraFilter.jsonql, "main"));
            }
        }
    ...
    createComplexSubtableQuery(design, options, subtable, subtableIndex) {
        ...
        for (let extraFilter of options.extraFilters || []) {
            ...
            if (extraFilter.table === subtableTable) {
                wheres.push(mwater_expressions_4.injectTableAlias(extraFilter.jsonql, "st"));
            }
        }
        wheres = lodash_1.default.compact(wheres);
        if (wheres.length === 1) {
