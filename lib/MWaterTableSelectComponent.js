var ExprUtils, FormsListComponent, H, IndicatorsListComponent, IssuesListComponent, MWaterTableSelectComponent, PropTypes, R, React, TabbedComponent, moment, querystring, siteTypes, ui, uiComponents,
...
module.exports = MWaterTableSelectComponent = (function(superClass) {
  ...
  MWaterTableSelectComponent.prototype.render = function() {
    ...
    return H.div(null, R(uiComponents.ToggleEditComponent, {
      ...
      editor: editor
    }), this.props.table ? H.div(null, R(ui.Radio, {
      value: "1",
      radioValue: "1"
    }, "All Responses"), R(ui.Radio, {
      value: "1",
      radioValue: "2"
    }, "Only Latest Response for each 'Water Point linked to this survey'"), R(ui.Radio, {
      value: "1",
      radioValue: "3"
    }, "Only Latest Response for each 'Select Nearest Community'")) : void 0);
  };
