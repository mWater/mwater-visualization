var ActionCancelModalComponent, ExprUtils, IntersectionDesignerComponent, PivotChartLayoutBuilder, PivotChartLayoutComponent, PivotChartUtils, PivotChartViewComponent, PropTypes, R, React, ReactDOM, SegmentDesignerComponent, TextComponent, _,
...
module.exports = PivotChartViewComponent = (function(superClass) {
  ...
  function PivotChartViewComponent(props) {
    ...
    PivotChartViewComponent.__super__.constructor.call(this, props);
    this.state = {
      editSegment: null,
