var ChartViewComponent, H, QueryDataLoadingComponent, React,
...
module.exports = ChartViewComponent = (function(superClass) {
  ...
  function ChartViewComponent() {
    return ChartViewComponent.__super__.constructor.apply(this, arguments);
  }
      ...
      elemFactory = (function(_this) {
        return function(data) {
          return _this.props.chart.createViewElement({
            ...
            standardWidth: _this.props.standardWidth
          });
        };
      })(this);
