...
class PivotChartDesignerComponent extends react_1.default.Component {
    ...
    renderStriping() {
        ...
        return R(bootstrap_1.default.FormGroup, {
            labelMuted: true,
            label: "Striping"
        }, R("label", { key: "none", className: "radio-inline" }, R("input", {
            type: "radio",
            checked: !this.props.design.striping,
            onClick: () => this.updateDesign({ striping: null })
        }), "None"), R("label", { key: "columns", className: "radio-inline" }, R("input", {
            type: "radio",
            checked: this.props.design.striping === "columns",
            onClick: () => this.updateDesign({ striping: "columns" })
        }), "Columns"), R("label", { key: "rows", className: "radio-inline" }, R("input", {
            type: "radio",
    ...
    renderSetup() {
        const intersectionId = `${this.props.design.rows[0].id}:${this.props.design.columns[0].id}`;
        return R("div", null, R(bootstrap_1.default.FormGroup, {
            labelMuted: true,
            label: "Columns",
