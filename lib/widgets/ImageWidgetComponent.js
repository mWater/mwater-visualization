...
module.exports = ImageWidgetComponent = function () {
  var ImageWidgetComponent = /*#__PURE__*/function (_AsyncLoadComponent) {
    (0, _inherits2["default"])(ImageWidgetComponent, _AsyncLoadComponent);

    var _super = _createSuper(ImageWidgetComponent);
...
ImageWidgetDesignComponent = function () {
  var ImageWidgetDesignComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(ImageWidgetDesignComponent, _React$Component);

    var _super2 = _createSuper(ImageWidgetDesignComponent);
...
RotatedImageComponent = function () {
  ...
  var RotatedImageComponent = /*#__PURE__*/function (_React$Component2) {
    (0, _inherits2["default"])(RotatedImageComponent, _React$Component2);

    var _super3 = _createSuper(RotatedImageComponent);
    ...
    (0, _createClass2["default"])(RotatedImageComponent, [{
      ...
      value: function render() {
        ...
        return R(AutoSizeComponent, {
          ...
          imageStyle.objectFit = "contain"; // Set width if rotated left or right
