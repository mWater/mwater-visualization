...
class OrderingComponent extends react_1.default.Component {
    constructor() {
        ...
        this.handleDirectionChange = (value) => {
            return this.props.onOrderingChange(lodash_1.default.extend({}, this.props.ordering, { direction: value ? "desc" : "asc" }));
        };
    }
    render() {
        var _a;
        return R("div", { style: { marginLeft: 5 } }, R("div", { style: { textAlign: "right" } }, R("button", { className: "btn btn-sm btn-link", type: "button", onClick: this.props.onOrderingRemove }, R("span", { className: "fas fa-times" }))), R(mwater_expressions_ui_1.ExprComponent, {
            schema: this.props.schema,
            dataSource: this.props.dataSource,
            table: this.props.table,
