...
LayerDesignerComponent = (function(superClass) {
  ...
  LayerDesignerComponent.prototype.render = function() {
    return H.div(null, this.renderRemove(), this.renderTable(), this.renderXAxis(), this.renderYAxis(), this.renderColorAxis(), this.renderFilter(), this.renderName());
  };
