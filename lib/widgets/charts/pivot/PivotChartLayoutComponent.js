var Color, LayoutCellComponent, PivotChartLayoutComponent, PropTypes, R, React, ReactDOM, _, classNames, ui,
...
module.exports = PivotChartLayoutComponent = (function(superClass) {
  ...
  function PivotChartLayoutComponent(props) {
    ...
    PivotChartLayoutComponent.__super__.constructor.call(this, props);
    this.state = {
      hoverSection: null
    };
    this.cellComps = {};
  ...
  PivotChartLayoutComponent.prototype.render = function() {
    ...
    }, R('tbody', null, _.map(this.props.layout.rows, (function(_this) {
