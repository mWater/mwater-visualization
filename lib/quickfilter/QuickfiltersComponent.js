var DateExprComponent, DateQuickfilterComponent, EnumQuickfilterComponent, ExprCleaner, ExprUtils, H, PropTypes, QuickfilterCompiler, QuickfiltersComponent, R, React, ReactSelect, TextLiteralComponent, TextQuickfilterComponent,
...
EnumQuickfilterComponent = (function(superClass) {
  ...
  EnumQuickfilterComponent.prototype.renderSingleSelect = function() {
    return R(ReactSelect, {
      ...
      onChange: this.props.onValueChange ? this.handleSingleChange : void 0,
  ...
  EnumQuickfilterComponent.prototype.renderMultiSelect = function() {
    return R(ReactSelect, {
      placeholder: "All",
      value: _.map(this.props.value || [], JSON.stringify).join("\n"),
      multi: true,
      delimiter: "\n",
      options: _.map(this.props.options, (function(_this) {
        return function(opt) {
          return {
            value: JSON.stringify(opt.id),
            label: ExprUtils.localizeString(opt.name, _this.context.locale)
          };
        };
      })(this)),
  ...
  EnumQuickfilterComponent.prototype.render = function() {
    ...
    }, this.props.multi ? this.renderMultiSelect() : this.renderSingleSelect()), !this.props.onValueChange ? H.i({
