var AdminChoroplethLayerDesigner, AdminScopeAndDetailLevelComponent, AxisComponent, ColorComponent, EditPopupComponent, ExprCompiler, ExprComponent, ExprUtils, FilterExprComponent, PropTypes, R, Rcslider, React, TableSelectComponent, ZoomLevelsComponent, _,
...
module.exports = AdminChoroplethLayerDesigner = (function(superClass) {
  ...
  AdminChoroplethLayerDesigner.prototype.render = function() {
    return R('div', null, this.renderTable(), this.renderAdminRegionExpr(), this.renderScopeAndDetailLevel(), this.renderDisplayNames(), this.renderColor(), this.renderFillOpacity(), this.renderFilter(), this.renderPopup(), this.props.design.table ? R(ZoomLevelsComponent, {
      design: this.props.design,
      onDesignChange: this.props.onDesignChange
    }) : void 0);
  };
