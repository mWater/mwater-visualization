var AdminChoroplethLayerDesigner, AdminScopeAndDetailLevelComponent, AxisComponent, ColorAxisComponent, ColorComponent, EditPopupComponent, ExprComponent, ExprUtils, FilterExprComponent, H, R, Rcslider, React, TableSelectComponent, _, updt,
...
module.exports = AdminChoroplethLayerDesigner = (function(superClass) {
  ...
  AdminChoroplethLayerDesigner.prototype.render = function() {
    return H.div(null, this.renderTable(), this.renderAdminRegionExpr(), this.renderScopeAndDetailLevel(), this.renderDisplayNames(), this.renderColor(), this.renderFillOpacity(), this.renderFilter(), this.renderPopup());
  };
