...
var AxisBuilder = require("../axes/AxisBuilder");
...
module.exports = /** @class */ (function (_super) {
    ...
    ChoroplethLayer.prototype.createJsonQL = function (design, schema, filters) {
        var axisBuilder = new AxisBuilder({ schema: schema });
        ...
        if (design.regionMode === "indirect" || !design.regionMode) {
            ...
            */
            ...
            var relevantFilters = _.where(filters, { table: design.table });
    ...
    ChoroplethLayer.prototype.createDesignerElement = function (options) {
        ...
        var ChoroplethLayerDesigner = require('./ChoroplethLayerDesigner');
    ...
    ChoroplethLayer.prototype.acceptKmlVisitorForRow = function (visitor, row) {
        ...
        var list = _.map(outer, function (coordinates) { return coordinates.join(","); });
