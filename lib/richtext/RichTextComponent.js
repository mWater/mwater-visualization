...
module.exports = RichTextComponent = function () {
  var RichTextComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(RichTextComponent, _React$Component);

    var _super = _createSuper(RichTextComponent);
    ...
    function RichTextComponent(props) {
      ...
      _this.handleSetFontSize = _this.handleSetFontSize.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleSetFontColor = _this.handleSetFontColor.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleChange = _this.handleChange.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleFocus = _this.handleFocus.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleBlur = _this.handleBlur.bind((0, _assertThisInitialized2["default"])(_this)); // Perform a command such as bold, underline, etc.

      _this.handleCommand = _this.handleCommand.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleCreateLink = _this.handleCreateLink.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleEditorClick = _this.handleEditorClick.bind((0, _assertThisInitialized2["default"])(_this));
      _this.renderPaletteContent = _this.renderPaletteContent.bind((0, _assertThisInitialized2["default"])(_this));
      _this.refContentEditable = _this.refContentEditable.bind((0, _assertThisInitialized2["default"])(_this));
      _this.state = {
        focused: false
      };
      return _this;
