...
class ZoomLevelsComponent extends react_1.default.Component {
    ...
    render() {
        ...
        return R("div", { className: "mb-3" }, R("label", { className: "text-muted" }, "Advanced"), R("div", { key: "min" }, R("span", { className: "text-muted" }, "Minimum Zoom Level:"), " ", R(NumberInputComponent_1.default, {
            small: true,
