...
class ClusterLayerDesignerComponent extends react_1.default.Component {
    ...
    renderTextColor() {
        ...
        return R("div", { className: "form-group" }, R("label", { className: "text-muted" }, R("span", { className: "glyphicon glyphicon glyphicon-tint" }), "Text Color"), R("div", null, R(ColorComponent_1.default, {
    ...
    renderFillColor() {
        ...
        return R("div", { className: "form-group" }, R("label", { className: "text-muted" }, R("span", { className: "glyphicon glyphicon glyphicon-tint" }), "Marker Color"), R("div", null, R(ColorComponent_1.default, {
