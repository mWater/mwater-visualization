...
class DatagridViewComponent extends react_1.default.Component {
    ...
    reloadRow(rowIndex, rowId, callback) {
        ...
        const filters = immer_1.default(this.props.filters || [], draft => {
            var _a;
            draft.push({
                ...
                jsonql: {
                    ...
                    op: "=",
                    exprs: [
                        { type: "field", tableAlias: "{alias}", column: (_a = this.props.schema.getTable(this.props.design.table)) === null || _a === void 0 ? void 0 : _a.primaryKey },
        ...
        this.props.datagridDataSource.getRows(this.props.design, 0, 1, filters, (error, rows) => {
            ...
            const newRows = immer_1.default(this.state.rows, draft => {
                if (rows[0]) {
