var BlocksLayoutManager, DirectLayerDataSource, DirectMapDataSource, DirectWidgetDataSource, LayerFactory, MapBoundsCalculator, MapDataSource, WidgetFactory, _, injectTableAlias, pako, querystring,
...
module.exports = DirectMapDataSource = (function(superClass) {
  ...
  function DirectMapDataSource(options) {
    DirectMapDataSource.__super__.constructor.call(this);
...
DirectLayerDataSource = (function() {
  ...
  DirectLayerDataSource.prototype.createUrl = function(extension, jsonqlCss) {
    ...
    query = {
      type: "jsonql",
      design: pako.deflate(JSON.stringify(jsonqlCss), {
        to: 'string'
      })
    };
