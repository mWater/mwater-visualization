var AxisBuilder, AxisComponent, ColorComponent, ExprCompiler, ExprUtils, FilterExprComponent, LayeredChartCompiler, LayeredChartLayerDesignerComponent, LayeredChartUtils, PropTypes, R, React, TableSelectComponent, ui, uiComponents,
...
module.exports = LayeredChartLayerDesignerComponent = (function(superClass) {
  ...
  function LayeredChartLayerDesignerComponent() {
    ...
    this.handleXColorMapChange = bind(this.handleXColorMapChange, this);
  ...
  LayeredChartLayerDesignerComponent.prototype.handleXColorMapChange = function(xColorMap) {
    var layer;
    layer = this.props.design.layers[this.props.index];
    return this.updateLayer({
      xColorMap: xColorMap
  ...
  LayeredChartLayerDesignerComponent.prototype.renderXAxis = function() {
    ...
    }), categoricalX && !layer.axes.color ? R(ui.Checkbox, {
