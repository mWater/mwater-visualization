var AxisComponent, BufferLayerDesignerComponent, ColorComponent, EditPopupComponent, ExprUtils, FilterExprComponent, H, NumberInputComponent, R, Rcslider, React, TableSelectComponent, _,
...
module.exports = BufferLayerDesignerComponent = (function(superClass) {
  ...
  BufferLayerDesignerComponent.prototype.render = function() {
    return H.div(null, this.renderTable(), this.renderGeometryAxis(), this.renderRadius(), this.renderColor(), this.renderColorAxis(), this.renderFillOpacity(), this.renderFilter(), this.renderPopup());
  };
