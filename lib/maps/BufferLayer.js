...
module.exports = BufferLayer = /*#__PURE__*/function (_Layer) {
  (0, _inherits2["default"])(BufferLayer, _Layer);

  var _super = _createSuper(BufferLayer);
  ...
  (0, _createClass2["default"])(BufferLayer, [{
    ...
    value: function onGridClick(ev, clickOptions) {
      var BlocksLayoutManager, WidgetFactory, filter, filterExpr, ids, popupFilterJoins, popupFilters, ref, results, table; // TODO abstract most to base class
    ...
    key: "getLegend",
    value: function getLegend(design, schema, name, dataSource, locale) {
    ...
    value: function cleanDesign(design, schema) {
      ...
      design = produce(design, function (draft) {
        ...
        draft.axes.geometry = axisBuilder.cleanAxis({
          axis: draft.axes.geometry ? original(draft.axes.geometry) : null,
          table: design.table,
          types: ['geometry'],
          aggrNeed: "none"
        });
        draft.axes.color = axisBuilder.cleanAxis({
          axis: draft.axes.color ? original(draft.axes.color) : null,
          table: design.table,
          types: ['enum', 'text', 'boolean', 'date'],
          aggrNeed: "none"
        });
