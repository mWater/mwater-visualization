...
PopoverHelpComponent = require('react-library/lib/PopoverHelpComponent'); // A single row in the table of layer views. Handles the editor state
...
module.exports = MapLayerViewDesignerComponent = function () {
  var MapLayerViewDesignerComponent = /*#__PURE__*/function (_React$Component) {
    ...
    function MapLayerViewDesignerComponent(props) {
      ...
      _this.handleGroupChange = _this.handleGroupChange.bind((0, _assertThisInitialized2["default"])(_this));
    ...
    (0, _createClass2["default"])(MapLayerViewDesignerComponent, [{
      ...
      value: function handleGroupChange(group) {
        boundMethodCheck(this, MapLayerViewDesignerComponent);
        return this.update({
          group: group
        });
      ...
      value: function renderAdvanced() {
        return R('div', {
          ...
          style: {
            display: "grid",
            gridTemplateColumns: "50% auto auto 1fr",
            alignItems: "center",
            columnGap: 5
          }
        }, R(ui.Checkbox, {
          ...
          placeholder: "None"
        }), R('div', null, R(PopoverHelpComponent, {
          placement: "top",
          key: "help"
      ...
      value: function renderEditor() {
        ...
        }) : void 0, this.renderOpacityControl(), this.renderAdvanced());
      }
    }, {
