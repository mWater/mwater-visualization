...
module.exports = ImageMosaicChartViewComponent = function () {
  var ImageMosaicChartViewComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(ImageMosaicChartViewComponent, _React$Component);

    var _super = _createSuper(ImageMosaicChartViewComponent);
    ...
    function ImageMosaicChartViewComponent() {
      ...
      _this.handleClick = _this.handleClick.bind((0, _assertThisInitialized2["default"])(_this)); // Render a single image

      _this.renderImage = _this.renderImage.bind((0, _assertThisInitialized2["default"])(_this));
      return _this;
    }
    ...
    (0, _createClass2["default"])(ImageMosaicChartViewComponent, [{
      ...
      value: function renderImage(primaryKey, image, imageManager) {
        ...
        return R(LazyLoad, {
          key: image.id,
          scrollContainer: '.mwater-visualization-block-parent-outer'
