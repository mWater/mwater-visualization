...
class TableChartDesignerComponent extends react_1.default.Component {
    constructor() {
        ...
        this.handleAddColumn = () => {
            const columns = this.props.design.columns.slice();
            columns.push({ id: (0, uuid_1.default)() });
            this.updateDesign({ columns });
        };
    ...
    renderOrderings() {
        ...
        return R("div", { className: "mb-3" }, R("label", { className: "text-muted" }, R("span", { className: "fas fa-sort-amount-down" }), " ", "Ordering"), R("div", { style: { marginLeft: 8 } }, react_1.default.createElement(OrderingsComponent_1.default, {
            schema: this.props.schema,
            dataSource: this.props.dataSource,
    ...
    renderFilter() {
        ...
        return R("div", { className: "mb-3" }, R("label", { className: "text-muted" }, R("span", { className: "fas fa-filter" }), " ", "Filters"), R("div", { style: { marginLeft: 8 } }, react_1.default.createElement(mwater_expressions_ui_2.FilterExprComponent, {
            schema: this.props.schema,
            dataSource: this.props.dataSource,
    ...
    renderLimit() {
        ...
        return R("div", { className: "mb-3" }, R("label", { className: "text-muted" }, "Maximum Number of Rows (up to 1000)"), R("div", { style: { marginLeft: 8 } }, R(ui.NumberInput, {
...
class TableChartColumnDesignerComponent extends react_1.default.Component {
    ...
    renderHeader() {
        ...
        const placeholder = column.textAxis ? axisBuilder.summarizeAxis((_a = column.textAxis) !== null && _a !== void 0 ? _a : null, this.context.locale) : "";
    ...
    renderSummarize() {
        ...
        return R('div', null, R(ui.Checkbox, { value: column.summarize, inline: true, onChange: (summarize) => { var _a; return this.updateColumn({ summarize, summaryType: (_a = column.summaryType) !== null && _a !== void 0 ? _a : 'sum' }); } }, "Summarize"), column.summarize ?
            R('div', null, R("label", { className: "text-muted" }, "Summary Type"), ": ", R(ui.Select, {
                inline: true,
