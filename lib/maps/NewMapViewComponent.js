...
function NewMapViewComponent(props) {
    ...
    var _f = react_1.useState(false), symbolsAdded = _f[0], setSymbolsAdded = _f[1];
    /** Contents of popup if open */
    var _g = react_1.useState(), popupContents = _g[0], setPopupContents = _g[1];
    /** Date-time layers must have been created after on server. Used to support refreshing */
    var _h = react_1.useState(new Date().toISOString()), layersCreatedAfter = _h[0], setLayersCreatedAfter = _h[1];
    ...
    var _j = react_1.useState(initialLegendDisplay == "closed" || (props.width < 500 && initialLegendDisplay == "closedIfSmall")), legendHidden = _j[0], setLegendHidden = _j[1];
    ...
    function updateUserStyle() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            var earliestExpires, compiledFilters, scopedCompiledFilters, newSources, newLayers, newClickHandlers, _i, _a, layerView, isScoping;
