...
module.exports = AdminChoroplethLayer = (function(superClass) {
  ...
  AdminChoroplethLayer.prototype.createJsonQL = function(design, schema, filters) {
    var axisBuilder, colorExpr, compiledAdminRegionExpr, exprCompiler, filter, i, innerQuery, labelExpr, len, query, ref, relevantFilters, whereClauses;
     ...
     */
    if ((ref = design.detailLevel) !== 0 && ref !== 1 && ref !== 2 && ref !== 3 && ref !== 4 && ref !== 5) {
  ...
  AdminChoroplethLayer.prototype.getLegend = function(design, schema, name) {
    var axisBuilder, categories, colors, exprUtils, layerTitleStyle, legendGroupProps;
    axisBuilder = new AxisBuilder({
      schema: schema
    });
