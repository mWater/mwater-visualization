var H, LabeledInlineComponent, LayeredChartCompiler, LayeredChartDesignerComponent, LayeredChartLayerDesignerComponent, PropTypes, R, React, TabbedComponent, ThresholdComponent, ThresholdsComponent, ui, uiComponents,
...
module.exports = LayeredChartDesignerComponent = (function(superClass) {
  ...
  LayeredChartDesignerComponent.prototype.render = function() {
    ...
    tabs.push({
      id: "design",
      label: "Design",
      elem: H.div(null, H.br(), this.renderType(), this.renderLayers(), this.renderThresholds())
    });
    if (this.props.design.type) {
      tabs.push({
        id: "labels",
...
ThresholdsComponent = (function(superClass) {
  ...
  ThresholdsComponent.prototype.render = function() {
    return H.div(null, _.map(this.props.thresholds, (function(_this) {
...
ThresholdComponent = (function(superClass) {
  ...
  ThresholdComponent.prototype.render = function() {
    return H.div(null, R(LabeledInlineComponent, {
      key: "value",
      label: "Value:"
    }, R(ui.NumberInput, {
      style: {
