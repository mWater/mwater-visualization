var $, AutoSizeComponent, DataSource, DirectDashboardDataSource, DirectDatagridDataSource, DirectMapDataSource, DragDropContextProvider, HTML5Backend, ItemsHtmlConverter, MWaterDashboardPane, MWaterDataSource, MWaterDatagridPane, MWaterDirectDashboardPane, MWaterDirectMapPane, MWaterLoaderComponent, MWaterMapPane, PropTypes, R, React, ReactDOM, RichTextComponent, RichTextPane, Schema, ServerDashboardDataSource, ServerMapDataSource, WaterOrgDashboardPane, adminRegionMap, autoBoundsMap, badColorsMap, badColorsMap2, bufferMap, datagridDesign, design, doubleClickMap, imageWidgetDashboardDesign, mapAndChartDashboard, mapDesign, mapId, oldDashboardDesign, pageBreakProblem, querystring, rosterDatagridDesign, share, simpleBarChart, simplePieChart, testMedium, visualization, wholeWorldFuncMap,
...
RichTextPane = (function(superClass) {
  ...
  function RichTextPane(props) {
    ...
    RichTextPane.__super__.constructor.call(this, props);
    this.state = {
      items: null
    };
  }
...
MWaterDashboardPane = (function(superClass) {
  ...
  function MWaterDashboardPane(props) {
    ...
    MWaterDashboardPane.__super__.constructor.call(this, props);
    this.state = {
      design: null,
      extraTables: []
    };
...
MWaterDirectDashboardPane = (function(superClass) {
  ...
  function MWaterDirectDashboardPane(props) {
    this.handleExtraTablesChange = bind(this.handleExtraTablesChange, this);
    this.handleDesignChange = bind(this.handleDesignChange, this);
    MWaterDirectDashboardPane.__super__.constructor.call(this, props);
    this.state = {
  ...
  MWaterDirectDashboardPane.prototype.handleExtraTablesChange = function(extraTables) {
    this.setState({
      extraTables: extraTables
    });
    ...
    return React.createElement(MWaterLoaderComponent, {
      ...
      return function(error, config) {
        ...
        return R('div', {
          ...
          onRowClick: function(table, rowId) {
            return alert("Row clicked: " + table + " " + rowId);
          }
        }));
      };
    })(this));
...
MWaterMapPane = (function(superClass) {
  ...
  function MWaterMapPane(props) {
    this.handleDesignChange = bind(this.handleDesignChange, this);
    MWaterMapPane.__super__.constructor.call(this, props);
    this.state = {
      design: null,
      extraTables: []
    };
...
MWaterDirectMapPane = (function(superClass) {
  ...
  function MWaterDirectMapPane(props) {
    this.handleExtraTablesChange = bind(this.handleExtraTablesChange, this);
    this.handleDesignChange = bind(this.handleDesignChange, this);
    MWaterDirectMapPane.__super__.constructor.call(this, props);
    this.state = {
  ...
  MWaterDirectMapPane.prototype.handleExtraTablesChange = function(extraTables) {
    this.setState({
      extraTables: extraTables
    });
...
MWaterDatagridPane = (function(superClass) {
  ...
  function MWaterDatagridPane(props) {
    this.handleDesignChange = bind(this.handleDesignChange, this);
    MWaterDatagridPane.__super__.constructor.call(this, props);
    this.state = {
...
WaterOrgDashboardPane = (function(superClass) {
  extend(WaterOrgDashboardPane, superClass);

  function WaterOrgDashboardPane(props) {
    this.handleDesignChange = bind(this.handleDesignChange, this);
    WaterOrgDashboardPane.__super__.constructor.call(this, props);
    this.state = {
      design: {
        items: {
          id: "root",
  ...
  WaterOrgDashboardPane.prototype.componentWillMount = function() {
    var url;
    ...
    return $.getJSON(url, (function(_this) {
      return function(schemaJson) {
        ...
        dataSource = new MWaterDataSource(_this.props.apiUrl, null, {
          serverCaching: false,
          localCaching: true
        });
        return _this.setState({
  ...
  WaterOrgDashboardPane.prototype.handleDesignChange = function(design) {
    this.setState({
      design: design
    });
    return console.log(JSON.stringify(design, null, 2));
  ...
  WaterOrgDashboardPane.prototype.render = function() {
    var dashboardDataSource;
