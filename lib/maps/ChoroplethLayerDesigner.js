...
class ChoroplethLayerDesigner extends react_1.default.Component {
    ...
    renderRegionsTable() {
        ...
        return (react_1.default.createElement("div", { className: "form-group" },
            ...
            react_1.default.createElement("div", { style: { marginLeft: 8 } },
                react_1.default.createElement("select", { value: regionsTable, onChange: ev => this.handleRegionsTableChange(ev.target.value), className: "form-control" },
    ...
    renderDisplayNames() {
        return R('div', { className: "form-group" }, R('div', { className: "checkbox" }, R('label', null, R('input', { type: "checkbox", checked: this.props.design.displayNames, onChange: ev => this.handleDisplayNamesChange(ev.target.checked) }), "Display Region Names")));
    }
    renderColor() {
        // Only if plain
