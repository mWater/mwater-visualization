            ...
            for (let layerId = 0, end = layers.length, asc = 0 <= end; asc ? layerId < end : layerId > end; asc ? layerId++ : layerId--) {
                ...
                for (let axisKey in layer.axes) {
                    ...
                    layer.axes[axisKey] = axisBuilder.cleanAxis({
                        axis: axis ? (0, immer_2.original)(axis) : null,
                        table: layer.table,
                        aggrNeed,
                        types: (_a = LayeredChartUtils.getAxisTypes(draft, layer, axisKey)) !== null && _a !== void 0 ? _a : undefined
                    });
                }
                ...
                layer.filter = exprCleaner.cleanExpr(layer.filter ? (0, immer_2.original)(layer.filter) : null, {
                    table: layer.table,
                    types: ["boolean"]
                });
