...
LayoutCellComponent = (function(superClass) {
  ...
  LayoutCellComponent.prototype.render = function() {
    ...
    style = {
      padding: 5,
      backgroundColor: cell.unconfigured && !isHover && this.props.onEditSection ? "#dfebf6" : cell.unconfigured && this.props.onEditSection ? "#eff5fb" : isHover ? "#F8F8F8" : cell.backgroundColor,
      position: "relative",
