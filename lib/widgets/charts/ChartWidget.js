...
ChartWidgetComponent = (function(superClass) {
  ...
  ChartWidgetComponent.prototype.renderChart = function(width, height, standardWidth) {
  ...
  ChartWidgetComponent.prototype.renderEditor = function() {
    ...
    chart = this.renderChart(width, this.props.height * (width / this.props.width), width);
    content = H.div({
      style: {
        height: "100%",
        width: "100%"
  ...
  ChartWidgetComponent.prototype.render = function() {
    ...
    }, this.renderChart(this.props.width, this.props.height, this.props.standardWidth)), (emptyDesign || !validDesign) && (this.props.onDesignChange != null) ? this.renderEditLink() : void 0);
  };
