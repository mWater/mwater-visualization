var Container, DecoratedBlockComponent, DragDropContext, DragSource, DropTarget, LayoutComponent, MoveLayoutComponent, MoveResizeLayoutComponent, PropTypes, R, React, ReactDOM, _, moveCollect, moveSpec, resizeCollect, resizeSpec, targetCollect, targetSpec,
...
Container = (function(superClass) {
  ...
  function Container(props) {
    ...
    Container.__super__.constructor.call(this, props);
    this.state = {
      moveHover: null,
      resizeHover: null
    };
