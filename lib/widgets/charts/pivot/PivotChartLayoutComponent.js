    ...
    (0, _createClass2["default"])(PivotChartLayoutComponent, [{
      ...
      value: function render() {
        ...
        return R('div', {
          ...
          className: "fa fa-exclamation-circle"
        }), " Warning: Too many columns in table to display") : void 0, R('div', {
          style: {
            position: "relative"
          }
        }, R('table', {
  ...
  var LayoutCellComponent = /*#__PURE__*/function (_React$Component2) {
    ...
    (0, _createClass2["default"])(LayoutCellComponent, [{
      ...
      value: function render() {
        ...
        var backgroundColor, borderBottom, borderRight, borderWeights, c, cell, classes, innerStyle, isHover, ref, ref1, ref2, ref3, style, textColor;
        cell = this.props.layout.rows[this.props.rowIndex].cells[this.props.columnIndex];
        ...
        if (backgroundColor) {
          ...
          textColor = (c.red() + c.green() + c.blue()) / 765 < 0.5 ? 'rgb(204,204,204)' : void 0;
        }
