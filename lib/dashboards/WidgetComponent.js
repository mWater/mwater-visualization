...
function WidgetComponent(props) {
    ...
    var widgetDataSource = react_1.useMemo(function () { return props.dashboardDataSource.getWidgetDataSource(props.type, props.id); }, [
    ...
    var widgetRef = useStabilizeFunction(props.widgetRef);
    // Stabilize values
