...
class OrderByDesignerComponent extends react_1.default.Component {
    ...
    render() {
        ...
        })), R("div", { className: "col-xs-3" }, react_1.default.createElement(bootstrap_1.Checkbox, { inline: true, value: this.props.orderBy.direction === "desc", onChange: this.handleDirectionChange }, "Reverse")), R("div", { className: "col-xs-1" }, R("button", { className: "btn btn-sm btn-link", type: "button", onClick: this.props.onRemove }, R("span", { className: "fas fa-times" }))));
    }
}
