...
var HexgridLayerDesigner = /** @class */ (function (_super) {
    __extends(HexgridLayerDesigner, _super);
    function HexgridLayerDesigner() {
        ...
        _this.handleSizeUnitsChange = function (sizeUnits) {
            if (sizeUnits === "pixels") {
                _this.update(function (d) { d.sizeUnits = sizeUnits; d.size = 30; });
            }
            else {
    ...
    HexgridLayerDesigner.prototype.update = function (mutation) {
        this.props.onDesignChange(immer_1.produce(this.props.design, mutation));
    };
    HexgridLayerDesigner.prototype.renderSize = function () {
    ...
    HexgridLayerDesigner.prototype.renderTable = function () {
        return (react_1.default.createElement("div", { className: "form-group" },
    ...
    HexgridLayerDesigner.prototype.renderGeometryExpr = function () {
        // If no data, hide
    ...
    HexgridLayerDesigner.prototype.renderColorAxis = function () {
        if (!this.props.design.table) {
            return null;
        }
    ...
    HexgridLayerDesigner.prototype.renderFillOpacity = function () {
        var _this = this;
    ...
    HexgridLayerDesigner.prototype.renderFilter = function () {
    ...
    //   })
    // }
    HexgridLayerDesigner.prototype.render = function () {
        return R('div', null, this.renderSize(), this.renderTable(), this.renderGeometryExpr(), this.renderColorAxis(), this.renderFillOpacity(), this.renderFilter(), 
        // this.renderPopup(),
        R(ZoomLevelsComponent, { design: this.props.design, onDesignChange: this.props.onDesignChange }));
    };
    return HexgridLayerDesigner;
}(react_1.default.Component));
exports.default = HexgridLayerDesigner;
