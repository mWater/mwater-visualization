...
class DateRangeComponent extends react_1.default.Component {
    constructor(props) {
        ...
        this.handleStartChange = (value) => {
            ...
            if (((_a = this.props.value) === null || _a === void 0 ? void 0 : _a[1]) && this.fromMoment(value) > this.props.value[1]) {
                ...
                return this.props.onChange([this.fromMoment(value), (_c = (_b = this.props.value) === null || _b === void 0 ? void 0 : _b[1]) !== null && _c !== void 0 ? _c : null]);
            }
        };
        this.handleEndChange = (value) => {
            ...
            if (((_a = this.props.value) === null || _a === void 0 ? void 0 : _a[0]) && this.fromMoment(value) < this.props.value[0]) {
                ...
                this.props.onChange([(_c = (_b = this.props.value) === null || _b === void 0 ? void 0 : _b[0]) !== null && _c !== void 0 ? _c : null, this.fromMoment(value)]);
            }
            return this.setState({ dropdownOpen: false });
        };
        this.handlePreset = (preset) => {
            ...
            let end, start;
            if (this.props.datetime) {
                start = (0, moment_1.default)(preset.value[0]);
                start.startOf("day");
                end = (0, moment_1.default)(preset.value[1]);
                end.endOf("day");
            }
            else {
    ...
    getPresets() {
        const presets = [
            { label: "Today", value: [(0, moment_1.default)(), (0, moment_1.default)()] },
            { label: "Yesterday", value: [(0, moment_1.default)().subtract(1, "days"), (0, moment_1.default)().subtract(1, "days")] },
            { label: "Last 7 Days", value: [(0, moment_1.default)().subtract(6, "days"), (0, moment_1.default)()] },
            { label: "Last 30 Days", value: [(0, moment_1.default)().subtract(29, "days"), (0, moment_1.default)()] },
            { label: "This Month", value: [(0, moment_1.default)().startOf("month"), (0, moment_1.default)().endOf("month")] },
            {
                label: "Last Month",
                value: [(0, moment_1.default)().subtract(1, "months").startOf("month"), (0, moment_1.default)().subtract(1, "months").endOf("month")]
            },
            { label: "This Year", value: [(0, moment_1.default)().startOf("year"), (0, moment_1.default)().endOf("year")] },
            {
                label: "Last Year",
