...
exports.default = RichTextComponent = (function () {
    RichTextComponent = class RichTextComponent extends react_1.default.Component {
        constructor(props) {
            super(props);
            this.handleClick = (ev) => {
            ...
            this.renderPaletteContent = (schemeName, { edges }) => {
                return R("div", {
                    ...
                    ref: (c) => {
                        return (this.paletteComponent = c);
                    }
                }, R("div", {
                    key: "bold",
        ...
        static initClass() {
            this.propTypes = {
                ...
                onItemsChange: prop_types_1.default.func,
                onItemClick: prop_types_1.default.func,
                className: prop_types_1.default.string,
                style: prop_types_1.default.object,
                // Converter to use for editing
                itemsHtmlConverter: prop_types_1.default.object,
                // True (default) to include heading h1, h2 in palette
                includeHeadings: prop_types_1.default.bool,
                // Extra buttons to put in palette
                extraPaletteButtons: prop_types_1.default.node
            };
            this.defaultProps = {
