...
module.exports = AxisBuilder = (function() {
  ...
  AxisBuilder.prototype.compileAxis = function(options) {
    var cases, compiledExpr, expr, exprCompiler, j, len, max, min, range, ref, whens;
    if (!options.axis) {
      return null;
    }
  ...
  AxisBuilder.prototype.getCategories = function(axis, values, locale) {
    var categories, current, end, format, i, j, k, max, min, noneCategory, numBins, precision, ref, ref1, ref2, start, year;
    noneCategory = {
      value: null,
    ...
    switch (this.getAxisType(axis)) {
      ...
      case "text":
        return _.map(_.compact(_.uniq(values)).sort(), function(v) {
          return {
            value: v,
            label: v || "None"
          };
