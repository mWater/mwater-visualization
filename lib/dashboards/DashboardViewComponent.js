...
exports.default = DashboardViewComponent = (function () {
    var _a;
    DashboardViewComponent = (_a = class DashboardViewComponent extends react_1.default.Component {
            constructor(props) {
                super(props);
            ...
            render() {
                ...
                return R("div", { style }, !this.props.hideScopes ? this.renderScopes() : undefined, layoutManager.renderLayout({
                    ...
                    layoutOptions: layoutOptions_1.getLayoutOptions(this.props.design),
                    renderWidget,
        ...
        _a.propTypes = {
            ...
            initialTOCEntryScroll: prop_types_1.default.shape({ widgetId: prop_types_1.default.string.isRequired, entryId: prop_types_1.default.any }),
            // True to hide scope display
            hideScopes: prop_types_1.default.bool,
            // True to render in print mode (prevents odd clipping issue)
            printMode: prop_types_1.default.bool
        },
        _a.childContextTypes = { locale: prop_types_1.default.string },
        _a);
