...
class DashboardViewComponent extends react_1.default.Component {
    constructor(props) {
        ...
        this.print = () => __awaiter(this, void 0, void 0, function* () {
            ...
            const mapTilerAPIKey = vectorMaps_1.getMapTilerApiKey();
            try {
                vectorMaps_1.setMapTilerApiKey("");
                ...
                yield printer.print(elem, { delay: 5000 });
            }
            finally {
                vectorMaps_1.setMapTilerApiKey(mapTilerAPIKey);
            }
        });
