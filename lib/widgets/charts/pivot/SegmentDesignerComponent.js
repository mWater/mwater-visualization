var AxisComponent, BorderComponent, ColorComponent, ExprComponent, FilterExprComponent, PropTypes, R, React, SegmentDesignerComponent, _, ui,
...
module.exports = SegmentDesignerComponent = (function(superClass) {
  ...
  function SegmentDesignerComponent(props) {
    this.handleOrderDirChange = bind(this.handleOrderDirChange, this);
    this.handleOrderExprChange = bind(this.handleOrderExprChange, this);
  ...
  SegmentDesignerComponent.prototype.handleOrderExprChange = function(orderExpr) {
    return this.update({
      orderExpr: orderExpr
    });
  };

  SegmentDesignerComponent.prototype.handleOrderDirChange = function(orderDir) {
    return this.update({
      orderDir: orderDir
    });
  };
  ...
  SegmentDesignerComponent.prototype.renderOrderExpr = function() {
    return R(ui.FormGroup, {
      labelMuted: true,
      label: [
        R(ui.Icon, {
