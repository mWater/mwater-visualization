...
class QuickfilterDesignComponent extends react_1.default.Component {
    ...
    render() {
        ...
        return R(RemovableComponent, { onRemove: this.props.onRemove }, R("div", { className: "card mb-3" }, R("div", { className: "card-body" }, R("div", { className: "mb-3", key: "table" }, R("label", { className: "text-muted" }, "Data Source"), R(ui.Select, {
...
class RemovableComponent extends react_1.default.Component {
    render() {
        return R("div", { style: { display: "flex" }, className: "hover-display-parent" }, R("div", { style: { flex: "1 1 auto" }, key: "main" }, this.props.children), R("div", { style: { flex: "0 0 auto", alignSelf: "center" }, className: "hover-display-child", key: "remove" }, R("a", { className: "link-plain", onClick: this.props.onRemove, style: { fontSize: "80%", marginLeft: 5 } }, R("span", { className: "fas fa-times" }))));
    }
}
