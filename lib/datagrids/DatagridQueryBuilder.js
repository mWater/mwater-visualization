...
module.exports = DatagridQueryBuilder = (function() {
  ...
  DatagridQueryBuilder.prototype.createComplexMainQuery = function(design, options) {
    var expr, exprCompiler, extraFilter, i, j, k, l, len, len1, len2, len3, m, query, ref, ref1, ref2, ref3, selects, stindex, subtable, wheres;
    exprCompiler = new ExprCompiler(this.schema);
    selects = [
      {
        type: "select",
  ...
  DatagridQueryBuilder.prototype.createComplexSubtableQuery = function(design, options, subtable, subtableIndex) {
    var expr, exprCompiler, exprUtils, extraFilter, i, j, k, l, len, len1, len2, len3, m, query, ref, ref1, ref2, ref3, selects, st, stindex, subtableTable, wheres;
