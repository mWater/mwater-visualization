var AttributionComponent, BaseLayerDesignerComponent, CheckboxComponent, ClickOutHandler, H, MapDesignerComponent, MapFiltersDesignerComponent, MapLayersDesignerComponent, R, React,
...
module.exports = MapDesignerComponent = (function(superClass) {
  ...
  MapDesignerComponent.prototype.render = function() {
    return H.div({
      ...
      className: "text-muted"
    }, "Automatic zoom")), R(AttributionComponent, {
