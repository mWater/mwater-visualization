...
module.exports = LeafletMapComponent = (function(superClass) {
  ...
  LeafletMapComponent.propTypes = {
    ...
    layers: React.PropTypes.arrayOf(React.PropTypes.shape({
      tileUrl: React.PropTypes.string.isRequired,
  ...
  LeafletMapComponent.prototype.componentDidMount = function() {
    ...
    this.map.fitBounds(new L.LatLngBounds([[this.props.initialBounds.n, this.props.initialBounds.w], [this.props.initialBounds.s, this.props.initialBounds.e]]));
  ...
  LeafletMapComponent.prototype.updateMap = function(prevProps) {
    ...
    if (!prevProps || !_.isEqual(this.props.layers !== prevProps.layers)) {
      if (this.tileLayers) {
        ref = this.tileLayers;
