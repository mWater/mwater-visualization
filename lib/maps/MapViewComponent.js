var ExprCompiler, ExprUtils, LayerFactory, LeafletMapComponent, LegendComponent, MapUtils, MapViewComponent, ModalPopupComponent, PropTypes, R, React, _,
...
module.exports = MapViewComponent = (function(superClass) {
  ...
  function MapViewComponent(props) {
    ...
    MapViewComponent.__super__.constructor.call(this, props);
    this.state = {
      popupContents: null
    };
  }
