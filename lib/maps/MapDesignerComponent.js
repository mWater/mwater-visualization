...
module.exports = MapDesignerComponent = function () {
  var MapDesignerComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(MapDesignerComponent, _React$Component);

    var _super = _createSuper(MapDesignerComponent);
    ...
    function MapDesignerComponent() {
      ...
      _this.handleShowLayerSwitcherChange = _this.handleShowLayerSwitcherChange.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleConvertToClusterMap = _this.handleConvertToClusterMap.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleInitialLegendDisplayChange = _this.handleInitialLegendDisplayChange.bind((0, _assertThisInitialized2["default"])(_this));
      return _this;
    }
    ...
    (0, _createClass2["default"])(MapDesignerComponent, [{
      ...
      key: "handleShowLayerSwitcherChange",
      value: function handleShowLayerSwitcherChange(value) {
        var design;
        boundMethodCheck(this, MapDesignerComponent);
        design = _.extend({}, this.props.design, {
          showLayerSwitcher: value
        });
        return this.props.onDesignChange(design);
      }
    }, {
      ...
      key: "handleInitialLegendDisplayChange",
      value: function handleInitialLegendDisplayChange(value) {
        var design;
        boundMethodCheck(this, MapDesignerComponent);
        design = _.extend({}, this.props.design, {
          initialLegendDisplay: value
        });
        return this.props.onDesignChange(design);
      }
    }, {
      ...
      value: function renderOptionsTab() {
        return R('div', null, R(BaseLayerDesignerComponent, {
          ...
          placement: "left"
        }, "Automatically zoom to the complete data whenever the map is loaded or the filters change"))), R(CheckboxComponent, {
          checked: this.props.design.showLayerSwitcher,
          onChange: this.handleShowLayerSwitcherChange
        }, R('span', {
          className: "text-muted"
        }, "Show Layer Switcher ", R(PopoverHelpComponent, {
          placement: "left"
        }, "Show a control in the map allowing switching layers"))), R(ui.FormGroup, {
          label: "Initial Legend Display",
          labelMuted: true
        }, R(ui.Select, {
          ...
          options: [{
            ...
            value: "closedIfSmall",
            label: "Open if wide enough"
          }],
          style: {
            width: "auto"
          }
        })), MapUtils.canConvertToClusterMap(this.props.design) ? R('div', {
          key: "tocluster"
        }, R('a', {
...
AttributionComponent = function () {
  ...
  var AttributionComponent = /*#__PURE__*/function (_React$Component2) {
    (0, _inherits2["default"])(AttributionComponent, _React$Component2);

    var _super2 = _createSuper(AttributionComponent);
...
AdvancedOptionsComponent = function () {
  ...
  var AdvancedOptionsComponent = /*#__PURE__*/function (_React$Component3) {
    (0, _inherits2["default"])(AdvancedOptionsComponent, _React$Component3);

    var _super3 = _createSuper(AdvancedOptionsComponent);
