...
class LayerLegendComponent extends react_1.default.Component {
    getCategories() {
        ...
        return axisBuilder.getCategories(this.props.axis, lodash_1.default.pluck(this.props.axis.colorMap, "value"), { locale: this.props.locale });
    }
    render() {
        let items;
        const axisBuilder = new AxisBuilder_1.default({ schema: this.props.schema });
...
LayerLegendComponent.defaultProps = { radiusLayer: false };
