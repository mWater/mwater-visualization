...
module.exports = DashboardViewComponent = function () {
  ...
  function (_React$Component) {
    ...
    function DashboardViewComponent(props) {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(DashboardViewComponent).call(this, props));
      _this.handleStorageChange = _this.handleStorageChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      ...
      _this.handleRemoveScope = _this.handleRemoveScope.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleItemsChange = _this.handleItemsChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))); // Handle a change of the clipboard and determine which tables the clipboard block uses

      _this.handleClipboardChange = _this.handleClipboardChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))); // Call to print the dashboard

      _this.print = _this.print.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleScrollToTOCEntry = _this.handleScrollToTOCEntry.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.state = {
    ...
    (0, _createClass2.default)(DashboardViewComponent, [{
      ...
      value: function handleClipboardChange(block) {
        var tables;
        boundMethodCheck(this, DashboardViewComponent); // If empty, just set it
