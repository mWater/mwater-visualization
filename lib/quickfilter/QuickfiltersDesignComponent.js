...
class QuickfilterDesignComponent extends react_1.default.Component {
    ...
    render() {
        ...
        return R(RemovableComponent, { onRemove: this.props.onRemove }, R("div", { className: "panel panel-default" }, R("div", { className: "panel-body" }, R("div", { className: "form-group", key: "table" }, R("label", { className: "text-muted" }, "Data Source"), R(ui.Select, {
