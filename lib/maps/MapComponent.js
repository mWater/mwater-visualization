var AutoSizeComponent, H, MapComponent, MapControlComponent, MapDesignerComponent, MapViewComponent, PopoverHelpComponent, PropTypes, R, React, UndoStack, _,
  ...
  MapComponent.prototype.renderActionLinks = function() {
    return H.div(null, this.props.onDesignChange != null ? [
      H.a({
        ...
        placement: "bottom"
      }, 'Changes to zoom level wont be saved in locked mode')), H.a({
        key: "undo",
