...
class MarkersLayerDesignerComponent extends react_1.default.Component {
    constructor() {
        ...
        this.handlePolygonBorderColorChange = (polygonBorderColor) => {
            return this.update({ polygonBorderColor });
        };
        this.handlePolygonFillOpacityChange = (polygonFillOpacity) => {
    ...
    renderPolygonBorderColor() {
        ...
        return R("div", { className: "mb-3" }, R("label", { className: "text-muted" }, "Polygon border color (blank for same as fill color)"), R("div", null, R(ColorComponent_1.default, {
    ...
    renderPolygonFillOpacity() {
        ...
        return R("div", { className: "mb-3" }, R("label", { className: "text-muted" }, R("span", null, `Polygon Fill Opacity: ${Math.round(opacity * 100)}%`)), R("div", { style: { padding: "10px" } }, react_1.default.createElement(rc_slider_1.default, {
            min: 0,
            max: 100,
            step: 1,
