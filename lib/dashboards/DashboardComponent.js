var AutoSizeComponent, DashboardComponent, DashboardUpgrader, DashboardViewComponent, ExprCompiler, H, LayoutManager, PropTypes, QuickfilterCompiler, QuickfiltersComponent, R, React, SettingsModalComponent, UndoStack, _,
...
module.exports = DashboardComponent = (function(superClass) {
  ...
  DashboardComponent.prototype.handleRefreshData = function() {
    ...
    if (typeof (base1 = this.props.dashboardDataSource).clearCache === "function") {
      base1.clearCache();
    }
