...
function NewMapViewComponent(props) {
    ...
    function updateUserStyle() {
        return __awaiter(this, void 0, void 0, function () {
            function addLayer(layerView, filters, opacity) {
                return __awaiter(this, void 0, void 0, function () {
                    var layer, design, defType, layerDataSource, _a, expires, url, vectorTileDef, _i, _b, mapLayer, tileUrl, tiles;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, layerDataSource.getVectorTileUrl(design, filters, layersCreatedAfter)];
                            case 1:
                                ...
                                vectorTileDef = layer.getVectorTile(design, layerView.id, props.schema, filters, opacity);
                                ...
                                return [3 /*break*/, 3];
                            case 2:
                                tileUrl = props.mapDataSource.getLayerDataSource(layerView.id).getTileUrl(design, []);
                                if (tileUrl) {
                                    tiles = [];
    ...
    react_1.useEffect(function () {
        ...
        // Add scale control
        var scale = new mapbox_gl_1.default.ScaleControl({
            unit: 'metric'
        });
        m.addControl(scale);
    ...
    react_1.useEffect(function () {
        ...
        // Load style
        var styleUrl = "https://api.mapbox.com/styles/v1/mapbox/" + style + "?access_token=pk.eyJ1IjoiZ3Jhc3NpY2siLCJhIjoiY2ozMzU1N3ZoMDA3ZDJxbzh0aTRtOTRoeSJ9.fFWBZ88vbdezyhfw-I-fag";
    ...
    react_1.useEffect(function () {
        ...
        var style = __assign(__assign({}, baseStyle), { sources: __assign(__assign({}, baseStyle.sources), userStyle.sources), glyphs: baseStyle.glyphs || "mapbox://fonts/mapbox/{fontstack}/{range}.pbf", layers: layers });
        map.setStyle(style);
