...
module.exports = HorizontalBlockComponent = function () {
  var HorizontalBlockComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(HorizontalBlockComponent, _React$Component);

    var _super = _createSuper(HorizontalBlockComponent);
    ...
    (0, _createClass2["default"])(HorizontalBlockComponent, [{
      ...
      value: function render() {
        ...
        var elem, i, index, j, percentages, ref, ref1, totalWeight, weight; // Handle simple case of collapseColumns (no editing allowed)

        if (this.props.collapseColumns) {
          return R('div', null, _.map(this.props.block.blocks, function (block, index) {
            return _this2.props.renderBlock(block, true);
          }));
