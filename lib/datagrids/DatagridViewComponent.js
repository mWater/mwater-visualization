...
module.exports = DatagridViewComponent = function () {
  var DatagridViewComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(DatagridViewComponent, _React$Component);

    var _super = _createSuper(DatagridViewComponent);

    function DatagridViewComponent(props) {
      var _this;

      (0, _classCallCheck2["default"])(this, DatagridViewComponent);
      _this = _super.call(this, props); // Reloads all data

      _this.reload = _this.reload.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleColumnResize = _this.handleColumnResize.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleCellClick = _this.handleCellClick.bind((0, _assertThisInitialized2["default"])(_this)); // Called to save 

      _this.handleSaveEdit = _this.handleSaveEdit.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleCancelEdit = _this.handleCancelEdit.bind((0, _assertThisInitialized2["default"])(_this)); // Called with current ref edit. Save

      _this.refEditCell = _this.refEditCell.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleRowDoubleClick = _this.handleRowDoubleClick.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleRowClick = _this.handleRowClick.bind((0, _assertThisInitialized2["default"])(_this)); // Render a single cell. exprType is passed in for performance purposes and is calculated once per column

      _this.renderCell = _this.renderCell.bind((0, _assertThisInitialized2["default"])(_this));
      _this.state = {
        rows: [],
