            ...
            return {
                ...
                elem: R(visualizationExports.DashboardComponent, {
                    ...
                    extraTitleButtonsElem: [
                        R("a", { key: "renametab", className: "btn btn-link btn-sm", onClick: this.handleRenameTab.bind(null, index) }, R("span", { className: "fas fa-pencil-alt" }), " Rename Tab"),
                        " ",
                        R("a", { key: "removetab", className: "btn btn-link btn-sm", onClick: this.handleRemoveTab.bind(null, index) }, R("span", { className: "fas fa-times" }), " Remove Tab")
                    ]
                })
            };
        };
