var AxisBuilder, ExprCleaner, ExprCompiler, ExprUtils, H, Layer, LayerLegendComponent, LegendGroup, MarkersLayer, PopupFilterJoinsUtils, React, _, injectTableAlias,
...
module.exports = MarkersLayer = (function(superClass) {
  ...
  MarkersLayer.prototype.onGridClick = function(ev, clickOptions) {
    var BlocksLayoutManager, WidgetFactory, filter, ids, popupFilterJoins, popupFilters, ref, results, table;
  ...
  MarkersLayer.prototype.getLegend = function(design, schema, name, dataSource, filters) {
