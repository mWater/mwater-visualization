...
module.exports = MarkersLayer = (function(superClass) {
  ...
  MarkersLayer.prototype.createJsonQL = function(sublayer, filters) {
    var axisBuilder, cluster, exprCompiler, filter, geometryExpr, innerquery, j, len, outerquery, relevantFilters, whereClauses;
  ...
  MarkersLayer.prototype.cleanDesign = function(design) {
    var axis, axisBuilder, axisKey, exprCleaner, j, len, ref, ref1, sublayer;
