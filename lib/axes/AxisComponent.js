...
module.exports = AxisComponent = (function(superClass) {
  ...
  AxisComponent.prototype.handleExprChange = function(expr) {
    ...
    return this.props.onChange(this.cleanAxis(_.extend({}, _.omit(this.props.value, ["colorMap", "drawOrder"]), {
      expr: expr
    })));
  };
  ...
  AxisComponent.prototype.handleXformChange = function(xform) {
    return this.props.onChange(this.cleanAxis(update(_.omit(this.props.value, ["colorMap", "drawOrder"]), {
      xform: {
        $set: xform
      }
    })));
  ...
  AxisComponent.prototype.render = function() {
    ...
    })), this.renderXform(axis), this.renderColorMap(axis));
  };
