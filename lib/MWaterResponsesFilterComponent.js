...
module.exports = MWaterResponsesFilterComponent = (function(superClass) {
  ...
  MWaterResponsesFilterComponent.prototype.render = function() {
    ...
    return H.div(null, R(ui.Checkbox, {
      value: this.isFinal(),
      onChange: this.handleFinalChange
    }, "Only Include Final Responses (recommended)"), siteColumns.length > 0 ? H.div({
      style: {
        paddingLeft: 5
      }
    }, R(ui.Radio, {
    ...
    }, "Do Not Filter by Latest"), _.map(siteColumns, (function(_this) {
      return function(column) {
        ...
        }, "Only Latest Response For Each ", H.i(null, "'" + (ExprUtils.localizeString(column.name)) + "'"));
      };
    })(this))) : void 0);
  };
