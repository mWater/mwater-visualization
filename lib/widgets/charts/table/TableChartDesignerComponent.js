...
class TableChartDesignerComponent extends react_1.default.Component {
    ...
    renderLimit() {
        ...
        return R("div", { className: "form-group" }, R("label", { className: "text-muted" }, "Maximum Number of Rows (up to 1000)"), R("div", { style: { marginLeft: 8 } }, R(bootstrap_1.default.NumberInput, {
