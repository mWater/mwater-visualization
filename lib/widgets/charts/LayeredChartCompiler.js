var AxisBuilder, ExprCompiler, ExprUtils, LayeredChartCompiler, _, colorHacks, injectTableAlias;
...
module.exports = LayeredChartCompiler = (function() {
  ...
  LayeredChartCompiler.prototype.compileYAxisLabelText = function(design, locale) {
    return design.yAxisLabelText || this.compileDefaultYAxisLabelText(design, locale);
  };

  LayeredChartCompiler.prototype.compileXAxisLabelText = function(design, locale) {
    return design.xAxisLabelText || this.compileDefaultXAxisLabelText(design, locale);
  };
