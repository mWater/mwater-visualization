...
module.exports = MapLayersDesignerComponent = (function(superClass) {
  ...
  MapLayersDesignerComponent.prototype.renderLayerGearMenu = function(layer, index) {
    ...
    }, H.li(null, H.a(null, "Edit Layer")), H.li(null, H.a(null, "Set Opacity")), H.li(null, H.a({
  ...
  MapLayersDesignerComponent.prototype.renderBaseLayer = function() {
    return H.div({
      style: {
        margin: 5,
        marginBottom: 10
      ...
      type: "radio",
      checked: this.props.design.baseLayer === "bing_road",
      onClick: this.handleBaseLayerChange.bind(null, "bing_road")
    }, "Roads")), H.label({
      className: "radio-inline"
    }, H.input({
      type: "radio",
      checked: this.props.design.baseLayer === "bing_aerial",
      onClick: this.handleBaseLayerChange.bind(null, "bing_aerial")
    }, "Satellite")));
  };
