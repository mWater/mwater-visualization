...
module.exports = ServerDashboardDataSource = /*#__PURE__*/function () {
  // options:
...
ServerWidgetDataSource = /*#__PURE__*/function () {
  // options:
  //   apiUrl: API url to use for talking to mWater server
  //   client: client id to use for talking to mWater server
  //   share: share id to use for talking to mWater server
...
ServerWidgetMapDataSource = /*#__PURE__*/function () {
  // options:
  //   apiUrl: API url to use for talking to mWater server
...
ServerWidgetLayerDataSource = /*#__PURE__*/function () {
  // options:
  //   apiUrl: API url to use for talking to mWater server
  //   client: client id to use for talking to mWater server
  //   share: share id to use for talking to mWater server
...
ServerWidgetLayerPopupWidgetDataSource = /*#__PURE__*/function () {
  // options:
  //   apiUrl: API url to use for talking to mWater server
  //   client: client id to use for talking to mWater server
  //   share: share id to use for talking to mWater server
