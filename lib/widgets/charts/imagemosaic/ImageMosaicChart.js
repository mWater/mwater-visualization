...
var AxisBuilder, Chart, ExprCleaner, ExprCompiler, ImageMosaicChart, R, React, _, injectTableAlias;
...
module.exports = ImageMosaicChart =
/*#__PURE__*/
function (_Chart) {
  ...
  function ImageMosaicChart() {
    ...
    return (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(ImageMosaicChart).apply(this, arguments));
  }
  ...
  (0, _createClass2["default"])(ImageMosaicChart, [{
    ...
    value: function cleanDesign(design, schema) {
      ...
      design.version = design.version || 1; // Clean axis
