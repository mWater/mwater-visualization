...
class QuickfiltersDesignComponent extends react_1.default.Component {
    ...
    render() {
        return R("div", null, lodash_1.default.map(this.props.design, (item, index) => this.renderQuickfilter(item, index)), this.props.tables.length > 0
            ? R("button", { type: "button", className: "btn btn-sm btn-default", onClick: this.handleAdd }, R("span", { className: "glyphicon glyphicon-plus" }), " Add Quick Filter")
            : undefined);
    }
}
exports.default = QuickfiltersDesignComponent;
QuickfiltersDesignComponent.defaultProps = { design: [] };
class QuickfilterDesignComponent extends react_1.default.Component {
    ...
    render() {
        ...
        return R(RemovableComponent, { onRemove: this.props.onRemove }, R("div", { className: "panel panel-default" }, R("div", { className: "panel-body" }, R("div", { className: "form-group", key: "table" }, R("label", { className: "text-muted" }, "Data Source"), R(bootstrap_1.default.Select, {
            ...
            nullLabel: "Select..."
        })), R("div", { className: "form-group", key: "expr" }, R("label", { className: "text-muted" }, "Filter By"), R("div", null, R(mwater_expressions_ui_1.ExprComponent, {
            schema: this.props.schema,
            dataSource: this.props.dataSource,
            ...
            ? R("div", { className: "form-group", key: "label" }, R("label", { className: "text-muted" }, "Label"), R("input", {
                type: "text",
...
class RemovableComponent extends react_1.default.Component {
    render() {
        return R("div", { style: { display: "flex" }, className: "hover-display-parent" }, R("div", { style: { flex: "1 1 auto" }, key: "main" }, this.props.children), R("div", { style: { flex: "0 0 auto", alignSelf: "center" }, className: "hover-display-child", key: "remove" }, R("a", { onClick: this.props.onRemove, style: { fontSize: "80%", cursor: "pointer", marginLeft: 5 } }, R("span", { className: "glyphicon glyphicon-remove" }))));
    }
}
