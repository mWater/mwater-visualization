...
class DateExprComponent extends react_1.default.Component {
    ...
    renderPresets() {
        ...
        }, R("ul", { className: "nav nav-pills nav-justified" }, lodash_1.default.map(presets, (preset) => {
            return R("li", null, R("a", { style: { padding: 5 }, onClick: this.handlePreset.bind(null, preset) }, preset.name));
