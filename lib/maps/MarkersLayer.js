...
class MarkersLayer extends Layer_1.default {
    ...
    getVectorTile(design, sourceId, schema, filters, opacity) {
        ...
        const color = mapboxUtils_1.compileColorMapToMapbox(design.axes.color, design.color || "#666666");
        // Add polygons
        mapLayers.push({
        ...
        if (!design.symbol) {
            mapLayers.push({
                ...
                paint: {
                    ...
                    "circle-stroke-color": mapboxUtils_1.compileColorToMapbox("white", (_a = design.axes.color) === null || _a === void 0 ? void 0 : _a.excludedValues),
