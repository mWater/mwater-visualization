...
AddRelatedFormModalComponent.contextTypes = { locale: prop_types_1.default.string };
function escapeRegex(s) {
    return s.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&");
}
/** Finds asset question in form */
function findAssetQuestion(formDesign, assetSystemId) {
    var _a;
    ...
    return (_a = question) !== null && _a !== void 0 ? _a : null;
}
