...
class ImageWidgetDesignComponent extends react_1.default.Component {
    ...
    renderUrlEditor() {
        ...
        }), R("div", { className: "form-text text-muted" }, "e.g. http://somesite.com/"), R("div", { className: "form-text text-muted" }, "When clicked on image, this link will open in a new tab"));
    }
    render() {
        ...
        const footer = R("div", null, R("button", { key: "save", type: "button", className: "btn btn-primary", onClick: this.handleSave }, "Save"), R("button", { key: "cancel", type: "button", className: "btn btn-secondary", onClick: this.handleCancel }, "Cancel"));
