...
class AddLayerComponent extends react_1.default.Component {
    ...
    static initClass() {
        this.contextTypes = { addLayerElementFactory: prop_types_1.default.func };
    ...
    render() {
        ...
        return R("div", { style: { margin: 5 }, key: "addLayer", className: "btn-group" }, R("button", { type: "button", "data-toggle": "dropdown", className: "btn btn-primary dropdown-toggle" }, R("span", { className: "glyphicon glyphicon-plus" }), " Add Layer ", R("span", { className: "caret" })), R("ul", { className: "dropdown-menu" }, lodash_1.default.map(newLayers, (layer, i) => {
            return R("li", { key: "" + i }, R("a", { onClick: this.handleAddLayer.bind(null, layer) }, layer.label || layer.name));
        })));
    }
}
