...
exports.default = LayeredChartDesignerComponent;
...
class ThresholdComponent extends react_1.default.Component {
    render() {
        return R("div", null, R(LabeledInlineComponent, { key: "value", label: "Value:" }, R(ui.NumberInput, {
            ...
            : undefined, "  ", R("button", { className: "btn btn-sm btn-link", onClick: this.props.onRemove }, R("i", { className: "fa fa-remove" })));
    }
}
