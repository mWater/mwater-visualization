...
var AxisBuilder, Chart, ExprCleaner, LayeredChart, LayeredChartCompiler, LayeredChartSvgFileSaver, LayeredChartUtils, R, React, TextWidget, _, async;
...
function (_Chart) {
  ...
  (0, _createClass2["default"])(LayeredChart, [{
    ...
    value: function cleanDesign(design, schema) {
      ...
      design.layers = design.layers || [{}]; // Default to titleText (legacy)
