var ComparisonExprComponent, ExpressionBuilder, H, ScalarExprComponent, literalComponents,
...
module.exports = ComparisonExprComponent = (function(superClass) {
  ...
  ComparisonExprComponent.prototype.handleOpChange = function(ev) {
    return this.props.onChange(_.extend({}, this.props.value, {
      op: ev.target.value
    }));
  };
  ...
  ComparisonExprComponent.prototype.render = function() {
    var exprBuilder, lhsControl, lhsType, opControl, ops, rhsControl, rhsType;
