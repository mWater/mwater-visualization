...
var ChoroplethLayerDesigner = /** @class */ (function (_super) {
    ...
    function ChoroplethLayerDesigner() {
        ...
        _this.handleBorderOpacityChange = function (borderOpacity) {
            _this.update(function (d) { d.borderOpacity = borderOpacity; });
        };
    ...
    ChoroplethLayerDesigner.prototype.renderBorderOpacity = function () {
        var _this = this;
        return R('div', { className: "form-group" }, R('label', { className: "text-muted" }, "Border Opacity: " + (this.props.design.borderOpacity * 100).toFixed(0) + "%"), ": ", R(rc_slider_1.default, {
            min: 0,
            max: 100,
            step: 1,
            tipTransitionName: "rc-slider-tooltip-zoom-down",
            value: Math.round((this.props.design.borderOpacity) * 100),
            onChange: function (val) { return _this.handleBorderOpacityChange(val / 100); }
        }));
    };
    ...
    ChoroplethLayerDesigner.prototype.render = function () {
        return R('div', null, this.renderRegionMode(), this.renderRegionsTable(), this.renderTable(), this.renderAdminRegionExpr(), this.renderScopeAndDetailLevel(), this.renderDisplayNames(), this.renderColor(), this.renderColorAxis(), this.renderFillOpacity(), this.renderBorderColor(), this.renderBorderOpacity(), this.renderFilter(), this.renderPopup(), R(ZoomLevelsComponent, { design: this.props.design, onDesignChange: this.props.onDesignChange }));
    };
