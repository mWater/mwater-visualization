...
module.exports = LayeredChartLayerDesignerComponent = function () {
  var LayeredChartLayerDesignerComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(LayeredChartLayerDesignerComponent, _React$Component);

    var _super = _createSuper(LayeredChartLayerDesignerComponent);
    ...
    function LayeredChartLayerDesignerComponent() {
      ...
      _this.handleXAxisChange = _this.handleXAxisChange.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleXColorMapChange = _this.handleXColorMapChange.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleColorAxisChange = _this.handleColorAxisChange.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleYAxisChange = _this.handleYAxisChange.bind((0, _assertThisInitialized2["default"])(_this));
      ...
      _this.handleCumulativeChange = _this.handleCumulativeChange.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleTrendlineChange = _this.handleTrendlineChange.bind((0, _assertThisInitialized2["default"])(_this));
    ...
    (0, _createClass2["default"])(LayeredChartLayerDesignerComponent, [{
      ...
      key: "handleTrendlineChange",
      value: function handleTrendlineChange(ev) {
        boundMethodCheck(this, LayeredChartLayerDesignerComponent);
        return this.updateLayer({
          trendline: ev.target.checked ? "linear" : void 0
        });
      }
    }, {
      ...
      value: function renderName() {
        ...
        placeholder = this.props.design.layers.length === 1 ? "Value" : "Series ".concat(this.props.index + 1);
        return R('input', {
          type: "text",
      ...
      value: function renderCumulative() {
        var axisBuilder, layer;
        layer = this.props.design.layers[this.props.index]; // Can only cumulative if non-polar and y axis determined and x axis supports cumulative
      ...
      key: "renderTrendline",
      value: function renderTrendline() {
        var axisBuilder, layer;
        layer = this.props.design.layers[this.props.index]; // Can only have trendline if non-polar and y + x axis determined and not cumulative and not stacked
        ...
        return R('div', {
          ...
          type: "checkbox",
          checked: layer.trendline === "linear",
          onChange: this.handleTrendlineChange
