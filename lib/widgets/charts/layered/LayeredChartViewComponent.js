var C3ChartComponent, ExprUtils, H, LayeredChartCompiler, LayeredChartViewComponent, PropTypes, R, React, ReactDOM, TextComponent, _, d3,
...
C3ChartComponent = (function(superClass) {
  ...
  C3ChartComponent.prototype.createChart = function(props) {
    var c3, chartOptions, compiler, el;
    if (this.chart) {
      this.chart.destroy();
    }
