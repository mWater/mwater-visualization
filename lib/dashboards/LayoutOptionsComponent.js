...
function LayoutOptionsComponent(props) {
    ...
    return react_1.default.createElement("div", { style: { display: "grid", gridTemplateRows: "auto 1fr", gridTemplateColumns: "auto 1fr", height: "100%" } },
        react_1.default.createElement("div", { style: { padding: 5, gridRow: "1 / 3" } },
            ...
            react_1.default.createElement(ThemeToggle, { theme: props.design.style, onChange: theme => { props.onDesignChange(Object.assign(Object.assign({}, props.design), { style: theme, layoutOptions: layoutOptions_1.getDefaultLayoutOptions(theme) })); } }),
            react_1.default.createElement("br", null),
            ...
            react_1.default.createElement(bootstrap_1.FormGroup, { label: "Collapse to Single Column" },
                react_1.default.createElement(WidthSelector, { value: layoutOptions.collapseColumnsWidth, onChange: collapseColumnsWidth => { setLayoutOptions(Object.assign(Object.assign({}, layoutOptions), { collapseColumnsWidth })); }, sign: "< " })),
            react_1.default.createElement(bootstrap_1.FormGroup, { label: "Hide Quickfilters" },
                react_1.default.createElement(WidthSelector, { value: layoutOptions.hideQuickfiltersWidth, onChange: hideQuickfiltersWidth => { setLayoutOptions(Object.assign(Object.assign({}, layoutOptions), { hideQuickfiltersWidth })); }, sign: "< " })),
            react_1.default.createElement(bootstrap_1.FormGroup, { label: "Minimum Width (before scrolling or scaling)" },
                react_1.default.createElement(WidthSelector, { value: layoutOptions.minimumWidth, onChange: minimumWidth => { setLayoutOptions(Object.assign(Object.assign({}, layoutOptions), { minimumWidth })); }, sign: "< " }),
                react_1.default.createElement(bootstrap_1.FormGroup, { label: "When Below Minimum Width" },
                    react_1.default.createElement(bootstrap_1.Toggle, { value: layoutOptions.belowMinimumWidth, onChange: belowMinimumWidth => { setLayoutOptions(Object.assign(Object.assign({}, layoutOptions), { belowMinimumWidth: belowMinimumWidth })); }, options: [
                            { value: "scroll", label: "Scroll" },
                            { value: "scale", label: "Scale" },
                        ] }))),
            react_1.default.createElement(bootstrap_1.FormGroup, { label: "Maximum Width (before padding)" },
                react_1.default.createElement(WidthSelector, { value: layoutOptions.maximumWidth, onChange: maximumWidth => { setLayoutOptions(Object.assign(Object.assign({}, layoutOptions), { maximumWidth })); }, sign: "> " }))),
