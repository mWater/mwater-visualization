var ExprInsertModalComponent, ExprItemsHtmlConverter, ExprUpdateModalComponent, PropTypes, R, React, RichTextComponent, TextComponent, _,
...
module.exports = TextComponent = (function(superClass) {
  ...
  TextComponent.prototype.handleItemClick = function(item) {
    return this.exprUpdateModal.open(item, (function(_this) {
  ...
  TextComponent.prototype.renderModals = function() {
    return [
      R(ExprInsertModalComponent, {
        ...
        ref: ((function(_this) {
          return function(c) {
            return _this.exprInsertModal = c;
          };
        })(this)),
        ...
        ref: ((function(_this) {
          return function(c) {
            return _this.exprUpdateModal = c;
          };
        })(this)),
        schema: this.props.schema,
        dataSource: this.props.dataSource,
