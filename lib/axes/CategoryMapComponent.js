var AxisBuilder, CategoryMapComponent, ColorComponent, ExprCompiler, ExprUtils, H, PropTypes, R, React, ReorderableListComponent, _, update,
...
module.exports = CategoryMapComponent = (function(superClass) {
  ...
  CategoryMapComponent.prototype.renderCategory = function(category, index, connectDragSource, connectDragPreview, connectDropTarget) {
    ...
    elem = H.div({
      key: category.value
    }, connectDragSource ? connectDragSource(H.i({
