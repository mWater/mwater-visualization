var AxisComponent, ColorComponent, EditableLinkComponent, ExpressionBuilder, H, LayerDesignerComponent, LayeredChartDesignerComponent, LayeredChartUtils, LogicalExprComponent, React,
...
module.exports = LayeredChartDesignerComponent = (function(superClass) {
  ...
  LayeredChartDesignerComponent.prototype.renderStackedProportional = function() {
    var design, ref;
    design = this.props.design;
    if ((ref = design.type) === 'pie' || ref === 'donut') {
      return;
    }
  ...
  LayeredChartDesignerComponent.prototype.render = function() {
    return H.div(null, this.renderType(), this.renderTranspose(), this.renderStackedProportional(), this.renderLayers(), H.br(), H.hr(), this.renderLabels());
  };
...
LayerDesignerComponent = (function(superClass) {
  ...
  LayerDesignerComponent.prototype.renderTable = function() {
    ...
    }), " ", "Data Source"), ": ", this.props.schema.createTableSelectElement(layer.table, this.handleTableChange));
  };
  ...
  LayerDesignerComponent.prototype.renderCumulative = function() {
    var layer;
    layer = this.props.design.layers[this.props.index];
    if (!this.isXAxisRequired(layer) || !layer.axes.y) {
      return;
    }
    return H.div({
      key: "cumulative"
  ...
  LayerDesignerComponent.prototype.render = function() {
    return H.div(null, this.renderRemove(), this.renderTable(), this.renderXAxis(), this.renderYAxis(), this.renderColorAxis(), this.renderColor(), this.renderFilter(), this.renderName());
  };
