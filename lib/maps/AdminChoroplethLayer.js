var AdminChoroplethLayer, AxisBuilder, ExprCleaner, ExprCompiler, ExprUtils, H, Layer, React, injectTableAlias,
...
module.exports = AdminChoroplethLayer = (function(superClass) {
  ...
  AdminChoroplethLayer.prototype.getLegend = function(design, schema) {
    return null;
  };
  ...
  AdminChoroplethLayer.prototype.cleanDesign = function(design, schema) {
    ...
    design.color = sublayer.color || "#000000";
