...
function DateEditComponent(props) {
    ...
    // Format date
    const [valueStr, setValueStr] = react_1.useState(props.datetime ?
        (props.value ? moment_1.default(props.value, moment_1.default.ISO_8601).format("YYYY-MM-DD HH:mm") : "")
        : props.value || "");
    ...
    function parseDate(value) {
        ...
        const m = moment_1.default(value, props.datetime ? "YYYY-MM-DD HH:mm" : "YYYY-MM-DD");
        if (!m.isValid()) {
            setIsValid(false);
            return null;
        }
