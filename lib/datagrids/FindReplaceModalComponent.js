...
module.exports = FindReplaceModalComponent = (function(superClass) {
  ...
  FindReplaceModalComponent.prototype.renderContents = function() {
    ...
    return H.div(null, H.div({
    ...
    }, H.label(null, "Replace: "), H.select({
      value: this.state.replaceColumn || "",
      onChange: ((function(_this) {
        return function(ev) {
          return _this.setState({
            replaceColumn: ev.target.value
          });
        };
      })(this)),
      ...
      key: "_none",
      value: ""
    }, "Select..."), _.map(replaceColumnOptions, (function(_this) {
    ...
    })(this)))), this.state.replaceColumn ? (replaceExpr = _.findWhere(this.props.design.columns, {
      id: this.state.replaceColumn
    }).expr, H.div({
      key: "with",
      className: "form-group"
    }, H.label(null, "With: "), R(ExprComponent, {
      ...
      preferLiteral: true,
      placeholder: "Blank"
    }))) : void 0, this.state.replaceColumn ? H.div({
      key: "condition",
      className: "form-group"
    }, H.label(null, "In rows that: "), R(ExprComponent, {
      schema: this.props.schema,
      dataSource: this.props.dataSource,
      table: this.props.design.table,
      ...
      key: "preview"
    }, H.h4(null, "Preview"), this.renderPreview()) : void 0);
  };
