...
var SwitchableTileUrlLayer = /** @class */ (function (_super) {
    ...
    SwitchableTileUrlLayer.prototype.getMinZoom = function (design) {
        return design.minZoom || null;
    };
    SwitchableTileUrlLayer.prototype.getMaxZoom = function (design) {
    ...
    SwitchableTileUrlLayer.prototype.getLegend = function (design, schema, name, dataSource, locale, filters) {
        // Find active option
        var option = design.options.find(function (d) { return d.id === design.activeOption; });
