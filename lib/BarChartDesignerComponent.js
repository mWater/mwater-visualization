var AestheticComponent, BarChart, BarChartDesignerComponent, EditableLinkComponent, ExpressionBuilder, H, LogicalExprComponent, React, ReactSelect, ScalarExprComponent,
...
module.exports = BarChartDesignerComponent = (function(superClass) {
  ...
  BarChartDesignerComponent.prototype.renderTable = function() {
    ...
    }, H.label(null, "Table"), H.div(null, React.createElement(EditableLinkComponent, {
  ...
  BarChartDesignerComponent.prototype.render = function() {
    return H.div(null, this.renderTable(), this.props.design.table ? [this.renderXAesthetic(), this.renderYAesthetic(), this.renderFilter()] : void 0);
  };
