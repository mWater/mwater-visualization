    ...
    renderOptions() {
        ...
        return [
            ...
            ["pie", "donut"].includes(design.type)
                ? [
                    react_1.default.createElement(bootstrap_1.Checkbox, { key: "polarOrder", value: design.hidePercentage, onChange: this.handlePercentageVisibilityChange }, "Hide Percentage"),
                    react_1.default.createElement(bootstrap_1.Checkbox, { key: "polarOrder", value: (design.polarOrder || "desc") === "desc", onChange: this.handlePolarOrderChange }, "Descending Order")
                ]
                : undefined
        ];
    }
