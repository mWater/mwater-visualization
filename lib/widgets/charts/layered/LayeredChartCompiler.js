...
var AxisBuilder, ExprCompiler, ExprUtils, LayeredChartCompiler, _, cleanString, commaFormatter, d3Format, d3Formatter, injectTableAlias, labelValueFormatter, pieLabelValueFormatter;
...
function () {
  ...
  (0, _createClass2["default"])(LayeredChartCompiler, [{
    ...
    value: function createChartOptions(options) {
      ...
      var c3Data, chartDesign, format, tickFormatter;
      ...
      if (options.design.labels && !_.isEmpty(c3Data.format)) {
        format = _.map(options.design.layers, function (layer, layerIndex) {
          if (c3Data.format[layerIndex]) {
            return c3Data.format[layerIndex];
          } else {
            return true;
          }
        });
