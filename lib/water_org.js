...
TabbedDashboard = function () {
  var TabbedDashboard = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(TabbedDashboard, _React$Component);

    var _super = _createSuper(TabbedDashboard);
    ...
    function TabbedDashboard() {
      ...
      _this.handleAddTab = _this.handleAddTab.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleRemoveTab = _this.handleRemoveTab.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleRenameTab = _this.handleRenameTab.bind((0, _assertThisInitialized2["default"])(_this));
      _this.createTab = _this.createTab.bind((0, _assertThisInitialized2["default"])(_this));
      return _this;
    }
