...
module.exports = PivotChartViewComponent = function () {
  ...
  function (_React$Component) {
    ...
    function PivotChartViewComponent(props) {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(PivotChartViewComponent).call(this, props));
      _this.handleHeaderChange = _this.handleHeaderChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleFooterChange = _this.handleFooterChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleEditSection = _this.handleEditSection.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleSaveEditSegment = _this.handleSaveEditSegment.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleCancelEditSegment = _this.handleCancelEditSegment.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleSaveEditIntersection = _this.handleSaveEditIntersection.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleCancelEditIntersection = _this.handleCancelEditIntersection.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleRemoveSegment = _this.handleRemoveSegment.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleInsertBeforeSegment = _this.handleInsertBeforeSegment.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleInsertAfterSegment = _this.handleInsertAfterSegment.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleAddChildSegment = _this.handleAddChildSegment.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleSummarizeSegment = _this.handleSummarizeSegment.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.state = {
        editSegment: null,
