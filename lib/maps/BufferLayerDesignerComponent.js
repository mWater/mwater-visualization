var AxisComponent, BufferLayerDesignerComponent, ColorComponent, ExprUtils, FilterExprComponent, H, NumberInputComponent, Rcslider, React, TableSelectComponent, _,
...
module.exports = BufferLayerDesignerComponent = (function(superClass) {
  ...
  BufferLayerDesignerComponent.prototype.render = function() {
    return H.div(null, this.renderTable(), this.renderGeometryAxis(), this.renderRadius(), this.renderColor(), this.renderColorAxis(), this.renderFillOpacity(), this.renderFilter());
  };
