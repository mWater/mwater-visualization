var AxisComponent, ColorComponent, EditableLinkComponent, ExpressionBuilder, H, LogicalExprComponent, MarkersLayerDesignerComponent, MarkersLayerSublayerDesignerComponent, React,
...
MarkersLayerSublayerDesignerComponent = (function(superClass) {
  ...
  MarkersLayerSublayerDesignerComponent.prototype.renderTable = function() {
    return H.div({
      ...
      onRemove: this.props.sublayer.table ? this.handleTableChange.bind(this, null) : void 0
    }, this.props.sublayer.table ? this.props.schema.getTable(this.props.sublayer.table).name : H.i(null, "Select...")));
  };
  ...
  MarkersLayerSublayerDesignerComponent.prototype.render = function() {
    return H.div(null, this.renderRemove(), this.renderTable(), this.renderGeometryAxis(), this.renderColor(), this.renderFilter());
  };
