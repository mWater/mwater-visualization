...
ClipboardPaletteItemComponent = (function(superClass) {
  ...
  ClipboardPaletteItemComponent.prototype.render = function() {
    ...
    elem = this.props.connectDropTarget(R('div', {
      ...
      className: "subtitle",
      key: "subtitle"
    }, this.props.isOver ? "Copy" : "Clipboard"), !this.props.clipboard ? R('div', {
      className: "tooltiptext"
    }, "Clipboard is empty. Drop a widget onto it to copy.") : void 0, this.props.cantPasteMessage ? R('div', {
      className: "tooltiptext"
    }, this.props.cantPasteMessage) : void 0, this.props.clipboard ? R('div', {
