var AxisComponent, ColorComponent, ExprUtils, FilterExprComponent, H, MarkersLayerDesignerComponent, MarkersLayerSublayerDesignerComponent, React, ReactSelect, TableSelectComponent, _,
...
module.exports = MarkersLayerDesignerComponent = (function(superClass) {
  ...
  MarkersLayerDesignerComponent.prototype.renderSublayers = function() {
    ...
    })(this)), _.last(this.props.design.sublayers) && _.last(this.props.design.sublayers).table ? H.button({
  ...
  MarkersLayerDesignerComponent.prototype.render = function() {
    return H.div(null, this.renderSublayers());
  };
...
MarkersLayerSublayerDesignerComponent = (function(superClass) {
  ...
  MarkersLayerSublayerDesignerComponent.prototype.handleColorAxisChange = function(axis) {
    return this.updateAxes({
      color: axis
    });
  };
  ...
  MarkersLayerSublayerDesignerComponent.prototype.handleNameChange = function(e) {
    return this.update({
      name: e.target.value
    });
  };
  ...
  MarkersLayerSublayerDesignerComponent.prototype.renderColorAxis = function() {
    var title;
    if (!this.props.sublayer.axes.geometry) {
      return;
    }
    title = H.span(null, H.span({
    ...
    return H.div({
      ...
      aggrNeed: "none",
      value: this.props.sublayer.axes.color,
      showColorMap: true,
  ...
  MarkersLayerSublayerDesignerComponent.prototype.renderColor = function() {
    ...
    return H.div({
      ...
      className: "glyphicon glyphicon glyphicon-tint"
    }), this.props.sublayer.axes.color ? " Default Color" : " Color"), H.div({
      style: {
        marginLeft: 8
      }
  ...
  MarkersLayerSublayerDesignerComponent.prototype.renderName = function() {
    return H.div({
      className: "form-group"
    }, H.label({
      className: "text-muted"
  ...
  MarkersLayerSublayerDesignerComponent.prototype.render = function() {
    return H.div(null, this.renderRemove(), this.renderName(), this.renderTable(), this.renderGeometryAxis(), this.renderColor(), this.renderColorAxis(), this.renderSymbol(), this.renderFilter());
  };
