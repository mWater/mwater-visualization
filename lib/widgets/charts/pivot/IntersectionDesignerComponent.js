...
class IntersectionDesignerComponent extends react_1.default.Component {
    ...
    renderValueAxis() {
        return R(bootstrap_1.default.FormGroup, {
            labelMuted: true,
            label: "Calculation",
    ...
    renderNullValue() {
        if (this.props.intersection.valueAxis) {
            ...
            }, R(bootstrap_1.default.TextInput, {
    ...
    renderFilter() {
        return R(bootstrap_1.default.FormGroup, {
            labelMuted: true,
            label: [R(bootstrap_1.default.Icon, { id: "glyphicon-filter" }), " Filters"]
    ...
    renderStyling() {
        return R(bootstrap_1.default.FormGroup, {
            ...
            key: "styling",
            label: "Styling"
        }, R(bootstrap_1.default.Checkbox, { key: "bold", inline: true, value: this.props.intersection.bold, onChange: this.update("bold") }, "Bold"), R(bootstrap_1.default.Checkbox, { key: "italic", inline: true, value: this.props.intersection.italic, onChange: this.update("italic") }, "Italic"));
    }
...
class BackgroundColorConditionsComponent extends react_1.default.Component {
    ...
    render() {
        ...
        }), R(bootstrap_1.default.Button, { type: "link", size: "sm", onClick: this.handleAdd }, R(bootstrap_1.default.Icon, { id: "fa-plus" }), " Add Condition"));
    }
}
...
class BackgroundColorConditionComponent extends react_1.default.Component {
    ...
    render() {
        return R("div", { className: "panel panel-default" }, R("div", { className: "panel-body" }, R(bootstrap_1.default.FormGroup, {
            labelMuted: true,
            label: "Condition"
