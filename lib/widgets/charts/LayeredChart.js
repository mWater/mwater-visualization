var AxisBuilder, Chart, ExprCleaner, H, LayeredChart, LayeredChartCompiler, LayeredChartSvgFileSaver, LayeredChartUtils, LayeredChartViewComponent, React, _, async,
...
module.exports = LayeredChart = (function(superClass) {
      ...
      return function() {
        ...
        return widgetDataSource.getData(design, filters, function(err, data) {
          if (err) {
            ...
            return LayeredChartSvgFileSaver.save(design, data, schema);
          }
        });
      };
    })(this);
  ...
  LayeredChart.prototype.createDataTable = function(design, schema, data, locale) {
