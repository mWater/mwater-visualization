...
module.exports = ServerDashboardDataSource = (function() {
  ...
  ServerDashboardDataSource.prototype.getWidgetDataSource = function(widgetId) {
    return new ServerWidgetDataSource(_.extend({}, options, {
      widgetId: widgetId
    }));
  };
...
ServerWidgetDataSource = (function() {
  ...
  ServerWidgetDataSource.prototype.getMapDataSource = function() {
...
ServerWidgetMapDataSource = (function() {
  ...
  ServerWidgetMapDataSource.prototype.getLayerDataSource = function(layerId) {
    return new ServerWidgetLayerDataSource(_.extend({}, options, {
      layerId: layerId
    }));
  };
...
ServerWidgetLayerDataSource = (function() {
  ...
  ServerWidgetLayerDataSource.prototype.getPopupWidgetDataSource = function(widgetId) {
    return new ServerWidgetLayerPopupWidgetDataSource(_.extend({}, options, {
      popupWidgetId: widgetId
    }));
  };

  ServerWidgetLayerDataSource.prototype.getTileUrl = function(layerId, filters) {
    return this.createUrl(layerId, filters, "png");
  };

  ServerWidgetLayerDataSource.prototype.getUtfGridUrl = function(layerId, filters) {
