...
class ImageUploaderComponent extends react_1.default.Component {
    ...
    renderUploader() {
        return react_1.default.createElement("div", null,
            react_1.default.createElement(react_dropzone_1.default, { multiple: false, onDrop: this.onFileDrop, noDragEventsBubbling: true }, ({ getRootProps, getInputProps, isDragActive }) => (react_1.default.createElement("div", Object.assign({}, getRootProps({ className: "dropzone" })),
