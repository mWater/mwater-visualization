...
exports.RadioToggleComponent = exports.ToggleEditComponent = exports.SwitchViewComponent = exports.OptionComponent = exports.OptionListComponent = exports.SectionComponent = void 0;
...
class RadioToggleComponent extends react_1.default.Component {
    render() {
        return R("div", null, lodash_1.default.map(this.props.options, (option, i) => {
            return R(bootstrap_1.Radio, {
