    ...
    (0, react_1.useEffect)(() => {
        ...
        if (items.length > 0) {
            ...
            props.dataSource.performQuery(query, (error, data) => {
                var _a;
                setValue((_a = data === null || data === void 0 ? void 0 : data[0]) !== null && _a !== void 0 ? _a : {});
            });
        }
    }, []);
    return (react_1.default.createElement("div", { className: "_mviz-map-hover-content" }, (_a = props.design.hoverOver) === null || _a === void 0 ? void 0 : _a.items.map((item) => {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("span", null,
                item.label,
                ":"),
            react_1.default.createElement("span", { className: "text-muted" }, value[item.id] === null ? "n/a" : (_a = value[item.id]) !== null && _a !== void 0 ? _a : "■■■■")));
    })));
};
