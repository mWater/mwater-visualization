...
class ChoroplethLayer extends Layer_1.default {
    ...
    createIndirectVectorTile(design, sourceId, schema, filters, opacity) {
        ...
        */
        ...
        const color = mapboxUtils_1.compileColorMapToMapbox(design.axes.color, design.color || "transparent");
        // Create layers
        const mapLayers = [];
        mapLayers.push({
            id: `${sourceId}:polygon-fill`,
        ...
        mapLayers.push({
            ...
            paint: {
                // Because of https://github.com/mapbox/mapbox-gl-js/issues/4090, line opacities < 1 create artifacts
                "line-color": mapboxUtils_1.compileColorToMapbox(design.borderColor || "#000", (_a = design.axes.color) === null || _a === void 0 ? void 0 : _a.excludedValues),
                "line-opacity": opacity,
                "line-width": 1,
                "line-blur": 1.5
            }
        ...
        if (design.displayNames) {
            mapLayers.push({
                ...
                paint: {
                    "text-color": mapboxUtils_1.compileColorToMapbox("black", (_b = design.axes.color) === null || _b === void 0 ? void 0 : _b.excludedValues),
                    "text-halo-color": mapboxUtils_1.compileColorToMapbox("rgba(255, 255, 255, 0.5)", (_c = design.axes.color) === null || _c === void 0 ? void 0 : _c.excludedValues),
                    "text-halo-width": 2,
                    "text-opacity": opacity
                }
            });
...
`;
    ...
    cleanDesign(design, schema) {
        ...
        const axisBuilder = new AxisBuilder_1.default({ schema });
        design = immer_1.produce(design, (draft) => {
            ...
            if (draft.regionMode === "indirect" && design.table) {
                draft.axes.color = axisBuilder.cleanAxis({
                    axis: draft.axes.color ? immer_1.original(draft.axes.color) || null : null,
                    table: design.table,
                    types: ["enum", "text", "boolean", "date"],
                    aggrNeed: "required"
                });
                draft.axes.label = axisBuilder.cleanAxis({
                    axis: draft.axes.label ? immer_1.original(draft.axes.label) || null : null,
                    table: design.table,
                    types: ["text", "number"],
                    aggrNeed: "required"
                });
    ...
    acceptKmlVisitorForRow(visitor, row) {
        ...
        const list = lodash_1.default.map(outer, (coordinates) => coordinates.join(","));
