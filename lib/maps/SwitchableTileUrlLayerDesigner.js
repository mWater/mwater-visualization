...
var SwitchableTileUrlLayerDesigner = /** @class */ (function (_super) {
    ...
    function SwitchableTileUrlLayerDesigner() {
        ...
        _this.handleChange = function (activeOption) {
            _this.props.onDesignChange(__assign({}, _this.props.design, { activeOption: activeOption }));
        };
        return _this;
    }
    ...
    SwitchableTileUrlLayerDesigner.prototype.render = function () {
        var _this = this;
        return react_1.default.createElement("div", null, this.props.design.options.map(function (opt) {
