var ActionCancelModalComponent, ChartWidget, ChartWidgetComponent, ChartWidgetViewComponent, CsvBuilder, H, ModalWindowComponent, React, SimpleWidgetComponent, Widget, filesaver,
...
ChartWidgetComponent = (function(superClass) {
  ...
  ChartWidgetComponent.prototype.renderChart = function(width, height) {
    return React.createElement(ChartWidgetViewComponent, {
  ...
  ChartWidgetComponent.prototype.renderEditor = function() {
    var chart, content, editor;
    editor = this.props.chart.createDesignerElement({
      design: this.props.design,
      onDesignChange: this.props.onDesignChange
    });
    chart = this.renderChart(this.props.width, this.props.height);
    content = H.div({
      style: {
        height: "100%",
        width: "100%"
      ...
      style: {
        width: "100%",
        height: "100%",
        paddingLeft: this.props.width + 40
      }
    }, H.div({
      style: {
        width: "100%",
