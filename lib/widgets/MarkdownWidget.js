var DropdownWidgetComponent, MarkdownWidget, MarkdownWidgetComponent, MarkdownWidgetDesignerComponent, MarkdownWidgetViewComponent, ModalWindowComponent, PropTypes, R, React, Widget, _, markdown,
...
MarkdownWidgetComponent = (function(superClass) {
  ...
  function MarkdownWidgetComponent(props) {
    ...
    MarkdownWidgetComponent.__super__.constructor.call(this, props);
    this.state = {
      editDesign: null
    };
  }
