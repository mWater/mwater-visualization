var AxisBuilder, AxisColorEditorComponent, ColorMapComponent, ColorMapOrderEditorComponent, ColorPaletteCollectionComponent, ColorPaletteComponent, H, R, React, _, c_c, update,
...
module.exports = AxisColorEditorComponent = (function(superClass) {
  ...
  AxisColorEditorComponent.prototype.render = function() {
    ...
    ] : void 0, this.state.mode === "normal" ? H.div(null, this.props.axis.colorMap ? H.div({
    ...
    }, "Customize color scheme"))) : void 0, H.p(null, H.a({
      style: {
        cursor: "pointer"
      },
      onClick: this.handleSelectPalette,
      key: "select-palette"
    }, "Select color scheme")), drawOrder && this.props.colorMapReorderable ? R(ColorMapOrderEditorComponent, {
