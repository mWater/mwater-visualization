...
module.exports = HoverComponent = (function(superClass) {
  ...
  HoverComponent.prototype.componentDidMount = function() {
    React.findDOMNode(this.refs.main).addEventListener("mouseover", this.onOver);
    return React.findDOMNode(this.refs.main).addEventListener("mouseout", this.onOut);
  };

  HoverComponent.prototype.componentWillUnmount = function() {
    React.findDOMNode(this.refs.main).removeEventListener("mouseover", this.onOver);
    return React.findDOMNode(this.refs.main).removeEventListener("mouseout", this.onOut);
  };
