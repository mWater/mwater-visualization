...
module.exports = SchemaBuilder = (function() {
  ...
  SchemaBuilder.prototype.addForm = function(form) {
    ...
    structure = [];
    return this.addFormItem(form, form.design, structure);
  };

  SchemaBuilder.prototype.addFormItem = function(form, item, structure) {
    var answerType, choice, column, i, j, len, len1, ref, ref1, results, results1, subitem;
    if (item.contents) {
      ref = item.contents;
      results = [];
      ...
      switch (answerType) {
        case "text":
          ...
          return this.schema.addColumn("form:" + form._id, column);
        case "number":
          if (item.decimal) {
            column = {
              id: "data:" + item._id + ":value",
        ...
        case "choices":
          ...
          for (j = 0, len1 = ref1.length; j < len1; j++) {
            ...
            results1.push(this.schema.addColumn("form:" + form._id, column));
          }
          return results1;
          break;
        case "date":
