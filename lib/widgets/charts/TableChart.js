var AxisBuilder, Chart, ExprCleaner, ExprCompiler, ExprUtils, H, React, TableChart, TableChartViewComponent, _, injectTableAlias,
...
module.exports = TableChart = (function(superClass) {
  ...
  TableChart.prototype.cleanDesign = function(design, schema) {
    var axisBuilder, column, columnId, exprCleaner, j, k, len, ordering, ref, ref1;
  ...
  TableChart.prototype.getData = function(design, schema, dataSource, filters, callback) {
    var axisBuilder, colNum, column, expr, exprCompiler, exprUtils, i, j, k, len, ordering, query, ref, ref1, whereClauses;
  ...
  TableChart.prototype.createDataTable = function(design, schema, data, locale) {
    var axisBuilder, header, renderHeaderCell, renderRow, table;
    axisBuilder = new AxisBuilder({
      schema: schema
    });
    renderHeaderCell = (function(_this) {
      return function(column) {
        return column.headerText || axisBuilder.summarizeAxis(column.textAxis, locale);
      };
    })(this);
