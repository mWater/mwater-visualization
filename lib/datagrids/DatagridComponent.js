var ActionCancelModalComponent, AutoSizeComponent, DatagridComponent, DatagridDesignerComponent, DatagridEditorComponent, DatagridUtils, DatagridViewComponent, ExprCleaner, ExprCompiler, ExprUtils, FindReplaceModalComponent, PropTypes, QuickfilterCompiler, QuickfiltersComponent, R, React, _,
...
module.exports = DatagridComponent = (function(superClass) {
  ...
  DatagridComponent.prototype.renderFindReplace = function() {
    ...
    return R('a', {
      ...
      onClick: ((function(_this) {
        return function() {
          return _this.findReplaceModal.show();
        };
      })(this))
    }, "Find/Replace");
  };
  ...
  DatagridComponent.prototype.renderFindReplaceModal = function(filters) {
    return R(FindReplaceModalComponent, {
      ref: (function(_this) {
        return function(c) {
          return _this.findReplaceModal = c;
        };
      })(this),
      schema: this.props.schema,
      dataSource: this.props.dataSource,
