...
module.exports = PopoverComponent = (function(superClass) {
  ...
  PopoverComponent.prototype.componentDidUpdate = function(prevProps) {
    if (!_.isEqual(prevProps.content, this.props.content)) {
  ...
  PopoverComponent.prototype.updatePopover = function(props, oldProps) {
    ...
    if (props && props.visible) {
      ...
      return React.render(this.props.content, div, (function(_this) {
        return function() {
          $(React.findDOMNode(_this)).popover({
            content: function() {
              return $(div);
            },
            html: true,
          ...
          return $(React.findDOMNode(_this)).popover("show");
        };
      })(this));
    }
  };
