...
var DatagridUtils, ExprCleaner, ExprUtils, _, original, produce, update;
...
module.exports = DatagridUtils = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(DatagridUtils, [{
    ...
    value: function cleanDesign(design) {
      ...
      design = produce(design, function (draft) {
        var column, i, len, ref, subtable, table;
        ref = draft.columns;
        ...
        for (i = 0, len = ref.length; i < len; i++) {
          ...
          if (column.type === "expr") {
            ...
            if (column.subtable) {
              ...
              table = new ExprUtils(_this.schema).followJoins(design.table, subtable.joins);
            } else {
              table = design.table;
            }

            column.expr = exprCleaner.cleanExpr(column.expr ? original(column.expr) : null, {
              table: table,
