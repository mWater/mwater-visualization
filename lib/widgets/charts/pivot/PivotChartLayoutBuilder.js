...
class PivotChartLayoutBuilder {
    ...
    buildLayout(design, data, locale) {
        ...
        for (let depth = 0; depth < columnsDepth; depth++) {
            ...
            const hasValueAxisLabel = columns.some(column => { var _a, _b; return ((_a = column[depth]) === null || _a === void 0 ? void 0 : _a.segment.label) && ((_b = column[depth]) === null || _b === void 0 ? void 0 : _b.segment.valueAxis); });
            if (hasValueAxisLabel) {
                ...
                for (const column of columns) {
                    cells.push({
                        ...
                        unconfigured: !((_e = (_d = column[depth]) === null || _d === void 0 ? void 0 : _d.segment) === null || _e === void 0 ? void 0 : _e.label) && !((_g = (_f = column[depth]) === null || _f === void 0 ? void 0 : _f.segment) === null || _g === void 0 ? void 0 : _g.valueAxis),
                        bold: ((_h = column[depth]) === null || _h === void 0 ? void 0 : _h.segment.bold) || ((_j = column[depth]) === null || _j === void 0 ? void 0 : _j.segment.valueLabelBold),
                        italic: (_k = column[depth]) === null || _k === void 0 ? void 0 : _k.segment.italic
                    });
                }
            ...
            for (const column of columns) {
                cells.push({
                    type: "column",
                    subtype: ((_m = (_l = column[depth]) === null || _l === void 0 ? void 0 : _l.segment) === null || _m === void 0 ? void 0 : _m.valueAxis) ? "value" : "label",
                    segment: (_o = column[depth]) === null || _o === void 0 ? void 0 : _o.segment,
                    section: (_p = column[depth]) === null || _p === void 0 ? void 0 : _p.segment.id,
                    text: (_q = column[depth]) === null || _q === void 0 ? void 0 : _q.label,
                    align: "center",
                    // Unconfigured if segment has no label or value
                    unconfigured: !((_s = (_r = column[depth]) === null || _r === void 0 ? void 0 : _r.segment) === null || _s === void 0 ? void 0 : _s.label) && !((_u = (_t = column[depth]) === null || _t === void 0 ? void 0 : _t.segment) === null || _u === void 0 ? void 0 : _u.valueAxis),
                    bold: (_v = column[depth]) === null || _v === void 0 ? void 0 : _v.segment.bold,
                    italic: (_w = column[depth]) === null || _w === void 0 ? void 0 : _w.segment.italic
                });
            }
            layout.rows.push({ cells });
        }
        ...
        for (let row of rows) {
                ...
                for (let depth = 0; depth < rowsDepth; depth++) {
                    if (needsSpecialRowHeader[depth]) {
                        cells.push({
                            type: "row",
                            subtype: "valueLabel",
                            segment: (_x = row[depth]) === null || _x === void 0 ? void 0 : _x.segment,
                            section: (_y = row[depth]) === null || _y === void 0 ? void 0 : _y.segment.id,
                            text: row[depth].segment.label,
                            bold: ((_z = row[depth]) === null || _z === void 0 ? void 0 : _z.segment.bold) || ((_0 = row[depth]) === null || _0 === void 0 ? void 0 : _0.segment.valueLabelBold),
                            italic: (_1 = row[depth]) === null || _1 === void 0 ? void 0 : _1.segment.italic
                        });
                    }
                    else {
                        cells.push({
                            type: "row",
                            subtype: "label",
                            segment: (_2 = row[depth]) === null || _2 === void 0 ? void 0 : _2.segment,
                            section: (_3 = row[depth]) === null || _3 === void 0 ? void 0 : _3.segment.id,
                            text: null,
                            // Unconfigured if segment has no label or value
                            unconfigured: ((_4 = row[depth]) === null || _4 === void 0 ? void 0 : _4.segment) && ((_5 = row[depth]) === null || _5 === void 0 ? void 0 : _5.segment.label) == null && !((_6 = row[depth]) === null || _6 === void 0 ? void 0 : _6.segment.valueAxis),
                            bold: (_7 = row[depth]) === null || _7 === void 0 ? void 0 : _7.segment.bold,
                            italic: (_8 = row[depth]) === null || _8 === void 0 ? void 0 : _8.segment.italic
                        });
                    }
                }
            ...
            for (let depth = 0; depth < rowsDepth; depth++) {
                cells.push({
                    type: "row",
                    subtype: ((_10 = (_9 = row[depth]) === null || _9 === void 0 ? void 0 : _9.segment) === null || _10 === void 0 ? void 0 : _10.valueAxis) ? "value" : "label",
                    segment: (_11 = row[depth]) === null || _11 === void 0 ? void 0 : _11.segment,
                    section: (_12 = row[depth]) === null || _12 === void 0 ? void 0 : _12.segment.id,
                    text: (_13 = row[depth]) === null || _13 === void 0 ? void 0 : _13.label,
                    // Unconfigured if segment has no label or value
                    unconfigured: ((_14 = row[depth]) === null || _14 === void 0 ? void 0 : _14.segment) && ((_15 = row[depth]) === null || _15 === void 0 ? void 0 : _15.segment.label) == null && !((_16 = row[depth]) === null || _16 === void 0 ? void 0 : _16.segment.valueAxis),
                    bold: (_17 = row[depth]) === null || _17 === void 0 ? void 0 : _17.segment.bold,
                    italic: (_18 = row[depth]) === null || _18 === void 0 ? void 0 : _18.segment.italic,
                    // Indent if has value and label
                    indent: ((_20 = (_19 = row[depth]) === null || _19 === void 0 ? void 0 : _19.segment) === null || _20 === void 0 ? void 0 : _20.valueAxis) && ((_22 = (_21 = row[depth]) === null || _21 === void 0 ? void 0 : _21.segment) === null || _22 === void 0 ? void 0 : _22.label) ? 1 : undefined
                });
            }
            // Emit contents
            for (column of columns) {
    ...
    getRowsOrColumns(isRow, segment, data, locale, parentSegments = [], parentValues = []) {
        ...
        if (!segment.valueAxis) {
            ...
            categories = lodash_1.default.map(this.axisBuilder.getCategories(segment.valueAxis, allValues, { locale, onlyValuesPresent: segment.valueAxisOnlyValuesPresent }), (category) => {
