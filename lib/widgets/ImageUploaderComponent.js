...
class ImageUploaderComponent extends react_1.default.Component {
    ...
    renderUploader() {
        return R("div", null, R(react_dropzone_1.default, {
            ...
            : R("div", null, "Drop file here or click to select file")), this.state.uid ? R("a", { onClick: () => this.setState({ editing: false }) }, "Cancel") : undefined);
    }
    renderPreview() {
        ...
        return R("div", null, R("img", { style: thumbnailStyle, src: this.props.dataSource.getImageUrl(this.state.uid) }), R("a", { className: "btn btn-default", onClick: this.handleChangeImage }, "Change"));
    }
    render() {
