...
module.exports = PivotChartLayoutBuilder = (function() {
  ...
  PivotChartLayoutBuilder.prototype.getRowsOrColumns = function(isRow, segment, data, locale, parentSegments, parentValues) {
    var allValues, categories, category, childResult, childResults, childSegment, index, intersectionData, intersectionId, j, l, len, len1, len2, len3, m, n, orderIndex, ref, ref1, relevantData, results, segIds, value;
    ...
    if (!segment.valueAxis) {
      ...
      if (segment.orderExpr) {
        ...
        categories = _.sortBy(categories, (function(_this) {
