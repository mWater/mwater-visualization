var ExprCompiler, ExprUtils, H, LayerFactory, LeafletMapComponent, LegendComponent, MapViewComponent, ModalPopupComponent, PropTypes, R, React, _,
...
module.exports = MapViewComponent = (function(superClass) {
  ...
  MapViewComponent.prototype.renderLegend = function() {
    console.log(this.getCompiledFilters());
