...
exports.default = ChartWidget = class ChartWidget extends Widget_1.default {
    constructor(chart) {
        super();
        this.chart = chart;
    }
...
class ChartWidgetComponent extends react_1.default.PureComponent {
    ...
    renderEditLink() {
        return R("div", { className: "mwater-visualization-widget-placeholder", onClick: this.handleStartEditing }, R(bootstrap_1.default.Icon, { id: this.props.chart.getPlaceholderIcon() }));
    }
    render() {
