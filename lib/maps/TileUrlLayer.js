...
module.exports = TileUrlLayer = /*#__PURE__*/function (_Layer) {
  (0, _inherits2["default"])(TileUrlLayer, _Layer);

  var _super = _createSuper(TileUrlLayer);
  ...
  (0, _createClass2["default"])(TileUrlLayer, [{
    ...
    value: // Gets the type of layer definition ("JsonQLCss"/"TileUrl")
    function getLayerDefinitionType() {
      return "TileUrl";
...
TileUrlLayerDesignerComponent = function () {
  var TileUrlLayerDesignerComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(TileUrlLayerDesignerComponent, _React$Component);

    var _super2 = _createSuper(TileUrlLayerDesignerComponent);
    ...
    function TileUrlLayerDesignerComponent() {
      ...
      _this.handleTileUrlChange = _this.handleTileUrlChange.bind((0, _assertThisInitialized2["default"])(_this));
      return _this;
    }
