...
module.exports = SettingsModalComponent = function () {
  var SettingsModalComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(SettingsModalComponent, _React$Component);

    var _super = _createSuper(SettingsModalComponent);
    ...
    function SettingsModalComponent(props) {
      ...
      _this.handleSave = _this.handleSave.bind((0, _assertThisInitialized2["default"])(_this));
