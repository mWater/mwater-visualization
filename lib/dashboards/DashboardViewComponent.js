...
module.exports = DashboardViewComponent = function () {
  var DashboardViewComponent = /*#__PURE__*/function (_React$Component) {
    ...
    (0, _createClass2["default"])(DashboardViewComponent, [{
      ...
      key: "compRef",
      value: function compRef(options) {
        var _this3 = this;
      ...
      value: function render() {
        ...
        if (clipboardContents && !_.all(clipboardContents.tables, function (table) {
          return _this4.props.schema.getTable(table);
        })) {
        ...
        renderWidget = function renderWidget(options) {
          ...
          filters = compiledFilters.concat(_this4.state.widgetScoper.getFilters(options.id)); // Extend the filters to include implicit filters (filter children in 1-n relationships)

          if (_this4.props.design.implicitFiltersEnabled || _this4.props.design.implicitFiltersEnabled == null) {
            // Default is true
            implicitFilterBuilder = new ImplicitFilterBuilder(_this4.props.schema);
          ...
          widgetElem = R(WidgetComponent, {
            ...
            id: options.id,
            type: options.type,
            schema: _this4.props.schema,
            dataSource: _this4.props.dataSource,
            dashboardDataSource: _this4.props.dashboardDataSource,
            design: options.design,
            scope: _this4.state.widgetScoper.getScope(options.id),
            filters: filters,
            onScopeChange: _this4.handleScopeChange.bind(null, options.id),
            onDesignChange: options.onDesignChange,
            width: options.width,
            height: options.height,
            onRowClick: _this4.props.onRowClick,
            namedStrings: _this4.props.namedStrings,
            tocEntries: tocEntries,
            onScrollToTOCEntry: _this4.handleScrollToTOCEntry
          }); // Keep references to widget elements

          widgetElem = React.cloneElement(widgetElem, {
            widgetRef: _this4.compRef(options)
          });
          return widgetElem;
        };
