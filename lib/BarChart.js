...
module.exports = BarChart = (function(superClass) {
  ...
  BarChart.prototype.cleanDesign = function(design) {
    var aes, aggrs, i, len, ref, ref1, value;
    ...
    if (design.aesthetics.y && design.aesthetics.y.expr) {
      ...
      if (design.aesthetics.y.aggr && (ref1 = design.aesthetics.y.aggr, indexOf.call(_.pluck(aggrs, "id"), ref1) < 0)) {
  ...
  BarChart.prototype.createQueries = function(design, filters) {
    var expr, exprCompiler, exprs, filter, i, len, query, relevantFilters, whereClauses;
