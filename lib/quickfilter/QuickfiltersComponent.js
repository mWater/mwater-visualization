...
EnumQuickfilterComponent = (function(superClass) {
  ...
  EnumQuickfilterComponent.prototype.renderSingleSelect = function(options) {
  ...
  EnumQuickfilterComponent.prototype.renderMultiSelect = function(options) {
    return R(ReactSelect, {
      placeholder: "All",
  ...
  EnumQuickfilterComponent.prototype.render = function() {
    ...
    width = (ref = _.max(options, (function(_this) {
      return function(o) {
        return o.label.length;
      };
    })(this))) != null ? ref.label.length : void 0;
    width = width ? width * 8 + 70 : 280;
    minWidth = width > 280 || this.props.multi ? "280px" : width + "px";
    return R('div', {
      style: {
