...
module.exports = DashboardComponent = function () {
  ...
  function (_React$Component) {
    ...
    function DashboardComponent(props) {
      ...
      _this.getQuickfilterValues = _this.getQuickfilterValues.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handlePrint = _this.handlePrint.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleUndo = _this.handleUndo.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleRedo = _this.handleRedo.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))); // Saves a json file to disk

      _this.handleSaveDesignFile = _this.handleSaveDesignFile.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleSettings = _this.handleSettings.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleToggleEditing = _this.handleToggleEditing.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleRefreshData = _this.handleRefreshData.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleStyleChange = _this.handleStyleChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      ...
      _this.handleUpgrade = _this.handleUpgrade.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.refDashboardView = _this.refDashboardView.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.state = {
