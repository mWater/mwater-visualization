...
class MapComponent extends react_1.default.Component {
    ...
    renderActionLinks() {
        return R("div", null, this.props.onDesignChange != null
            ...
            : undefined, this.props.extraTitleButtonsElem, this.state.hideQuickfilters && this.props.design.quickfilters && this.props.design.quickfilters.length > 0
    ...
    render() {
        ...
        }, this.renderHeader(), this.state.hideQuickfilters ? null : this.renderQuickfilter(), R("div", { style: { width: "100%", height: "100%", gridArea: "view", overflow: "hidden" } }, this.renderView()), this.renderDesigner());
    }
}
