var ClickOutHandler, DateExprComponent, DatePicker, PropTypes, R, React, moment, presets,
...
module.exports = DateExprComponent = (function(superClass) {
  ...
  function DateExprComponent(props) {
    ...
    DateExprComponent.__super__.constructor.call(this, props);
    this.state = {
      dropdownOpen: false,
      custom: false
    };
