...
class QuickfilterDesignComponent extends react_1.default.Component {
    ...
    render() {
        ...
        return R(RemovableComponent, { onRemove: this.props.onRemove }, R("div", { className: "card" }, R("div", { className: "card-body" }, R("div", { className: "mb-3", key: "table" }, R("label", { className: "text-muted" }, "Data Source"), R(ui.Select, {
