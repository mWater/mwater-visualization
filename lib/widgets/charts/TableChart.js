...
module.exports = TableChart = (function(superClass) {
  ...
  TableChart.prototype.getData = function(design, schema, dataSource, filters, callback) {
    var axisBuilder, colNum, column, expr, exprCompiler, exprUtils, i, j, k, len, ordering, query, ref, ref1, ref2, ref3, ref4, whereClauses;
    ...
    for (colNum = j = 0, ref = design.columns.length; 0 <= ref ? j < ref : j > ref; colNum = 0 <= ref ? ++j : --j) {
      ...
      expr = exprCompiler.compileExpr({
        expr: (ref1 = column.textAxis) != null ? ref1.expr : void 0,
        tableAlias: "main"
      });
      query.selects.push({
        type: "select",
    ...
    ref2 = design.orderings || [];
    for (i = k = 0, len = ref2.length; k < len; i = ++k) {
      ordering = ref2[i];
      query.selects.push({
        type: "select",
        expr: exprCompiler.compileExpr({
          expr: (ref3 = ordering.axis) != null ? ref3.expr : void 0,
          tableAlias: "main"
        }),
        alias: "o" + i
      });
      ...
      if (exprUtils.getExprAggrStatus((ref4 = ordering.axis) != null ? ref4.expr : void 0) === "individual") {
    ...
    renderRow = (function(_this) {
      return function(record) {
        ...
        renderCell = function(column, columnIndex) {
          ...
          return exprUtils.stringifyExprLiteral((ref = column.textAxis) != null ? ref.expr : void 0, value, locale);
        };
