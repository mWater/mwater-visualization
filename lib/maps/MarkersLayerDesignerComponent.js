var AxisComponent, ColorComponent, EditPopupComponent, ExprUtils, FilterExprComponent, H, MarkersLayerDesignerComponent, R, React, ReactSelect, TableSelectComponent, _,
...
module.exports = MarkersLayerDesignerComponent = (function(superClass) {
  ...
  MarkersLayerDesignerComponent.prototype.render = function() {
    return H.div(null, this.renderTable(), this.renderGeometryAxis(), this.renderColor(), this.renderColorAxis(), this.renderSymbol(), this.renderFilter(), this.props.design.table ? R(EditPopupComponent, {
