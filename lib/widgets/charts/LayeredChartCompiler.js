...
module.exports = LayeredChartCompiler = (function() {
  ...
  LayeredChartCompiler.prototype.compileDefaultTitleText = function(design) {
    if (design.layers[0].axes.x) {
      return this.compileYAxisLabelText(design) + " vs " + this.compileXAxisLabelText(design);
    } else {
      return this.compileYAxisLabelText(design) + " vs " + this.axisBuilder.summarizeAxis(design.layers[0].axes.color);
    }
  };
