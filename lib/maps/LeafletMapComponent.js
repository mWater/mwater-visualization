...
exports.standardLeafletIcon = void 0;
...
exports.standardLeafletIcon = leaflet_1.default.icon({
...
class LeafletMapComponent extends react_1.Component {
                            ...
                            pointToLayer: (geojson, latlng) => {
                                if (layer.pointStyle) {
                                    ...
                                    return leaflet_1.default.marker(latlng, {
                                        icon: exports.standardLeafletIcon,
                                        interactive: layer.nonInteractive ? false : true
                                    });
                                }
                            }
    ...
    render() {
        return R("div", { className: this.props.showZoomControlOnHover ? "show-zoom-control-on-hover" : undefined }, this.props.legend && this.loaded
            ? // Inject zoom
