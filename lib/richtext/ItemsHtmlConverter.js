...
module.exports = ItemsHtmlConverter = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(ItemsHtmlConverter, [{
    ...
    value: // Converts list of items to html
    ...
    value: function convertElemToItems(elem) {
      var href, hrefMatches, i, item, items, j, len, len1, node, ref, ref1, ref2, style, tag, text; // console.log elem.outerHTML
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        ...
        if (node.nodeType === 1) {
          ...
          if (node.href) {
            ...
            href = hrefMatches != null ? hrefMatches[1] : void 0;
