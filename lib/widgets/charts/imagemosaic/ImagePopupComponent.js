var H, ImagePopupComponent, ModalWindowComponent, PropTypes, R, React, RotationAwareImageComponent,
...
module.exports = ImagePopupComponent = (function(superClass) {
  ...
  function ImagePopupComponent() {
    ImagePopupComponent.__super__.constructor.apply(this, arguments);
    this.state = {
      image: null,
      url: null
    };
