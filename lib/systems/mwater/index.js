...
MWaterTableSelectElement = (function(superClass) {
  ...
  MWaterTableSelectElement.prototype.getAsyncOptions = function(cb) {
    var options;
    options = _.map(schema.getTables(), function(t) {
      return {
        value: t.id,
        label: t.name
      };
    ...
    return this.getFormOptions((function(_this) {
      return function(err, formOptions) {
        ...
        for (i = 0, len = formOptions.length; i < len; i++) {
          opt = formOptions[i];
          if (!_this.schema.getTable(opt.value)) {
            options.push(opt);
          }
        }
        return cb({
  ...
  MWaterTableSelectElement.prototype.render = function() {
    return React.createElement(ReactSelect, {
      ...
      asyncOptions: this.getFormOptions
    });
  };
