var AxisBuilder, ExprCompiler, ExprUtils, LayeredChartCompiler, _, injectTableAlias, tickFormatter;
...
module.exports = LayeredChartCompiler = (function() {
  ...
  LayeredChartCompiler.prototype.createChartOptions = function(options) {
    var c3Data, chartDesign, ref, ref1, ref2;
    ...
    chartDesign = {
      ...
      pie: {
        label: {
          format: options.design.labels ? (function(_this) {
    ...
    if (((ref = options.design.layers[0]) != null ? (ref1 = ref.axes.x) != null ? (ref2 = ref1.xform) != null ? ref2.type : void 0 : void 0 : void 0) === "year") {
      chartDesign.axis.x.tick.format = function(x) {
  ...
  LayeredChartCompiler.prototype.flattenRowData = function(rows) {
    var error, existingRow, flatRows, j, k, len, len1, row, x, xs;
    flatRows = [];
    for (j = 0, len = rows.length; j < len; j++) {
      row = rows[j];
      if (!row.x) {
  ...
  LayeredChartCompiler.prototype.compileDataCategorical = function(design, data, locale) {
    var categories, categoryMap, categoryXs, colors, column, columns, dataMap, groups, i, j, k, len, len1, m, n, names, ref, ref1, types, xAxis, xType, xValues, xs, xtotals;
    columns = [];
    types = {};
    names = {};
    dataMap = {};
