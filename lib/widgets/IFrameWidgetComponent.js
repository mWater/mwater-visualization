var DropdownWidgetComponent, IFrameWidgetComponent, ModalPopupComponent, PropTypes, R, React, _, ui,
...
module.exports = IFrameWidgetComponent = (function(superClass) {
  ...
  function IFrameWidgetComponent(props) {
    ...
    IFrameWidgetComponent.__super__.constructor.call(this, props);
    this.state = {
      editing: false,
      editUrl: null
    };
