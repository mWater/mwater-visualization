...
exports.default = TOCWidget = class TOCWidget extends Widget_1.default {
...
class TOCWidgetViewComponent extends react_1.default.Component {
    ...
    renderTOCEntry(tocEntry, index) {
        ...
        return R("div", { key: index, style: { paddingLeft: tocEntry.level * 8 - 8 } }, R("a", { onClick: this.handleEntryClick.bind(null, tocEntry), style: { cursor: "pointer" } }, indentation, R("span", null, tocEntry.text)));
    }
    render() {
        // Get border
        const border = (() => {
...
class TOCWidgetDesignerComponent extends react_1.default.Component {
    ...
    update() {
        return update_1.default(this.props.design, this.props.onDesignChange, arguments);
    }
    render() {
        return R("div", null, R(bootstrap_1.default.FormGroup, { label: "Header" }, R(bootstrap_1.default.TextInput, { value: this.props.design.header || "", onChange: this.update("header"), placeholder: "None" })), R(bootstrap_1.default.FormGroup, { label: "Border" }, R(BorderComponent, { value: this.props.design.borderWeight || 0, onChange: this.update("borderWeight") })), R(bootstrap_1.default.FormGroup, { label: "Numbering" }, R(bootstrap_1.default.Radio, {
            inline: true,
            value: this.props.design.numbering || false,
            radioValue: true,
            onChange: this.update("numbering")
        }, "On"), R(bootstrap_1.default.Radio, {
            inline: true,
            value: this.props.design.numbering || false,
            radioValue: false,
            onChange: this.update("numbering")
...
class BorderComponent extends react_1.default.Component {
    ...
    render() {
        ...
        return R("div", null, R(bootstrap_1.default.Radio, { inline: true, value, radioValue: 0, onChange: this.props.onChange }, "None"), R(bootstrap_1.default.Radio, { inline: true, value, radioValue: 1, onChange: this.props.onChange }, "Light"), R(bootstrap_1.default.Radio, { inline: true, value, radioValue: 2, onChange: this.props.onChange }, "Medium"), R(bootstrap_1.default.Radio, { inline: true, value, radioValue: 3, onChange: this.props.onChange }, "Heavy"));
    }
}
