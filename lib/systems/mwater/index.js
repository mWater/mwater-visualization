    ...
    return function(entityTypes) {
      return $.getJSON(options.apiUrl + ("properties" + clientUrl), function(properties) {
        return $.getJSON(options.apiUrl + ("units" + clientUrl), function(units) {
          var createTableSelectElement, dataSource, layerFactory, loadFormTable, loadFormTables, schema, schemaBuilder, widgetFactory;
          schema = new Schema();
          ...
          loadFormTable = function(formId, cb) {
            var url;
            url = options.apiUrl;
          ...
          loadFormTables = function(formTables, callback) {
            return async.eachSeries(formTables || [], loadFormTable, callback);
          };
            ...
            return React.createElement(MWaterTableSelectElement, {
              ...
              onChange: function(newTable) {
                ...
                if (newTable.match(/^responses:/)) {
                  ...
                  return loadFormTable(formId, function(err) {
                    if (err) {
                      throw err;
                    }
                    return onChange(newTable);
