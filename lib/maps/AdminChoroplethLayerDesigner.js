var AdminChoroplethLayerDesigner, AxisComponent, ColorComponent, EditPopupComponent, ExprComponent, ExprUtils, FilterExprComponent, H, R, Rcslider, React, ReactSelect, RegionAndDetailLevelComponent, TableSelectComponent, _, updt,
...
module.exports = AdminChoroplethLayerDesigner = (function(superClass) {
  ...
  AdminChoroplethLayerDesigner.prototype.render = function() {
    return H.div(null, this.renderRegionAndDetailLevel(), this.renderTable(), this.renderAdminRegionExpr(), this.renderDisplayNames(), this.renderColor(), this.renderColorAxis(), this.renderFillOpacity(), this.renderFilter(), this.renderPopup());
  };
