var C3ChartComponent, ExprUtils, H, LayeredChartCompiler, LayeredChartViewComponent, R, React, ReactDOM, TextWidget, _,
    ...
    return H.div({
      ...
      widgetDataSource: {
        getData: (function(_this) {
          return function(design, filters, callback) {
            return callback(null, _this.props.data.header);
          };
        })(this)
      },
  ...
  LayeredChartViewComponent.prototype.renderFooter = function() {
    return H.div({
      ...
      widgetDataSource: {
        getData: (function(_this) {
          return function(design, filters, callback) {
            return callback(null, _this.props.data.footer);
          };
        })(this)
      },
      filters: this.props.filters,
