...
class TableContentsComponent extends react_1.default.Component {
    ...
    renderFooterCell(index) {
        ...
        if (exprType && exprType == 'number') {
            node = (0, valueFormatter_1.formatValue)(exprType, this.props.data.summary[`c${index}`], column.format);
        }
    ...
    render() {
        return R("table", { className: "table table-sm table-hover", style: { fontSize: "10pt", marginBottom: 0 } }, this.renderHeader(), this.renderBody(), this.renderFooter());
    }
}
