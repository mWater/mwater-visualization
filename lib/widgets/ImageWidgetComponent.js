var AsyncLoadComponent, DropdownWidgetComponent, Dropzone, ExprComponent, H, ImageUploaderComponent, ImageWidgetComponent, ModalPopupComponent, R, React, TabbedComponent, TableSelectComponent, _, uuid,
...
module.exports = ImageWidgetComponent = (function(superClass) {
  ...
  ImageWidgetComponent.prototype.renderUrlEditor = function() {
    ...
    }, H.label(null, "URL to image"), H.input({
      type: "text",
  ...
  ImageWidgetComponent.prototype.renderContent = function() {
    ...
    if (this.props.design.imageUrl || this.props.design.uid) {
      source = this.props.design.imageUrl || this.props.apiUrl + "images/" + this.props.design.uid;
      return H.img({
        style: {
          maxWidth: "100%",
          maxHeight: "100%"
  ...
  ImageWidgetComponent.prototype.renderExpression = function() {
    return H.img({
      ...
      src: "https://img0.etsystatic.com/119/0/6281042/il_570xN.1025495956_8oux.jpg"
    });
  };
  ...
  ImageWidgetComponent.prototype.render = function() {
    ...
    }, this.renderEditor(), !this.props.design.imageUrl && !this.props.design.expr && !this.props.design.uid ? this.renderEditLink() : H.div({
      style: {
        position: "relative",
        width: this.props.width,
        height: this.props.height,
