var DraggableBlockComponent, HorizontalBlockComponent, PropTypes, R, React, _,
...
module.exports = HorizontalBlockComponent = (function(superClass) {
  ...
  function HorizontalBlockComponent(props) {
    ...
    HorizontalBlockComponent.__super__.constructor.call(this, props);
    this.state = {
      dragIndex: null,
      dragInitialX: null,
      dragXOffset: null,
  ...
  HorizontalBlockComponent.prototype.render = function() {
    ...
    if (this.props.onBlockUpdate != null) {
      ...
      }, R('tbody', null, R('tr', null, _.map(this.props.block.blocks, (function(_this) {
        return function(block, index) {
          return [
            index > 0 && (_this.props.onBlockUpdate != null) ? R('td', {
              style: {
                width: 5,
                position: "relative",
              ...
              key: block.id,
              ref: (function(c) {
                return _this.blockRefs["block" + index] = c;
              })
