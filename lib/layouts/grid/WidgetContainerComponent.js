...
Container = function () {
  ...
  function (_React$Component2) {
    ...
    function Container(props) {
      ...
      _this.handleWidgetDesignChange = _this.handleWidgetDesignChange.bind((0, _assertThisInitialized2["default"])(_this)); // Render a particular layout. Allow visible to be false so that 
