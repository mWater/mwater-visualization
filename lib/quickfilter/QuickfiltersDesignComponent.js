var ExprComponent, ExprUtils, H, PropTypes, QuickfilterDesignComponent, QuickfiltersDesignComponent, R, React, RemovableComponent, TableSelectComponent, ui, update,
...
module.exports = QuickfiltersDesignComponent = (function(superClass) {
  ...
  QuickfiltersDesignComponent.prototype.render = function() {
    ...
    })(this)), this.props.tables.length > 0 ? H.button({
      type: "button",
...
QuickfilterDesignComponent = (function(superClass) {
  ...
  QuickfilterDesignComponent.prototype.render = function() {
    ...
    }, "Merge with previous quickfilter ", H.span({
      className: "text-muted"
    }, "- displays as one single control that filters both")) : void 0, exprType === 'enum' || exprType === 'text' ? R(ui.Checkbox, {
