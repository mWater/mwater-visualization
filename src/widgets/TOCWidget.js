...
class TOCWidgetViewComponent extends React.Component {
  ...
  renderTOCEntry(tocEntry, index) {
    ...
    return R('div', {key: index, style: { paddingLeft: (tocEntry.level * 8) - 8 }},
      R('a', {onClick: this.handleEntryClick.bind(null, tocEntry), style: { cursor: "pointer" }},
        indentation,
  ...
  render() {
    // Get border
    const border = (() => { switch (this.props.design.borderWeight) {
      case 0: return "none";
      case 1: return "solid 1px #f4f4f4";
      case 2: return "solid 1px #ccc";
      case 3: return "solid 1px #888";
    } })();
    ...
    return R('div', { 
      ...
      this.props.onDesignChange && (this.props.tocEntries.length === 0) ?
        R('div', {className: "text-muted"},
          "Table of Contents will appear here as text blocks with headings are added to the dashboard") : undefined
    );
  }
}
  ...
  render() {
    return R('div', null,
      ...
      R(ui.FormGroup, {label: "Numbering"},
        R(ui.Radio, {inline: true, value: this.props.design.numbering || false, radioValue: true, onChange: this.update("numbering")},
          "On"),
        R(ui.Radio, {inline: true, value: this.props.design.numbering || false, radioValue: false, onChange: this.update("numbering")},
          "Off")
      )
    );
  }
