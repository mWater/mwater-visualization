var DirectMapUrlSource, LayerFactory, _, injectTableAlias;
...
module.exports = DirectMapUrlSource = (function() {
  function DirectMapUrlSource(options) {
  ...
  DirectMapUrlSource.prototype.getTileUrl = function(layerId, filters) {
  ...
  DirectMapUrlSource.prototype.getUtfGridUrl = function(layerId, filters) {
    var design, jsonqlCss, layer, layerView;
    layerView = _.findWhere(this.mapDesign.layerViews, {
      id: layerId
    });
  ...
  DirectMapUrlSource.prototype.createUrl = function(extension, jsonqlCss) {
    var query, url;
    query = "type=jsonql";
    if (this.client) {
  ...
  DirectMapUrlSource.prototype.createLegacyUrl = function(design, extension, filters) {
