      ...
      value: function render() {
        ...
        if (this.props.onItemsChange) {
          ...
          return R(AutoSizeComponent, {
            ...
            var innerParentStyle, outerParentStyle, scale;
            outerParentStyle = {
              width: "100%",
              height: "100%",
              overflowX: "auto"
            ...
            if (_this3.props.layoutOptions.belowMinimumWidth === "scroll") {
              innerParentStyle.minWidth = _this3.props.layoutOptions.minimumWidth || void 0;
              innerParentStyle.maxWidth = _this3.props.layoutOptions.maximumWidth || void 0;
            } else {
              if (_this3.props.layoutOptions.minimumWidth != null && size.width < _this3.props.layoutOptions.minimumWidth) {
                scale = size.width / _this3.props.layoutOptions.minimumWidth;
            ...
            }, _this3.renderBlock(_this3.props.items, _this3.props.layoutOptions.collapseColumnsWidth != null && size.width <= _this3.props.layoutOptions.collapseColumnsWidth)));
          });
        }
      }
    }]);
