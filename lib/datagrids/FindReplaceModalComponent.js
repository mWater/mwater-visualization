...
class FindReplaceModalComponent extends react_1.default.Component {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let extraFilter of this.props.filters || []) {
                if (extraFilter.table === this.props.design.table) {
                    wheres.push((0, mwater_expressions_3.injectTableAlias)(extraFilter.jsonql, "main"));
                }
            }
    ...
    renderPreview() {
        ...
        const design = (0, immer_1.default)(this.props.design, draft => {
    ...
    renderContents() {
        ...
        return R("div", null, R("div", { key: "replace", className: "mb-3" }, R("label", null, T("Column with data to replace") + ": "), R(react_select_1.default, {
            ...
            if (this.state.replaceColumn) {
                // Get expr of replace column
                const replaceExpr = lodash_1.default.findWhere(this.props.design.columns, { id: this.state.replaceColumn }).expr;
                return R("div", { key: "with", className: "mb-3" }, R("label", null, T("Value to replace data with") + ": "), R(mwater_expressions_ui_1.ExprComponent, {
                    schema: this.props.schema,
                    dataSource: this.props.dataSource,
                    table: this.props.design.table,
            ...
            return null;
        })(), R("div", { key: "condition", className: "mb-3" }, R("label", null, T("Only in rows that (optional)") + ":"), R(mwater_expressions_ui_1.ExprComponent, {
            schema: this.props.schema,
            dataSource: this.props.dataSource,
            table: this.props.design.table,
