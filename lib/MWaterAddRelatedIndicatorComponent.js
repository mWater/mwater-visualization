var ExprUtils, MWaterAddRelatedIndicatorComponent, PropTypes, R, React, _, filterMatches, flattenProperties, moment, querystring, ui,
...
module.exports = MWaterAddRelatedIndicatorComponent = (function(superClass) {
  ...
  function MWaterAddRelatedIndicatorComponent(props) {
    ...
    MWaterAddRelatedIndicatorComponent.__super__.constructor.call(this, props);
    this.state = {
      addingTables: [],
      indicators: null
    };
  ...
  MWaterAddRelatedIndicatorComponent.prototype.render = function() {
    ...
    return R('div', null, R('div', {
      ...
      return function(indicator) {
        ...
        }, (ref = indicator._id, indexOf.call(_this.state.addingTables, ref) >= 0) ? R('i', {
          className: "fa fa-spin fa-spinner"
