...
class IFrameWidgetComponent extends react_1.default.Component {
    ...
    renderEditor() {
        ...
        const content = R("div", { className: "form-group" }, R("label", null, "URL to embed"), R("input", {
            type: "text",
    ...
    renderEditLink() {
        return R("div", { className: "mwater-visualization-widget-placeholder", onClick: this.handleStartEditing }, R(bootstrap_1.default.Icon, { id: "fa-youtube-play" }));
    }
