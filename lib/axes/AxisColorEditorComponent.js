...
module.exports = AxisColorEditorComponent = function () {
  ...
  function (_React$Component) {
    ...
    function AxisColorEditorComponent(props) {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(AxisColorEditorComponent).call(this, props));
      _this.handleSelectPalette = _this.handleSelectPalette.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleResetPalette = _this.handleResetPalette.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handlePaletteChange = _this.handlePaletteChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleCancelCustomize = _this.handleCancelCustomize.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.state = {
        mode: "normal"
      };
      return _this;
