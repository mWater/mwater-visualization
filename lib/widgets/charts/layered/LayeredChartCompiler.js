...
module.exports = LayeredChartCompiler = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(LayeredChartCompiler, [{
    ...
    value: function compileDataCategorical(design, data, locale) {
      ...
      var categories, categoryMap, categoryOrder, categoryXs, colorOverrides, colors, column, columns, dataMap, defaultStacked, format, groups, i, j, k, layer, layerIndex, len, len1, len2, m, n, names, nullLabel, o, ref, ref1, ref2, stacked, types, xAxis, xType, xValues, xs, xtotals;
      columns = [];
      types = {};
      names = {};
      dataMap = {};
