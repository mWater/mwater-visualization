...
function (_Widget) {
  ...
  function ChartWidget(chart) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(ChartWidget).call(this));
    _this.chart = chart;
    return _this;
...
ChartWidgetComponent = function () {
  ...
  function (_React$Component) {
    ...
    function ChartWidgetComponent(props) {
      ...
      _this2 = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(ChartWidgetComponent).call(this, props)); // Saves a csv file to disk

      _this2.handleSaveCsvFile = _this2.handleSaveCsvFile.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)));
      _this2.handleStartEditing = _this2.handleStartEditing.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)));
      _this2.handleEndEditing = _this2.handleEndEditing.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)));
      _this2.handleCancelEditing = _this2.handleCancelEditing.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)));
      _this2.handleEditDesignChange = _this2.handleEditDesignChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)));
      _this2.state = {
    ...
    (0, _createClass2.default)(ChartWidgetComponent, [{
      ...
      key: "renderChart",
      value: function renderChart(design, onDesignChange, width, height, standardWidth) {
  ...
  }, (0, _defineProperty2.default)(_ChartWidgetComponent, "dataSource", PropTypes.object.isRequired), (0, _defineProperty2.default)(_ChartWidgetComponent, "width", PropTypes.number), (0, _defineProperty2.default)(_ChartWidgetComponent, "height", PropTypes.number), (0, _defineProperty2.default)(_ChartWidgetComponent, "standardWidth", PropTypes.number), (0, _defineProperty2.default)(_ChartWidgetComponent, "scope", PropTypes.any), (0, _defineProperty2.default)(_ChartWidgetComponent, "filters", PropTypes.array), (0, _defineProperty2.default)(_ChartWidgetComponent, "onScopeChange", PropTypes.func), (0, _defineProperty2.default)(_ChartWidgetComponent, "onRowClick", PropTypes.func), (0, _defineProperty2.default)(_ChartWidgetComponent, "connectMoveHandle", PropTypes.func), (0, _defineProperty2.default)(_ChartWidgetComponent, "connectResizeHandle", PropTypes.func), _ChartWidgetComponent);
