var AxisBuilder, BufferLayer, ExprCleaner, ExprCompiler, H, Layer, React, _, injectTableAlias,
...
module.exports = BufferLayer = (function(superClass) {
  ...
  BufferLayer.prototype.createKMLExportJsonQL = function(design, schema, filters) {
    var axisBuilder, bufferedGeometry, colorExpr, exprCompiler, filter, geometryExpr, j, len, query, radiusDeg, relevantFilters, selects, whereClauses;
    axisBuilder = new AxisBuilder({
      schema: schema
    });
    exprCompiler = new ExprCompiler(schema);
