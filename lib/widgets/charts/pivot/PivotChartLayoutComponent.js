...
module.exports = PivotChartLayoutComponent = (function(superClass) {
  ...
  PivotChartLayoutComponent.prototype.render = function() {
    return H.div({
    ...
    }), " Warning: Too many rows in table to display") : void 0, this.props.layout.tooManyColumns ? H.div({
      className: "text-warning",
      style: {
        fontSize: 12
      }
      ...
      className: "fa fa-exclamation-circle"
    }), " Warning: Too many columns in table to display") : void 0, H.table({
