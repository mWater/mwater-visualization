...
module.exports = MapDesignerComponent = function () {
  ...
  function (_React$Component) {
    ...
    function MapDesignerComponent() {
      ...
      _this.handleLegendOptionsChange = _this.handleLegendOptionsChange.bind((0, _assertThisInitialized2["default"])(_this));
      return _this;
    }
    ...
    (0, _createClass2["default"])(MapDesignerComponent, [{
      ...
      key: "handleLegendOptionsChange",
      value: function handleLegendOptionsChange(value) {
        var design;
        boundMethodCheck(this, MapDesignerComponent);
        design = _.extend({}, this.props.design, {
          legend: value
      ...
      value: function renderOptionsTab() {
        ...
        }), R('br'), R(LegendDesignControl, {
          design: this.props.design.legend || {},
          onChange: this.handleLegendOptionsChange
...
AdvancedOptionsComponent = function () {
  ...
  return AdvancedOptionsComponent;
}.call(void 0); // Legend position and scale component


LegendDesignControl = function LegendDesignControl(_ref) {
  var design = _ref.design,
      onChange = _ref.onChange;
  var updateLegend;

  updateLegend = function updateLegend() {
    return update(design, onChange, arguments);
  };
  ...
  return R('div', {
    ...
    checked: design.showLegend != null ? design.showLegend : true,
    ...
    className: "text-muted"
  }, "Position"), R('div', null, R(ui.Toggle, {
    value: design.position || 'bottomRight',
    size: 'xs',
    ...
    className: "text-muted"
  }, "Size"), R('div', null, R(ui.Toggle, {
    value: design.scale || 'normal',
