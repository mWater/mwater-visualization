...
export default LayeredChartDesignerComponent = (function() {
  LayeredChartDesignerComponent = class LayeredChartDesignerComponent extends React.Component {
      ...
      return R('div', null,
        ...
        this.areAxesLabelsNeeded() ?
          R('div', {className: "form-group"},
            R('span', null,
              R('label', {className: "text-muted"}, this.props.design.transpose ? "Vertical Axis Label" : "Horizontal Axis Label"),
              " ",
              R('button', {className: "btn btn-default btn-xs", onClick: this.handleToggleXAxisLabelClick}, (this.props.design.xAxisLabelText != null) ? "Hide" : "Show")),
            (this.props.design.xAxisLabelText != null) ?
              R('input', {type: "text", className: "form-control input-sm", value: this.props.design.xAxisLabelText, onChange: this.handleXAxisLabelTextChange, placeholder: compiler.compileDefaultXAxisLabelText(this.props.design)}) : undefined
          ) : undefined,
        this.areAxesLabelsNeeded() ?
          R('div', {className: "form-group"},
            R('span', null,
              R('label', {className: "text-muted"}, !this.props.design.transpose ? "Vertical Axis Label" : "Horizontal Axis Label"),
              " ",
              R('button', {className: "btn btn-default btn-xs", onClick: this.handleToggleYAxisLabelClick}, (this.props.design.yAxisLabelText != null) ? "Hide" : "Show")),
            (this.props.design.yAxisLabelText != null) ?
              R('input', {type: "text", className: "form-control input-sm", value: this.props.design.yAxisLabelText, onChange: this.handleYAxisLabelTextChange, placeholder: compiler.compileDefaultYAxisLabelText(this.props.design)}) : undefined
          ) : undefined
      );
    }
    ...
    renderType() {
      ...
      return R(uiComponents.SectionComponent, {icon: "glyphicon-th", label: "Chart Type"},
    ...
    renderLayers() {
      ...
      return R('div', null, 
        ...
        (this.props.design.layers.length > 0) && _.last(this.props.design.layers).table ?
          R('button', {className: "btn btn-link", type: "button", onClick: this.handleAddLayer},
            R('span', {className: "glyphicon glyphicon-plus"}),
            " Add Another Series") : undefined
      );
    }
        ...
        ['pie', 'donut'].includes(design.type) ?
          [
            R('label', {className: "checkbox-inline", key: "polarOrder"},
              R('input', {type: "checkbox", checked: design.hidePercentage, onChange: this.handlePercentageVisibilityChange}),
              "Hide Percentage"),
            R('label', {className: "checkbox-inline", key: "polarOrder"},
              R('input', {type: "checkbox", checked: (design.polarOrder || "desc") === "desc", onChange: this.handlePolarOrderChange}),
              "Descending Order")
          ] : undefined);
    }
    ...
    renderThresholds() {
      ...
      if (this.props.design.type && !['pie', 'donut'].includes(this.props.design.type)) {
        return R(uiComponents.SectionComponent, {label: "Y Threshold Lines"},
    ...
    renderYRange() {
      // Doesn't apply to polar
      if (this.props.design.type && !['pie', 'donut'].includes(this.props.design.type)) {
        return R(uiComponents.SectionComponent, {label: "Y Axis Range"},
          R(LabeledInlineComponent, {key: "min", label: "Min:"},
            R(ui.NumberInput, {decimal: true, style: { display: "inline-block" }, size: "sm", value: this.props.design.yMin, onChange: this.handleYMinChange, placeholder: "Auto"})),
          "  ",
          R(LabeledInlineComponent, {key: "label", label: "Max:"},
            R(ui.NumberInput, {decimal: true, style: { display: "inline-block" }, size: "sm", value: this.props.design.yMax, onChange: this.handleYMaxChange, placeholder: "Auto"}))
        );
      }
    }
  ...
  render() {
    return R('div', null,
      _.map(this.props.thresholds, (threshold, index) => {
        return R(ThresholdComponent, {threshold, onThresholdChange: this.handleChange.bind(null, index), onRemove: this.handleRemove.bind(null, index), showHighlightColor: this.props.showHighlightColor});
      }),

      R('button', {type: "button", className: "btn btn-xs btn-link", onClick: this.handleAdd},
  ...
  render() {
    return R('div', null,
      R(LabeledInlineComponent, {key: "value", label: "Value:"},
        R(ui.NumberInput, {decimal: true, style: { display: "inline-block" }, size: "sm", value: this.props.threshold.value, onChange: v => this.props.onThresholdChange(_.extend({}, this.props.threshold, {value: v}))})),
      "  ",
      R(LabeledInlineComponent, {key: "label", label: "Label:"},
        R(ui.TextInput, {style: { display: "inline-block", width: "8em" }, size: "sm", value: this.props.threshold.label, onChange: v => this.props.onThresholdChange(_.extend({}, this.props.threshold, {label: v}))})),
      "  ",
      this.props.showHighlightColor ?
        R(LabeledInlineComponent, {key: "color", label: "Highlight color:"},
          R('div', {style: { verticalAlign: "middle", display: "inline-block" }},
            R(ColorComponent, {color: this.props.threshold.highlightColor, onChange: v => this.props.onThresholdChange(_.extend({}, this.props.threshold, {highlightColor: v}))}))
        ) : undefined,
      "  ",
      R('button', {className: "btn btn-xs btn-link", onClick: this.props.onRemove}, 
