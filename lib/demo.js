var AutoSizeComponent, CalendarChartViewComponent, DataSource, DirectDashboardDataSource, DirectMapUrlSource, H, LayeredChart, LayeredChartDesignerComponent, MWaterDashboardPane, MWaterDataSource, MWaterDatagridDesignerPane, MWaterDatagridPane, MWaterDirectDashboardPane, MWaterDirectMapPane, MWaterLoaderComponent, MWaterMapPane, React, ReactDOM, Schema, ServerDashboardDataSource, ServerMapUrlSource, dashboardDesign, dashboardId, datagridDesign, mapDesign, mapId, querystring, rosterDatagridDesign, share, visualization,
...
MWaterMapPane = (function(superClass) {
  ...
  MWaterMapPane.prototype.render = function() {
    ...
    return React.createElement(MWaterLoaderComponent, {
      ...
      return function(error, config) {
        var mapUrlSource;
        mapUrlSource = new ServerMapUrlSource({
          apiUrl: _this.props.apiUrl,
          client: _this.props.client,
          share: share,
          mapId: mapId
...
$(function() {
  ...
  }, H.style(null, 'html, body, #main { height: 100% }'), React.createElement(MWaterDatagridDesignerPane, {
