...
class MWaterLoaderComponent extends AsyncLoadComponent_1.default {
    ...
    isLoadNeeded(newProps, oldProps) {
        return !lodash_1.default.isEqual(lodash_1.default.pick(newProps, "apiUrl", "client", "user", "share", "asUser", "extraTables", "locales"), lodash_1.default.pick(oldProps, "apiUrl", "client", "user", "share", "asUser", "extraTables", "locales"));
    }
