...
export default LayeredChartLayerDesignerComponent = (function() {
  LayeredChartLayerDesignerComponent = class LayeredChartLayerDesignerComponent extends React.Component {
    ...
    renderName() {
      ...
      return R('input', {type: "text", className: "form-control input-sm", value: layer.name, onChange: this.handleNameChange, placeholder});
    }
    ...
    renderTable() {
      ...
      return R(uiComponents.SectionComponent, {icon: "fa-database", label: "Data Source"},
    ...
    renderXAxis() {
      ...
      return R(uiComponents.SectionComponent, {label: title},
        R(AxisComponent, { 
          schema: this.props.schema,
    ...
    renderColor() {
      ...
      return R('div', {className: "form-group"},
        R('label', {className: "text-muted"}, 
          layer.axes.color ? "Default Color" : "Color"),
        R('div', {style: { marginLeft: 8 }}, 
          ...
          layer.axes.x && categoricalX && !layer.axes.color ?
            R(ui.Checkbox, {value: layer.xColorMap, onChange: this.handleXColorMapChange}, 
              "Set Individual Colors") : undefined
        )
      );
    }
    ...
    render() {
      ...
      return R('div', null, 
        ...
        (() => {
        if (!this.isLayerPolar(layer)) {
          if (layer.axes.y) { return this.renderColor(); }
        }
      })(),
