...
injectTableAlias = require('mwater-expressions').injectTableAlias; // Displays a combo box that allows selecting single text value from an expression

module.exports = TextLiteralComponent = function () {
  var TextLiteralComponent =
  /*#__PURE__*/
  function (_React$Component) {
    ...
    function TextLiteralComponent() {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(TextLiteralComponent).apply(this, arguments));
      _this.handleSingleChange = _this.handleSingleChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.handleMultipleChange = _this.handleMultipleChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.getOptions = _this.getOptions.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      return _this;
    }
    ...
    (0, _createClass2.default)(TextLiteralComponent, [{
      ...
      value: function getOptions(input, cb) {
        ...
        boundMethodCheck(this, TextLiteralComponent); // Create query to get matches

        exprCompiler = new ExprCompiler(this.props.schema); // Add filter for input
