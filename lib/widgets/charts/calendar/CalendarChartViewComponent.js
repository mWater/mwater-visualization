...
class CalendarChartViewComponent extends react_1.default.Component {
    ...
    getCellSize() {
        ...
        if (this.props.design.titleText) {
            remainingSpace = remainingSpace - (0, jquery_1.default)(this.title).outerHeight();
        }
    ...
    handleCellClick(cell, data) {
        ...
        (_e = (_d = this.props).onScopeChange) === null || _e === void 0 ? void 0 : _e.call(_d, scopeData);
    }
    // Redraw component
    redraw() {
        this.reloading = true;
        ...
        const tip = (0, d3_tip_1.default)()
            .attr("class", "d3-tip")
            .html(function (d) {
            const _date = (0, moment_1.default)(d);
