...
Cell = require('fixed-data-table-2').Cell; // Cell allows editing an expression column cell
// Store edited value here to prevent slow re-render of entire datagrid

module.exports = EditExprCellComponent = function () {
  var EditExprCellComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(EditExprCellComponent, _React$Component);

    var _super = _createSuper(EditExprCellComponent);
...
TextEditComponent = function () {
  // Simple text box
  var TextEditComponent = /*#__PURE__*/function (_React$Component2) {
    (0, _inherits2["default"])(TextEditComponent, _React$Component2);

    var _super2 = _createSuper(TextEditComponent);
...
NumberEditComponent = function () {
  // Simple number box
  var NumberEditComponent = /*#__PURE__*/function (_React$Component3) {
    (0, _inherits2["default"])(NumberEditComponent, _React$Component3);

    var _super3 = _createSuper(NumberEditComponent);
...
EnumEditComponent = function () {
  // Simple enum box
  var EnumEditComponent = /*#__PURE__*/function (_React$Component4) {
    (0, _inherits2["default"])(EnumEditComponent, _React$Component4);

    var _super4 = _createSuper(EnumEditComponent);
