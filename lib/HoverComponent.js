...
function (_React$Component) {
  ...
  function HoverComponent(props) {
    ...
    _this.onOver = _this.onOver.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    _this.onOut = _this.onOut.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    _this.state = {
      hovered: false
    };
    return _this;
