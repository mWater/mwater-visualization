...
module.exports = MarkersLayerDesignerComponent = function () {
  var MarkersLayerDesignerComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(MarkersLayerDesignerComponent, _React$Component);

    var _super = _createSuper(MarkersLayerDesignerComponent);
    ...
    function MarkersLayerDesignerComponent() {
      ...
      _this.handleLineWidthChange = _this.handleLineWidthChange.bind((0, _assertThisInitialized2["default"])(_this));
      return _this;
    ...
    (0, _createClass2["default"])(MarkersLayerDesignerComponent, [{
      ...
      key: "handleLineWidthChange",
      value: function handleLineWidthChange(lineWidth) {
        boundMethodCheck(this, MarkersLayerDesignerComponent);
        return this.update({
          lineWidth: lineWidth
        });
      ...
      value: function renderColor() {
        ...
        }), "Color"), R('div', null, R(ColorComponent, {
      ...
      key: "renderLineWidth",
      value: function renderLineWidth() {
        if (!this.props.design.axes.geometry) {
          return;
        }
        ...
        return R('div', {
          ...
          className: "text-muted"
        }, "Line Width (for shapes)"), R(ui.Select, {
      ...
      value: function render() {
        return R('div', null, this.renderTable(), this.renderGeometryAxis(), this.renderColor(), this.renderSymbol(), this.renderMarkerSize(), this.renderLineWidth(), this.renderFilter(), this.renderPopup(), this.props.design.table ? R(ZoomLevelsComponent, {
          design: this.props.design,
          onDesignChange: this.props.onDesignChange
        }) : void 0);
      }
