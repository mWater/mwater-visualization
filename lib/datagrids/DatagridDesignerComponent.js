...
ui = require('react-library/lib/bootstrap'); // Designer for the datagrid. Currenly allows only single-table designs (no subtable rows)

module.exports = DatagridDesignerComponent = function () {
  var DatagridDesignerComponent =
  /*#__PURE__*/
  function (_React$Component) {
    ...
    function DatagridDesignerComponent() {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(DatagridDesignerComponent).apply(this, arguments));
      ...
      _this.handleColumnsChange = _this.handleColumnsChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      ...
      _this.handleOrderBysChange = _this.handleOrderBysChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      return _this;
    }
...
DatagridOptionsComponent = function () {
  ...
  function (_React$Component2) {
    ...
    function DatagridOptionsComponent() {
      ...
      return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(DatagridOptionsComponent).apply(this, arguments));
    }
...
ColumnsDesignerComponent = function () {
  ...
  function (_React$Component3) {
    ...
    function ColumnsDesignerComponent() {
      ...
      _this4 = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(ColumnsDesignerComponent).apply(this, arguments));
      _this4.handleColumnChange = _this4.handleColumnChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this4)));
      _this4.handleAddColumn = _this4.handleAddColumn.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this4)));
      _this4.handleAddIdColumn = _this4.handleAddIdColumn.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this4)));
      _this4.handleAddDefaultColumns = _this4.handleAddDefaultColumns.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this4)));
      _this4.handleRemoveAllColumns = _this4.handleRemoveAllColumns.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this4)));
      _this4.renderColumn = _this4.renderColumn.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this4)));
      return _this4;
    }
...
ColumnDesignerComponent = function () {
  ...
  function (_React$Component4) {
    ...
    function ColumnDesignerComponent() {
      ...
      _this5 = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(ColumnDesignerComponent).apply(this, arguments));
      _this5.handleExprChange = _this5.handleExprChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this5)));
      _this5.handleLabelChange = _this5.handleLabelChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this5)));
      _this5.handleSplitEnumset = _this5.handleSplitEnumset.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this5)));
      _this5.handleSplitGeometry = _this5.handleSplitGeometry.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this5)));
      _this5.render = _this5.render.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this5)));
      return _this5;
    }
    ...
    (0, _createClass2.default)(ColumnDesignerComponent, [{
      ...
      value: function render() {
        ...
        boundMethodCheck(this, ColumnDesignerComponent);
        exprUtils = new ExprUtils(this.props.schema); // Get type of current expression
        ...
        elem = R('div', {
          ...
          className: "col-xs-5" // style: { border: "solid 1px #DDD", padding: 4 },
