...
module.exports = SegmentDesignerComponent = (function(superClass) {
  ...
  SegmentDesignerComponent.prototype.renderStyling = function() {
    ...
    }), "Header Bold") : void 0, this.props.segment.valueAxis && this.props.segment.label ? H.label({
      className: "checkbox-inline",
      key: "fillerColor"
    }, H.input({
      type: "checkbox",
      checked: this.props.segment.fillerColor != null,
      onChange: (function(_this) {
        return function(ev) {
          return _this.update({
            fillerColor: ev.target.checked ? "#EEE" : null
          });
        };
      })(this)
    }), "Shade Filler Cells") : void 0);
  };
