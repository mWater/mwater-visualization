...
module.exports = IntersectionDesignerComponent = function () {
  var IntersectionDesignerComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(IntersectionDesignerComponent, _React$Component);

    var _super = _createSuper(IntersectionDesignerComponent);

    function IntersectionDesignerComponent() {
      var _this;

      (0, _classCallCheck2["default"])(this, IntersectionDesignerComponent);
      _this = _super.apply(this, arguments); // Updates intersection with the specified changes
...
BackgroundColorConditionsComponent = function () {
  ...
  var BackgroundColorConditionsComponent = /*#__PURE__*/function (_React$Component2) {
    (0, _inherits2["default"])(BackgroundColorConditionsComponent, _React$Component2);

    var _super2 = _createSuper(BackgroundColorConditionsComponent);
...
BackgroundColorConditionComponent = function () {
  ...
  var BackgroundColorConditionComponent = /*#__PURE__*/function (_React$Component3) {
    (0, _inherits2["default"])(BackgroundColorConditionComponent, _React$Component3);

    var _super3 = _createSuper(BackgroundColorConditionComponent);

    function BackgroundColorConditionComponent() {
      var _this4;

      (0, _classCallCheck2["default"])(this, BackgroundColorConditionComponent);
      _this4 = _super3.apply(this, arguments); // Updates intersection with the specified changes
