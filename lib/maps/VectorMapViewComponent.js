...
function VectorMapViewComponent(props) {
    ...
    const [hoverContents, setHoverContents] = (0, react_1.useState)();
    ...
    const handleLayerHover = (0, useStableCallback_1.useStableCallback)((layerViewId, ev) => {
    ...
    const handleLayerHoverDebounced = (0, react_1.useMemo)(() => {
        return lodash_1.default.debounce(handleLayerHover, 250, { leading: true, trailing: false });
    }, [handleLayerHover]);
    ...
    const setBounds = (0, useStableCallback_1.useStableCallback)((mapBounds) => {
        // Ignore if readonly
    ...
    const renderHoverContent = () => {
        ...
        return react_1.default.createElement("div", { style: style }, hoverContents !== null && hoverContents !== void 0 ? hoverContents : "asdksjdbfskajf");
    };
