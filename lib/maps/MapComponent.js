var AutoSizeComponent, H, MapComponent, MapControlComponent, MapDesignerComponent, MapViewComponent, PropTypes, React, UndoStack, _,
...
module.exports = MapComponent = (function(superClass) {
  ...
  MapComponent.prototype.renderPrint = function() {
    var printScale2Url, printScale3Url;
    printScale2Url = this.props.mapDataSource.getPrintUrl(this.getDesign(), 2);
    printScale3Url = this.props.mapDataSource.getPrintUrl(this.getDesign(), 3);
    if (printScale2Url && printScale3Url) {
      return H.div({
        key: "print",
        className: "btn-group"
      }, H.button({
