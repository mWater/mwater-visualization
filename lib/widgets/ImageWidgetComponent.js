...
class ImageWidgetComponent extends AsyncLoadComponent_1.default {
    constructor() {
        ...
        this.handleStartEditing = () => {
            var _a;
            (_a = this.editor) === null || _a === void 0 ? void 0 : _a.edit();
        };
    }
    // Override to determine if a load is needed. Not called on mounting
    isLoadNeeded(newProps, oldProps) {
        return (newProps.design.expr != null &&
...
class ImageWidgetDesignComponent extends react_1.default.Component {
    constructor(props) {
        ...
        this.handleOpenUrlInSameTabChange = (openUrlInSameTab) => {
    ...
    renderUrlEditor() {
        ...
        }), R("div", { className: "form-text text-muted" }, "e.g. http://somesite.com/"), (this.state.url ?
            R("div", null, R(ui.Checkbox, {
                value: !this.state.openUrlInSameTab,
                onChange: this.handleOpenUrlInSameTabChange
            }, "Open link in new tab"))
            : null), R("div", { className: "form-text text-muted" }, "When clicked on image, this link will open in a new tab"));
    }
    render() {
