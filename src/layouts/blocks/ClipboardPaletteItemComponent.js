      ...
      R('div', { 
        ...
        style: (this.props.isOver ? { backgroundColor: "#2485dd" } : undefined)
          ...
          R('div', {className: "subtitle", key: "subtitle"},
            this.props.isOver ? "Copy" : "Clipboard"),
          ...
          this.props.clipboard ?
            R('div', {className: "clearclipboard", onClick: this.handleClear},
              R('i', {className: "fa fa-trash-o"})) : undefined)
    );

    if (this.props.clipboard && !this.props.cantPasteMessage) {
      elem = R(DragSourceComponent, {createDragItem: this.createItem},
        elem);
    }
    return elem;
  }
