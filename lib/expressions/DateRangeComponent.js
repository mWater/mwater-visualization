var DateRangeComponent, DateRangePicker, ExpressionBuilder, ExpressionCompiler, H, React, moment,
...
module.exports = DateRangeComponent = (function(superClass) {
  ...
  DateRangeComponent.prototype.render = function() {
    ...
    hasValue = this.props.value && _.isArray(this.props.value.value);
    if (hasValue) {
      startDate = moment(this.props.value.value[0], moment.ISO_8601);
      endDate = moment(this.props.value.value[1], moment.ISO_8601);
